...
$(BUILD)/bin/appweb.out: $(DEPS_41)
	...
	$(CC) -o $(BUILD)/bin/appweb.out $(LDFLAGS) $(LIBPATHS)      "$(BUILD)/obj/appweb.o" $(LIBPATHS_41) $(LIBS_41) $(LIBS_41) $(LIBS) -Wl,-r 
...
$(BUILD)/bin/authpass.out: $(DEPS_42)
	...
	$(CC) -o $(BUILD)/bin/authpass.out $(LDFLAGS) $(LIBPATHS)      "$(BUILD)/obj/authpass.o" $(LIBPATHS_42) $(LIBS_42) $(LIBS_42) $(LIBS) -Wl,-r 
...
$(BUILD)/bin/esp.out: $(DEPS_44)
	...
	$(CC) -o $(BUILD)/bin/esp.out $(LDFLAGS) $(LIBPATHS)      "$(BUILD)/obj/esp.o" $(LIBPATHS_44) $(LIBS_44) $(LIBS_44) $(LIBS) -Wl,-r 
endif
...
$(BUILD)/bin/http.out: $(DEPS_45)
	...
	$(CC) -o $(BUILD)/bin/http.out $(LDFLAGS) $(LIBPATHS)      "$(BUILD)/obj/http.o" $(LIBPATHS_45) $(LIBS_45) $(LIBS_45) $(LIBS) -Wl,-r 
endif
...
$(BUILD)/bin/appman.out: $(DEPS_48)
	...
	$(CC) -o $(BUILD)/bin/appman.out $(LDFLAGS) $(LIBPATHS)      "$(BUILD)/obj/watchdog.o" $(LIBPATHS_48) $(LIBS_48) $(LIBS_48) $(LIBS) -Wl,-r 
