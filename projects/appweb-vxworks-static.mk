...
$(BUILD)/bin/libslink.out: $(DEPS_46)
...
DEPS_48 += $(BUILD)/bin/libmprssl.out
DEPS_48 += $(BUILD)/obj/sslModule.o

$(BUILD)/bin/libmod_ssl.out: $(DEPS_48)
...
$(BUILD)/bin/libmod_cgi.out: $(DEPS_49)
...
DEPS_50 += $(BUILD)/bin/libslink.out
ifeq ($(ME_COM_ESP),1)
    DEPS_50 += $(BUILD)/bin/libmod_esp.out
endif
ifeq ($(ME_COM_SSL),1)
    DEPS_50 += $(BUILD)/bin/libmod_ssl.out
endif
ifeq ($(ME_COM_CGI),1)
    DEPS_50 += $(BUILD)/bin/libmod_cgi.out
endif
...
$(BUILD)/bin/appweb.out: $(DEPS_50)
	...
	$(CC) -o $(BUILD)/bin/appweb.out $(LDFLAGS) $(LIBPATHS)   "$(BUILD)/obj/appweb.o" $(LIBPATHS_50) $(LIBS_50) $(LIBS_50) $(LIBS) -Wl,-r 
...
$(BUILD)/bin/authpass.out: $(DEPS_51)
	...
	$(CC) -o $(BUILD)/bin/authpass.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/authpass.o" $(LIBPATHS_51) $(LIBS_51) $(LIBS_51) $(LIBS) -Wl,-r 
...
$(BUILD)/bin/esp.out: $(DEPS_53)
	...
	$(CC) -o $(BUILD)/bin/esp.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/esp.o" $(LIBPATHS_53) $(LIBS_53) $(LIBS_53) $(LIBS) -Wl,-r 
endif
...
$(BUILD)/bin/appman.out: $(DEPS_59)
	...
	$(CC) -o $(BUILD)/bin/appman.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/manager.o" $(LIBPATHS_59) $(LIBS_59) $(LIBS_59) $(LIBS) -Wl,-r 
