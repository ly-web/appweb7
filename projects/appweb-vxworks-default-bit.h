...
#endif
#ifndef BIT_REQUIRES
    #define BIT_REQUIRES "ejscript,est,sdb,vxworks,compiler,lib,link,pcre"
#endif
...
/* Profile */
    ...
    #define BIT_CONFIG_CMD "bit -d -q -platform vxworks-x86-default -configure . -without default -with ejscript -with est --with sdb -gen make"
#endif
