#
#   appweb-linux-debug.mk -- Makefile to build Embedthis Appweb for linux
#
...
$(CONFIG)/obj/mprLib.o: \
        ...
        $(CONFIG)/inc/bit.h \
        $(CONFIG)/inc/mpr.h
	$(CC) -c -o $(CONFIG)/obj/mprLib.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/deps/mpr/mprLib.c
...
$(CONFIG)/obj/mprSsl.o: \
        ...
        $(CONFIG)/inc/mpr.h \
        $(CONFIG)/inc/est.h
	$(CC) -c -o $(CONFIG)/obj/mprSsl.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/deps/mpr/mprSsl.c
...
$(CONFIG)/obj/manager.o: \
        ...
        $(CONFIG)/inc/bit.h \
        $(CONFIG)/inc/mpr.h
	$(CC) -c -o $(CONFIG)/obj/manager.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/deps/mpr/manager.c
...
$(CONFIG)/obj/makerom.o: \
        ...
        $(CONFIG)/inc/bit.h \
        $(CONFIG)/inc/mpr.h
	$(CC) -c -o $(CONFIG)/obj/makerom.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/deps/mpr/makerom.c
...
$(CONFIG)/obj/pcre.o: \
        ...
        $(CONFIG)/inc/bit.h \
        $(CONFIG)/inc/pcre.h
	$(CC) -c -o $(CONFIG)/obj/pcre.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/deps/pcre/pcre.c
...
$(CONFIG)/obj/httpLib.o: \
        ...
        $(CONFIG)/inc/http.h \
        $(CONFIG)/inc/pcre.h
	$(CC) -c -o $(CONFIG)/obj/httpLib.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/deps/http/httpLib.c
...
$(CONFIG)/obj/http.o: \
        ...
        $(CONFIG)/inc/bit.h \
        $(CONFIG)/inc/http.h
	$(CC) -c -o $(CONFIG)/obj/http.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/deps/http/http.c
...
$(CONFIG)/obj/sqlite3.o: \
        ...
        $(CONFIG)/inc/bit.h \
        $(CONFIG)/inc/sqlite3.h
	$(CC) -c -o $(CONFIG)/obj/sqlite3.o -fPIC -w -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/deps/sqlite/sqlite3.c
...
$(CONFIG)/obj/sqlite.o: \
        ...
        $(CONFIG)/inc/bit.h \
        $(CONFIG)/inc/sqlite3.h
	$(CC) -c -o $(CONFIG)/obj/sqlite.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/deps/sqlite/sqlite.c
...
$(CONFIG)/obj/config.o: \
        ...
        $(CONFIG)/inc/appweb.h \
        $(CONFIG)/inc/pcre.h
	$(CC) -c -o $(CONFIG)/obj/config.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/config.c

$(CONFIG)/obj/convenience.o: \
        src/convenience.c \
        $(CONFIG)/inc/bit.h \
        $(CONFIG)/inc/appweb.h
	$(CC) -c -o $(CONFIG)/obj/convenience.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/convenience.c

$(CONFIG)/obj/dirHandler.o: \
        src/dirHandler.c \
        $(CONFIG)/inc/bit.h \
        $(CONFIG)/inc/appweb.h
	$(CC) -c -o $(CONFIG)/obj/dirHandler.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/dirHandler.c

$(CONFIG)/obj/fileHandler.o: \
        src/fileHandler.c \
        $(CONFIG)/inc/bit.h \
        $(CONFIG)/inc/appweb.h
	$(CC) -c -o $(CONFIG)/obj/fileHandler.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/fileHandler.c

$(CONFIG)/obj/log.o: \
        src/log.c \
        $(CONFIG)/inc/bit.h \
        $(CONFIG)/inc/appweb.h
	$(CC) -c -o $(CONFIG)/obj/log.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/log.c

$(CONFIG)/obj/server.o: \
        src/server.c \
        $(CONFIG)/inc/bit.h \
        $(CONFIG)/inc/appweb.h
	$(CC) -c -o $(CONFIG)/obj/server.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/server.c
...
$(CONFIG)/obj/edi.o: \
        ...
        $(CONFIG)/inc/edi.h \
        $(CONFIG)/inc/pcre.h
	$(CC) -c -o $(CONFIG)/obj/edi.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/esp/edi.c

$(CONFIG)/obj/espAbbrev.o: \
        src/esp/espAbbrev.c \
        $(CONFIG)/inc/bit.h \
        $(CONFIG)/inc/esp.h
	$(CC) -c -o $(CONFIG)/obj/espAbbrev.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/esp/espAbbrev.c

$(CONFIG)/obj/espFramework.o: \
        src/esp/espFramework.c \
        $(CONFIG)/inc/bit.h \
        $(CONFIG)/inc/esp.h
	$(CC) -c -o $(CONFIG)/obj/espFramework.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/esp/espFramework.c
...
$(CONFIG)/obj/espHandler.o: \
        ...
        $(CONFIG)/inc/esp.h \
        $(CONFIG)/inc/edi.h
	$(CC) -c -o $(CONFIG)/obj/espHandler.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/esp/espHandler.c
...
$(CONFIG)/obj/espHtml.o: \
        ...
        $(CONFIG)/inc/esp.h \
        $(CONFIG)/inc/edi.h
	$(CC) -c -o $(CONFIG)/obj/espHtml.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/esp/espHtml.c

$(CONFIG)/obj/espSession.o: \
        src/esp/espSession.c \
        $(CONFIG)/inc/bit.h \
        $(CONFIG)/inc/esp.h
	$(CC) -c -o $(CONFIG)/obj/espSession.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/esp/espSession.c

$(CONFIG)/obj/espTemplate.o: \
        src/esp/espTemplate.c \
        $(CONFIG)/inc/bit.h \
        $(CONFIG)/inc/esp.h
	$(CC) -c -o $(CONFIG)/obj/espTemplate.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/esp/espTemplate.c
...
$(CONFIG)/obj/mdb.o: \
        ...
        $(CONFIG)/inc/mdb.h \
        $(CONFIG)/inc/pcre.h
	$(CC) -c -o $(CONFIG)/obj/mdb.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/esp/mdb.c
...
$(CONFIG)/obj/sdb.o: \
        ...
        $(CONFIG)/inc/appweb.h \
        $(CONFIG)/inc/edi.h
	$(CC) -c -o $(CONFIG)/obj/sdb.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/esp/sdb.c
...
$(CONFIG)/obj/esp.o: \
        ...
        $(CONFIG)/inc/bit.h \
        $(CONFIG)/inc/esp.h
	$(CC) -c -o $(CONFIG)/obj/esp.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/esp/esp.c
...
$(CONFIG)/obj/cgiHandler.o: \
        ...
        $(CONFIG)/inc/bit.h \
        $(CONFIG)/inc/appweb.h
	$(CC) -c -o $(CONFIG)/obj/cgiHandler.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/modules/cgiHandler.c
...
$(CONFIG)/obj/authpass.o: \
        ...
        $(CONFIG)/inc/bit.h \
        $(CONFIG)/inc/appweb.h
	$(CC) -c -o $(CONFIG)/obj/authpass.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/utils/authpass.c
...
$(CONFIG)/obj/cgiProgram.o: \
        ...
        $(CONFIG)/inc/bit.h
	$(CC) -c -o $(CONFIG)/obj/cgiProgram.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/utils/cgiProgram.c
...
$(CONFIG)/obj/setConfig.o: \
        ...
        $(CONFIG)/inc/bit.h \
        $(CONFIG)/inc/mpr.h
	$(CC) -c -o $(CONFIG)/obj/setConfig.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/utils/setConfig.c
...
$(CONFIG)/obj/appweb.o: \
        ...
        $(CONFIG)/inc/appweb.h \
        $(CONFIG)/inc/esp.h
	$(CC) -c -o $(CONFIG)/obj/appweb.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc src/server/appweb.c
...
$(CONFIG)/obj/testAppweb.o: \
        ...
        $(CONFIG)/inc/bit.h \
        $(CONFIG)/inc/testAppweb.h
	$(CC) -c -o $(CONFIG)/obj/testAppweb.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc test/testAppweb.c

$(CONFIG)/obj/testHttp.o: \
        test/testHttp.c \
        $(CONFIG)/inc/bit.h \
        $(CONFIG)/inc/testAppweb.h
	$(CC) -c -o $(CONFIG)/obj/testHttp.o $(CFLAGS) -DEMBEDTHIS=1 $(DFLAGS) -I$(CONFIG)/inc test/testHttp.c
