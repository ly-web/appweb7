...
$(CONFIG)/obj/appweb.o: \
	...
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/appweb.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(BIT_PACK_PHP_PATH)" "-I$(BIT_PACK_PHP_PATH)/main" "-I$(BIT_PACK_PHP_PATH)/Zend" "-I$(BIT_PACK_PHP_PATH)/TSRM" src/server/appweb.c
...
$(CONFIG)/bin/appweb: $(DEPS_49)
	...
	$(CC) -o $(CONFIG)/bin/appweb -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)     "$(CONFIG)/obj/appweb.o" $(LIBPATHS_49) $(LIBS_49) $(LIBS_49) $(LIBS) -lpam 
...
$(CONFIG)/bin/authpass: $(DEPS_51)
	...
	$(CC) -o $(CONFIG)/bin/authpass -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/authpass.o" $(LIBPATHS_51) $(LIBS_51) $(LIBS_51) $(LIBS) -lpam 
...
$(CONFIG)/bin/ejsc: $(DEPS_56)
	...
	$(CC) -o $(CONFIG)/bin/ejsc -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsc.o" $(LIBPATHS_56) $(LIBS_56) $(LIBS_56) $(LIBS) -lpam 
endif
...
$(CONFIG)/bin/ejscmd: $(DEPS_59)
	...
	$(CC) -o $(CONFIG)/bin/ejscmd -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejs.o" $(LIBPATHS_59) $(LIBS_59) $(LIBS_59) $(LIBS) -lpam -ledit 
endif
...
DEPS_60 += src/paks/esp-angular/LICENSE.md
DEPS_60 += src/paks/esp-angular/package.json
DEPS_60 += src/paks/esp-angular/README.md
DEPS_60 += src/paks/esp-angular-mvc
DEPS_60 += src/paks/esp-angular-mvc/LICENSE.md
DEPS_60 += src/paks/esp-angular-mvc/package.json
DEPS_60 += src/paks/esp-angular-mvc/README.md
...
DEPS_60 += src/paks/esp-angular-mvc/templates/esp-angular-mvc/start.me
...
DEPS_60 += src/paks/esp-html-mvc/templates/esp-html-mvc/start.me
DEPS_60 += src/paks/esp-legacy-mvc
DEPS_60 += src/paks/esp-legacy-mvc/LICENSE.md
DEPS_60 += src/paks/esp-legacy-mvc/package.json
DEPS_60 += src/paks/esp-legacy-mvc/README.md
...
$(CONFIG)/esp: $(DEPS_60)
	( \
	cd src/paks; \
	mkdir -p "../../$(CONFIG)/esp/esp-angular/5.0.0" ; \
	cp esp-angular/esp-click.js ../../$(CONFIG)/esp/esp-angular/5.0.0/esp-click.js ; \
	cp esp-angular/esp-edit.js ../../$(CONFIG)/esp/esp-angular/5.0.0/esp-edit.js ; \
	cp esp-angular/esp-field-errors.js ../../$(CONFIG)/esp/esp-angular/5.0.0/esp-field-errors.js ; \
	cp esp-angular/esp-fixnum.js ../../$(CONFIG)/esp/esp-angular/5.0.0/esp-fixnum.js ; \
	cp esp-angular/esp-format.js ../../$(CONFIG)/esp/esp-angular/5.0.0/esp-format.js ; \
	cp esp-angular/esp-input-group.js ../../$(CONFIG)/esp/esp-angular/5.0.0/esp-input-group.js ; \
	cp esp-angular/esp-input.js ../../$(CONFIG)/esp/esp-angular/5.0.0/esp-input.js ; \
	cp esp-angular/esp-resource.js ../../$(CONFIG)/esp/esp-angular/5.0.0/esp-resource.js ; \
	cp esp-angular/esp-session.js ../../$(CONFIG)/esp/esp-angular/5.0.0/esp-session.js ; \
	cp esp-angular/esp-titlecase.js ../../$(CONFIG)/esp/esp-angular/5.0.0/esp-titlecase.js ; \
	cp esp-angular/esp.js ../../$(CONFIG)/esp/esp-angular/5.0.0/esp.js ; \
	cp esp-angular/LICENSE.md ../../$(CONFIG)/esp/esp-angular/5.0.0/LICENSE.md ; \
	cp esp-angular/package.json ../../$(CONFIG)/esp/esp-angular/5.0.0/package.json ; \
	cp esp-angular/README.md ../../$(CONFIG)/esp/esp-angular/5.0.0/README.md ; \
	mkdir -p "../../$(CONFIG)/esp/esp-angular-mvc/5.0.0" ; \
	cp esp-angular-mvc/LICENSE.md ../../$(CONFIG)/esp/esp-angular-mvc/5.0.0/LICENSE.md ; \
	cp esp-angular-mvc/package.json ../../$(CONFIG)/esp/esp-angular-mvc/5.0.0/package.json ; \
	cp esp-angular-mvc/README.md ../../$(CONFIG)/esp/esp-angular-mvc/5.0.0/README.md ; \
	mkdir -p "../../$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates" ; \
	mkdir -p "../../$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc" ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/appweb.conf ../../$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/appweb.conf ; \
	mkdir -p "../../$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client" ; \
	mkdir -p "../../$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client/app" ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/client/app/main.js ../../$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client/app/main.js ; \
	mkdir -p "../../$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client/assets" ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/client/assets/favicon.ico ../../$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client/assets/favicon.ico ; \
	mkdir -p "../../$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client/css" ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/client/css/all.css ../../$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client/css/all.css ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/client/css/all.less ../../$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client/css/all.less ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/client/css/app.less ../../$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client/css/app.less ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/client/css/fix.css ../../$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client/css/fix.css ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/client/css/theme.less ../../$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client/css/theme.less ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/client/index.esp ../../$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client/index.esp ; \
	mkdir -p "../../$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client/pages" ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/client/pages/splash.html ../../$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client/pages/splash.html ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/controller-singleton.c ../../$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/controller-singleton.c ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/controller.c ../../$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/controller.c ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/controller.js ../../$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/controller.js ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/edit.html ../../$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/edit.html ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/list.html ../../$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/list.html ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/model.js ../../$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/model.js ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/start.me ../../$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/start.me ; \
	...
	mkdir -p "../../$(CONFIG)/esp/esp-legacy-mvc/5.0.0" ; \
	cp esp-legacy-mvc/LICENSE.md ../../$(CONFIG)/esp/esp-legacy-mvc/5.0.0/LICENSE.md ; \
	cp esp-legacy-mvc/package.json ../../$(CONFIG)/esp/esp-legacy-mvc/5.0.0/package.json ; \
	cp esp-legacy-mvc/README.md ../../$(CONFIG)/esp/esp-legacy-mvc/5.0.0/README.md ; \
	mkdir -p "../../$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates" ; \
	mkdir -p "../../$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc" ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/appweb.conf ../../$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/appweb.conf ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/controller.c ../../$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/controller.c ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/edit.esp ../../$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/edit.esp ; \
	mkdir -p "../../$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/layouts" ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/layouts/default.esp ../../$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/layouts/default.esp ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/list.esp ../../$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/list.esp ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/migration.c ../../$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/migration.c ; \
	mkdir -p "../../$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/src" ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/src/app.c ../../$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/src/app.c ; \
	mkdir -p "../../$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/static" ; \
	mkdir -p "../../$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/static/css" ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/static/css/all.css ../../$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/static/css/all.css ; \
	mkdir -p "../../$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/static/images" ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/static/images/banner.jpg ../../$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/static/images/banner.jpg ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/static/images/favicon.ico ../../$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/static/images/favicon.ico ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/static/images/splash.jpg ../../$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/static/images/splash.jpg ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/static/index.esp ../../$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/static/index.esp ; \
	mkdir -p "../../$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/static/js" ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/static/js/jquery.esp.js ../../$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/static/js/jquery.esp.js ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/static/js/jquery.js ../../$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/static/js/jquery.js ; \
...
$(CONFIG)/bin/esp: $(DEPS_63)
	...
	$(CC) -o $(CONFIG)/bin/esp -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/esp.o" "$(CONFIG)/obj/espLib.o" $(LIBPATHS_63) $(LIBS_63) $(LIBS_63) $(LIBS) -lpam 
endif
...
$(CONFIG)/obj/http.o: \
	...
	$(CC) -c $(DFLAGS) -o $(CONFIG)/obj/http.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_OPENSSL_PATH)/include" src/paks/http/http.c
...
$(CONFIG)/bin/http: $(DEPS_66)
	...
	$(CC) -o $(CONFIG)/bin/http -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)    "$(CONFIG)/obj/http.o" $(LIBPATHS_66) $(LIBS_66) $(LIBS_66) $(LIBS) -lpam 
endif
...
installBinary: $(DEPS_84)
	...
	if [ "$(ME_COM_ESP)" = 1 ]; then true ; \
	cp src/paks/angular/angular-animate.js $(CONFIG)/esp/angular/1.2.6/angular-animate.js ; \
	cp src/paks/angular/angular-csp.css $(CONFIG)/esp/angular/1.2.6/angular-csp.css ; \
	cp src/paks/angular/angular-route.js $(CONFIG)/esp/angular/1.2.6/angular-route.js ; \
	cp src/paks/angular/angular.js $(CONFIG)/esp/angular/1.2.6/angular.js ; \
	cp src/paks/angular/package.json $(CONFIG)/esp/angular/1.2.6/package.json ; \
	cp src/paks/esp-angular/esp-click.js $(CONFIG)/esp/esp-angular/5.0.0/esp-click.js ; \
	cp src/paks/esp-angular/esp-edit.js $(CONFIG)/esp/esp-angular/5.0.0/esp-edit.js ; \
	cp src/paks/esp-angular/esp-field-errors.js $(CONFIG)/esp/esp-angular/5.0.0/esp-field-errors.js ; \
	cp src/paks/esp-angular/esp-fixnum.js $(CONFIG)/esp/esp-angular/5.0.0/esp-fixnum.js ; \
	cp src/paks/esp-angular/esp-format.js $(CONFIG)/esp/esp-angular/5.0.0/esp-format.js ; \
	cp src/paks/esp-angular/esp-input-group.js $(CONFIG)/esp/esp-angular/5.0.0/esp-input-group.js ; \
	cp src/paks/esp-angular/esp-input.js $(CONFIG)/esp/esp-angular/5.0.0/esp-input.js ; \
	cp src/paks/esp-angular/esp-resource.js $(CONFIG)/esp/esp-angular/5.0.0/esp-resource.js ; \
	cp src/paks/esp-angular/esp-session.js $(CONFIG)/esp/esp-angular/5.0.0/esp-session.js ; \
	cp src/paks/esp-angular/esp-titlecase.js $(CONFIG)/esp/esp-angular/5.0.0/esp-titlecase.js ; \
	cp src/paks/esp-angular/esp.js $(CONFIG)/esp/esp-angular/5.0.0/esp.js ; \
	cp src/paks/esp-angular/LICENSE.md $(CONFIG)/esp/esp-angular/5.0.0/LICENSE.md ; \
	cp src/paks/esp-angular/package.json $(CONFIG)/esp/esp-angular/5.0.0/package.json ; \
	cp src/paks/esp-angular/README.md $(CONFIG)/esp/esp-angular/5.0.0/README.md ; \
	cp src/paks/esp-angular-mvc/LICENSE.md $(CONFIG)/esp/esp-angular-mvc/5.0.0/LICENSE.md ; \
	cp src/paks/esp-angular-mvc/package.json $(CONFIG)/esp/esp-angular-mvc/5.0.0/package.json ; \
	cp src/paks/esp-angular-mvc/README.md $(CONFIG)/esp/esp-angular-mvc/5.0.0/README.md ; \
	mkdir -p "$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates" ; \
	mkdir -p "$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc" ; \
	cp src/paks/esp-angular-mvc/templates/esp-angular-mvc/appweb.conf $(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/appweb.conf ; \
	mkdir -p "$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client" ; \
	mkdir -p "$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client/app" ; \
	cp src/paks/esp-angular-mvc/templates/esp-angular-mvc/client/app/main.js $(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client/app/main.js ; \
	mkdir -p "$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client/assets" ; \
	cp src/paks/esp-angular-mvc/templates/esp-angular-mvc/client/assets/favicon.ico $(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client/assets/favicon.ico ; \
	mkdir -p "$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client/css" ; \
	cp src/paks/esp-angular-mvc/templates/esp-angular-mvc/client/css/all.css $(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client/css/all.css ; \
	cp src/paks/esp-angular-mvc/templates/esp-angular-mvc/client/css/all.less $(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client/css/all.less ; \
	cp src/paks/esp-angular-mvc/templates/esp-angular-mvc/client/css/app.less $(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client/css/app.less ; \
	cp src/paks/esp-angular-mvc/templates/esp-angular-mvc/client/css/fix.css $(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client/css/fix.css ; \
	cp src/paks/esp-angular-mvc/templates/esp-angular-mvc/client/css/theme.less $(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client/css/theme.less ; \
	cp src/paks/esp-angular-mvc/templates/esp-angular-mvc/client/index.esp $(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client/index.esp ; \
	mkdir -p "$(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client/pages" ; \
	cp src/paks/esp-angular-mvc/templates/esp-angular-mvc/client/pages/splash.html $(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/client/pages/splash.html ; \
	cp src/paks/esp-angular-mvc/templates/esp-angular-mvc/controller-singleton.c $(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/controller-singleton.c ; \
	cp src/paks/esp-angular-mvc/templates/esp-angular-mvc/controller.c $(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/controller.c ; \
	cp src/paks/esp-angular-mvc/templates/esp-angular-mvc/controller.js $(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/controller.js ; \
	cp src/paks/esp-angular-mvc/templates/esp-angular-mvc/edit.html $(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/edit.html ; \
	cp src/paks/esp-angular-mvc/templates/esp-angular-mvc/list.html $(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/list.html ; \
	cp src/paks/esp-angular-mvc/templates/esp-angular-mvc/model.js $(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/model.js ; \
	cp src/paks/esp-angular-mvc/templates/esp-angular-mvc/start.me $(CONFIG)/esp/esp-angular-mvc/5.0.0/templates/esp-angular-mvc/start.me ; \
	cp src/paks/esp-html-mvc/LICENSE.md $(CONFIG)/esp/esp-html-mvc/5.0.0/LICENSE.md ; \
	cp src/paks/esp-html-mvc/package.json $(CONFIG)/esp/esp-html-mvc/5.0.0/package.json ; \
	cp src/paks/esp-html-mvc/README.md $(CONFIG)/esp/esp-html-mvc/5.0.0/README.md ; \
	mkdir -p "$(CONFIG)/esp/esp-html-mvc/5.0.0/templates" ; \
	mkdir -p "$(CONFIG)/esp/esp-html-mvc/5.0.0/templates/esp-html-mvc" ; \
	cp src/paks/esp-html-mvc/templates/esp-html-mvc/appweb.conf $(CONFIG)/esp/esp-html-mvc/5.0.0/templates/esp-html-mvc/appweb.conf ; \
	mkdir -p "$(CONFIG)/esp/esp-html-mvc/5.0.0/templates/esp-html-mvc/client" ; \
	mkdir -p "$(CONFIG)/esp/esp-html-mvc/5.0.0/templates/esp-html-mvc/client/assets" ; \
	cp src/paks/esp-html-mvc/templates/esp-html-mvc/client/assets/favicon.ico $(CONFIG)/esp/esp-html-mvc/5.0.0/templates/esp-html-mvc/client/assets/favicon.ico ; \
	mkdir -p "$(CONFIG)/esp/esp-html-mvc/5.0.0/templates/esp-html-mvc/client/css" ; \
	cp src/paks/esp-html-mvc/templates/esp-html-mvc/client/css/all.css $(CONFIG)/esp/esp-html-mvc/5.0.0/templates/esp-html-mvc/client/css/all.css ; \
	cp src/paks/esp-html-mvc/templates/esp-html-mvc/client/css/all.less $(CONFIG)/esp/esp-html-mvc/5.0.0/templates/esp-html-mvc/client/css/all.less ; \
	cp src/paks/esp-html-mvc/templates/esp-html-mvc/client/css/app.less $(CONFIG)/esp/esp-html-mvc/5.0.0/templates/esp-html-mvc/client/css/app.less ; \
	cp src/paks/esp-html-mvc/templates/esp-html-mvc/client/css/theme.less $(CONFIG)/esp/esp-html-mvc/5.0.0/templates/esp-html-mvc/client/css/theme.less ; \
	cp src/paks/esp-html-mvc/templates/esp-html-mvc/client/index.esp $(CONFIG)/esp/esp-html-mvc/5.0.0/templates/esp-html-mvc/client/index.esp ; \
	mkdir -p "$(CONFIG)/esp/esp-html-mvc/5.0.0/templates/esp-html-mvc/client/layouts" ; \
	cp src/paks/esp-html-mvc/templates/esp-html-mvc/client/layouts/default.esp $(CONFIG)/esp/esp-html-mvc/5.0.0/templates/esp-html-mvc/client/layouts/default.esp ; \
	cp src/paks/esp-html-mvc/templates/esp-html-mvc/controller-singleton.c $(CONFIG)/esp/esp-html-mvc/5.0.0/templates/esp-html-mvc/controller-singleton.c ; \
	cp src/paks/esp-html-mvc/templates/esp-html-mvc/controller.c $(CONFIG)/esp/esp-html-mvc/5.0.0/templates/esp-html-mvc/controller.c ; \
	cp src/paks/esp-html-mvc/templates/esp-html-mvc/edit.esp $(CONFIG)/esp/esp-html-mvc/5.0.0/templates/esp-html-mvc/edit.esp ; \
	cp src/paks/esp-html-mvc/templates/esp-html-mvc/list.esp $(CONFIG)/esp/esp-html-mvc/5.0.0/templates/esp-html-mvc/list.esp ; \
	cp src/paks/esp-html-mvc/templates/esp-html-mvc/start.me $(CONFIG)/esp/esp-html-mvc/5.0.0/templates/esp-html-mvc/start.me ; \
	cp src/paks/esp-legacy-mvc/LICENSE.md $(CONFIG)/esp/esp-legacy-mvc/5.0.0/LICENSE.md ; \
	cp src/paks/esp-legacy-mvc/package.json $(CONFIG)/esp/esp-legacy-mvc/5.0.0/package.json ; \
	cp src/paks/esp-legacy-mvc/README.md $(CONFIG)/esp/esp-legacy-mvc/5.0.0/README.md ; \
	mkdir -p "$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates" ; \
	mkdir -p "$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc" ; \
	cp src/paks/esp-legacy-mvc/templates/esp-legacy-mvc/appweb.conf $(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/appweb.conf ; \
	cp src/paks/esp-legacy-mvc/templates/esp-legacy-mvc/controller.c $(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/controller.c ; \
	cp src/paks/esp-legacy-mvc/templates/esp-legacy-mvc/edit.esp $(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/edit.esp ; \
	mkdir -p "$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/layouts" ; \
	cp src/paks/esp-legacy-mvc/templates/esp-legacy-mvc/layouts/default.esp $(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/layouts/default.esp ; \
	cp src/paks/esp-legacy-mvc/templates/esp-legacy-mvc/list.esp $(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/list.esp ; \
	cp src/paks/esp-legacy-mvc/templates/esp-legacy-mvc/migration.c $(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/migration.c ; \
	mkdir -p "$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/src" ; \
	cp src/paks/esp-legacy-mvc/templates/esp-legacy-mvc/src/app.c $(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/src/app.c ; \
	mkdir -p "$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/static" ; \
	mkdir -p "$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/static/css" ; \
	cp src/paks/esp-legacy-mvc/templates/esp-legacy-mvc/static/css/all.css $(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/static/css/all.css ; \
	mkdir -p "$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/static/images" ; \
	cp src/paks/esp-legacy-mvc/templates/esp-legacy-mvc/static/images/banner.jpg $(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/static/images/banner.jpg ; \
	cp src/paks/esp-legacy-mvc/templates/esp-legacy-mvc/static/images/favicon.ico $(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/static/images/favicon.ico ; \
	cp src/paks/esp-legacy-mvc/templates/esp-legacy-mvc/static/images/splash.jpg $(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/static/images/splash.jpg ; \
	cp src/paks/esp-legacy-mvc/templates/esp-legacy-mvc/static/index.esp $(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/static/index.esp ; \
	mkdir -p "$(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/static/js" ; \
	cp src/paks/esp-legacy-mvc/templates/esp-legacy-mvc/static/js/jquery.esp.js $(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/static/js/jquery.esp.js ; \
	cp src/paks/esp-legacy-mvc/templates/esp-legacy-mvc/static/js/jquery.js $(CONFIG)/esp/esp-legacy-mvc/5.0.0/templates/esp-legacy-mvc/static/js/jquery.js ; \
	cp src/paks/esp-server/LICENSE.md $(CONFIG)/esp/esp-server/5.0.0/LICENSE.md ; \
	cp src/paks/esp-server/package.json $(CONFIG)/esp/esp-server/5.0.0/package.json ; \
	cp src/paks/esp-server/README.md $(CONFIG)/esp/esp-server/5.0.0/README.md ; \
	mkdir -p "$(CONFIG)/esp/esp-server/5.0.0/templates" ; \
	mkdir -p "$(CONFIG)/esp/esp-server/5.0.0/templates/esp-server" ; \
	cp src/paks/esp-server/templates/esp-server/appweb.conf $(CONFIG)/esp/esp-server/5.0.0/templates/esp-server/appweb.conf ; \
	cp src/paks/esp-server/templates/esp-server/controller.c $(CONFIG)/esp/esp-server/5.0.0/templates/esp-server/controller.c ; \
	cp src/paks/esp-server/templates/esp-server/migration.c $(CONFIG)/esp/esp-server/5.0.0/templates/esp-server/migration.c ; \
	mkdir -p "$(CONFIG)/esp/esp-server/5.0.0/templates/esp-server/src" ; \
	cp src/paks/esp-server/templates/esp-server/src/app.c $(CONFIG)/esp/esp-server/5.0.0/templates/esp-server/src/app.c ; \
	fi ; \
	if [ "$(ME_COM_ESP)" = 1 ]; then true ; \
