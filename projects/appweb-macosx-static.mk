...
$(BUILD)/bin/libslink.dylib: $(DEPS_64)
...
$(BUILD)/bin/libest.dylib: $(DEPS_65)
...
ifeq ($(ME_COM_EST),1)
    DEPS_66 += $(BUILD)/bin/libest.dylib
endif
DEPS_66 += $(BUILD)/obj/mprSsl.o

$(BUILD)/bin/libmprssl.dylib: $(DEPS_66)
...
DEPS_67 += $(BUILD)/bin/libmprssl.dylib
DEPS_67 += $(BUILD)/obj/sslModule.o

$(BUILD)/bin/libmod_ssl.dylib: $(DEPS_67)
...
$(BUILD)/bin/libzlib.dylib: $(DEPS_68)
...
ifeq ($(ME_COM_ZLIB),1)
    DEPS_69 += $(BUILD)/bin/libzlib.dylib
endif
...
$(BUILD)/bin/libejs.dylib: $(DEPS_69)
...
$(BUILD)/bin/libmod_ejs.dylib: $(DEPS_70)
...
$(BUILD)/bin/libmod_php.dylib: $(DEPS_71)
...
DEPS_73 += $(BUILD)/bin/libslink.dylib
ifeq ($(ME_COM_ESP),1)
    DEPS_73 += $(BUILD)/bin/libmod_esp.dylib
endif
ifeq ($(ME_COM_SSL),1)
    DEPS_73 += $(BUILD)/bin/libmod_ssl.dylib
endif
ifeq ($(ME_COM_EJS),1)
    DEPS_73 += $(BUILD)/bin/libmod_ejs.dylib
endif
ifeq ($(ME_COM_PHP),1)
    DEPS_73 += $(BUILD)/bin/libmod_php.dylib
endif
ifeq ($(ME_COM_CGI),1)
    DEPS_73 += $(BUILD)/bin/libmod_cgi.dylib
endif
...
#   ejsc
#
DEPS_76 += $(BUILD)/bin/libejs.dylib
...
#   espcmd
#
DEPS_81 += $(BUILD)/bin/libmod_esp.dylib
...
#   httpcmd
#
DEPS_84 += $(BUILD)/bin/libhttp.dylib
