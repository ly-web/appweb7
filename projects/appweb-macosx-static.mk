...
$(BUILD)/bin/libmod_esp.dylib: $(DEPS_53)
...
#
ifeq ($(ME_COM_ESP),1)
    DEPS_54 += $(BUILD)/bin/libmod_esp.dylib
endif
ifeq ($(ME_COM_ESP),1)
    DEPS_54 += $(BUILD)/bin/libmod_esp.dylib
endif
...
$(BUILD)/bin/libslink.dylib: $(DEPS_54)
...
$(BUILD)/bin/libzlib.dylib: $(DEPS_57)
...
ifeq ($(ME_COM_ZLIB),1)
    DEPS_58 += $(BUILD)/bin/libzlib.dylib
endif
...
$(BUILD)/bin/libejs.dylib: $(DEPS_58)
...
$(BUILD)/bin/libmod_ejs.dylib: $(DEPS_59)
...
$(BUILD)/bin/libmod_php.dylib: $(DEPS_60)
...
ifeq ($(ME_COM_SSL),1)
    DEPS_62 += $(BUILD)/bin/libmod_ssl.dylib
endif
ifeq ($(ME_COM_EJS),1)
    DEPS_62 += $(BUILD)/bin/libmod_ejs.dylib
endif
ifeq ($(ME_COM_PHP),1)
    DEPS_62 += $(BUILD)/bin/libmod_php.dylib
endif
ifeq ($(ME_COM_CGI),1)
    DEPS_62 += $(BUILD)/bin/libmod_cgi.dylib
endif
...
$(BUILD)/bin/ejsc: $(DEPS_64)
	...
	$(CC) -o $(BUILD)/bin/ejsc -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/ejsc.o" $(LIBPATHS_64) $(LIBS_64) $(LIBS_64) $(LIBS) -lpam 
endif
...
$(BUILD)/bin/ejs: $(DEPS_66)
	...
	$(CC) -o $(BUILD)/bin/ejs -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/ejs.o" $(LIBPATHS_66) $(LIBS_66) $(LIBS_66) $(LIBS) -lpam -ledit 
endif
