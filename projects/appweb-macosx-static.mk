...
$(BUILD)/bin/libesp.dylib: $(DEPS_44)
...
$(BUILD)/bin/libmod_esp.dylib: $(DEPS_45)
...
ifeq ($(ME_COM_ESP),1)
    DEPS_46 += $(BUILD)/bin/libmod_esp.dylib
endif
...
DEPS_48 += $(BUILD)/bin/libmprssl.dylib
DEPS_48 += $(BUILD)/obj/sslModule.o

$(BUILD)/bin/libmod_ssl.dylib: $(DEPS_48)
...
$(BUILD)/bin/libmod_cgi.dylib: $(DEPS_49)
...
DEPS_50 += $(BUILD)/bin/libslink.dylib
ifeq ($(ME_COM_ESP),1)
    DEPS_50 += $(BUILD)/bin/libmod_esp.dylib
endif
ifeq ($(ME_COM_SSL),1)
    DEPS_50 += $(BUILD)/bin/libmod_ssl.dylib
endif
ifeq ($(ME_COM_CGI),1)
    DEPS_50 += $(BUILD)/bin/libmod_cgi.dylib
endif
...
#   esp-compile.json
#
DEPS_52 += paks/esp/dist/esp-compile.json
...
$(BUILD)/bin/esp: $(DEPS_53)
	...
	$(CC) -o $(BUILD)/bin/esp -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/esp.o" $(LIBPATHS_53) $(LIBS_53) $(LIBS_53) $(LIBS) -lpam 
endif
...
#   http-ca-crt
#
DEPS_55 += paks/http/dist/ca.crt

$(BUILD)/bin/ca.crt: $(DEPS_55)
