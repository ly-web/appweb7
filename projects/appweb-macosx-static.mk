...
$(BUILD)/bin/libmod_esp.dylib: $(DEPS_55)
...
#
ifeq ($(ME_COM_ESP),1)
    DEPS_56 += $(BUILD)/bin/libmod_esp.dylib
endif
ifeq ($(ME_COM_ESP),1)
    DEPS_56 += $(BUILD)/bin/libmod_esp.dylib
endif
...
$(BUILD)/bin/libest.dylib: $(DEPS_57)
...
ifeq ($(ME_COM_EST),1)
    DEPS_58 += $(BUILD)/bin/libest.dylib
endif
DEPS_58 += $(BUILD)/obj/mprSsl.o

$(BUILD)/bin/libmprssl.dylib: $(DEPS_58)
...
DEPS_59 += $(BUILD)/bin/libmprssl.dylib
DEPS_59 += $(BUILD)/obj/sslModule.o

$(BUILD)/bin/libmod_ssl.dylib: $(DEPS_59)
...
DEPS_65 += $(BUILD)/bin/libslink.dylib
ifeq ($(ME_COM_ESP),1)
    DEPS_65 += $(BUILD)/bin/libmod_esp.dylib
endif
ifeq ($(ME_COM_SSL),1)
    DEPS_65 += $(BUILD)/bin/libmod_ssl.dylib
endif
ifeq ($(ME_COM_EJS),1)
    DEPS_65 += $(BUILD)/bin/libmod_ejs.dylib
endif
ifeq ($(ME_COM_PHP),1)
    DEPS_65 += $(BUILD)/bin/libmod_php.dylib
endif
ifeq ($(ME_COM_CGI),1)
    DEPS_65 += $(BUILD)/bin/libmod_cgi.dylib
endif
...
#   cgiProgram
#
DEPS_67 += $(BUILD)/obj/cgiProgram.o

$(BUILD)/bin/cgiProgram: $(DEPS_67)
...
$(BUILD)/bin/ejsc: $(DEPS_68)
	@echo '      [Link] $(BUILD)/bin/ejsc'
	$(CC) -o $(BUILD)/bin/ejsc -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/ejsc.o" $(LIBPATHS_68) $(LIBS_68) $(LIBS_68) $(LIBS) -lpam 
endif
...
DEPS_69 += $(BUILD)/bin/ejsc

$(BUILD)/bin/ejs.mod: $(DEPS_69)
	( \
	cd src/paks/ejs; \
...
#   ejscmd
#
DEPS_70 += $(BUILD)/bin/libejs.dylib
DEPS_70 += $(BUILD)/obj/ejs.o
...
$(BUILD)/bin/ejs: $(DEPS_70)
	@echo '      [Link] $(BUILD)/bin/ejs'
	$(CC) -o $(BUILD)/bin/ejs -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/ejs.o" $(LIBPATHS_70) $(LIBS_70) $(LIBS_70) $(LIBS) -lpam -ledit 
endif
...
#   esp.conf
#
DEPS_72 += src/paks/esp/esp.conf

$(BUILD)/bin/esp.conf: $(DEPS_72)
...
#   genslink
#
DEPS_74 += $(BUILD)/bin/libmod_esp.dylib
