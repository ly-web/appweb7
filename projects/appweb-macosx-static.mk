...
build/$(CONFIG)/obj/log.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/log.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/log.c
...
build/$(CONFIG)/obj/server.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/server.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) src/server.c
...
build/$(CONFIG)/bin/libappweb.a: $(DEPS_20)
	@echo '      [Link] build/$(CONFIG)/bin/libappweb.a'
	ar -cr build/$(CONFIG)/bin/libappweb.a "build/$(CONFIG)/obj/config.o" "build/$(CONFIG)/obj/convenience.o" "build/$(CONFIG)/obj/dirHandler.o" "build/$(CONFIG)/obj/fileHandler.o" "build/$(CONFIG)/obj/log.o" "build/$(CONFIG)/obj/server.o"
...
DEPS_24 += build/$(CONFIG)/obj/dirHandler.o
DEPS_24 += build/$(CONFIG)/obj/fileHandler.o
DEPS_24 += build/$(CONFIG)/obj/log.o
DEPS_24 += build/$(CONFIG)/obj/server.o
DEPS_24 += build/$(CONFIG)/bin/libappweb.a
DEPS_24 += build/$(CONFIG)/inc/esp.h
DEPS_24 += build/$(CONFIG)/obj/espLib.o

build/$(CONFIG)/bin/libmod_esp.a: $(DEPS_24)
...
ifeq ($(ME_COM_PCRE),1)
    DEPS_26 += build/$(CONFIG)/bin/libpcre.a
endif
DEPS_26 += build/$(CONFIG)/inc/http.h
DEPS_26 += build/$(CONFIG)/obj/httpLib.o
ifeq ($(ME_COM_HTTP),1)
    DEPS_26 += build/$(CONFIG)/bin/libhttp.a
endif
...
DEPS_26 += build/$(CONFIG)/bin/libappweb.a
DEPS_26 += build/$(CONFIG)/inc/esp.h
DEPS_26 += build/$(CONFIG)/obj/espLib.o
ifeq ($(ME_COM_ESP),1)
    DEPS_26 += build/$(CONFIG)/bin/libmod_esp.a
endif
DEPS_26 += build/$(CONFIG)/obj/slink.o

build/$(CONFIG)/bin/libslink.a: $(DEPS_26)
...
build/$(CONFIG)/bin/libest.a: $(DEPS_29)
...
DEPS_31 += build/$(CONFIG)/bin/libmpr.a
DEPS_31 += build/$(CONFIG)/inc/est.h
DEPS_31 += build/$(CONFIG)/obj/estLib.o
ifeq ($(ME_COM_EST),1)
    DEPS_31 += build/$(CONFIG)/bin/libest.a
endif
DEPS_31 += build/$(CONFIG)/obj/mprSsl.o

build/$(CONFIG)/bin/libmprssl.a: $(DEPS_31)
...
build/$(CONFIG)/obj/sslModule.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/sslModule.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" src/modules/sslModule.c
...
DEPS_33 += build/$(CONFIG)/bin/libmpr.a
DEPS_33 += build/$(CONFIG)/inc/pcre.h
DEPS_33 += build/$(CONFIG)/obj/pcre.o
ifeq ($(ME_COM_PCRE),1)
    DEPS_33 += build/$(CONFIG)/bin/libpcre.a
endif
DEPS_33 += build/$(CONFIG)/inc/http.h
DEPS_33 += build/$(CONFIG)/obj/httpLib.o
ifeq ($(ME_COM_HTTP),1)
    DEPS_33 += build/$(CONFIG)/bin/libhttp.a
endif
DEPS_33 += build/$(CONFIG)/inc/appweb.h
DEPS_33 += build/$(CONFIG)/inc/customize.h
DEPS_33 += build/$(CONFIG)/obj/config.o
DEPS_33 += build/$(CONFIG)/obj/convenience.o
DEPS_33 += build/$(CONFIG)/obj/dirHandler.o
DEPS_33 += build/$(CONFIG)/obj/fileHandler.o
DEPS_33 += build/$(CONFIG)/obj/log.o
DEPS_33 += build/$(CONFIG)/obj/server.o
DEPS_33 += build/$(CONFIG)/bin/libappweb.a
DEPS_33 += build/$(CONFIG)/inc/est.h
DEPS_33 += build/$(CONFIG)/obj/estLib.o
ifeq ($(ME_COM_EST),1)
    DEPS_33 += build/$(CONFIG)/bin/libest.a
endif
DEPS_33 += build/$(CONFIG)/obj/mprSsl.o
DEPS_33 += build/$(CONFIG)/bin/libmprssl.a
DEPS_33 += build/$(CONFIG)/obj/sslModule.o

build/$(CONFIG)/bin/libmod_ssl.a: $(DEPS_33)
...
#   zlib.h
#
build/$(CONFIG)/inc/zlib.h: $(DEPS_34)
...
build/$(CONFIG)/bin/libzlib.a: $(DEPS_36)
...
#   ejs.h
#
build/$(CONFIG)/inc/ejs.h: $(DEPS_37)
...
#   ejs.slots.h
#
build/$(CONFIG)/inc/ejs.slots.h: $(DEPS_38)
...
#   ejsByteGoto.h
#
build/$(CONFIG)/inc/ejsByteGoto.h: $(DEPS_39)
...
ifeq ($(ME_COM_ZLIB),1)
    DEPS_41 += build/$(CONFIG)/bin/libzlib.a
endif
...
build/$(CONFIG)/bin/libejs.a: $(DEPS_41)
...
DEPS_43 += build/$(CONFIG)/obj/dirHandler.o
DEPS_43 += build/$(CONFIG)/obj/fileHandler.o
DEPS_43 += build/$(CONFIG)/obj/log.o
DEPS_43 += build/$(CONFIG)/obj/server.o
DEPS_43 += build/$(CONFIG)/bin/libappweb.a
DEPS_43 += build/$(CONFIG)/inc/zlib.h
DEPS_43 += build/$(CONFIG)/obj/zlib.o
ifeq ($(ME_COM_ZLIB),1)
    DEPS_43 += build/$(CONFIG)/bin/libzlib.a
endif
...
DEPS_43 += build/$(CONFIG)/bin/libejs.a
DEPS_43 += build/$(CONFIG)/obj/ejsHandler.o

build/$(CONFIG)/bin/libmod_ejs.a: $(DEPS_43)
...
DEPS_45 += build/$(CONFIG)/obj/dirHandler.o
DEPS_45 += build/$(CONFIG)/obj/fileHandler.o
DEPS_45 += build/$(CONFIG)/obj/log.o
DEPS_45 += build/$(CONFIG)/obj/server.o
DEPS_45 += build/$(CONFIG)/bin/libappweb.a
DEPS_45 += build/$(CONFIG)/obj/phpHandler.o

build/$(CONFIG)/bin/libmod_php.a: $(DEPS_45)
...
DEPS_47 += build/$(CONFIG)/obj/cgiHandler.o

build/$(CONFIG)/bin/libmod_cgi.a: $(DEPS_47)
...
DEPS_48 += build/$(CONFIG)/inc/appweb.h

build/$(CONFIG)/obj/appweb.o: \
    src/server/appweb.c $(DEPS_48)
	@echo '   [Compile] build/$(CONFIG)/obj/appweb.o'
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/appweb.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" "-I$(ME_COM_PHP_PATH)" "-I$(ME_COM_PHP_PATH)/main" "-I$(ME_COM_PHP_PATH)/Zend" "-I$(ME_COM_PHP_PATH)/TSRM" src/server/appweb.c
...
DEPS_49 += build/$(CONFIG)/bin/libappweb.a
DEPS_49 += src/slink.c
DEPS_49 += build/$(CONFIG)/inc/esp.h
DEPS_49 += build/$(CONFIG)/obj/espLib.o
ifeq ($(ME_COM_ESP),1)
    DEPS_49 += build/$(CONFIG)/bin/libmod_esp.a
endif
DEPS_49 += build/$(CONFIG)/obj/slink.o
DEPS_49 += build/$(CONFIG)/bin/libslink.a
DEPS_49 += build/$(CONFIG)/inc/est.h
DEPS_49 += build/$(CONFIG)/obj/estLib.o
ifeq ($(ME_COM_EST),1)
    DEPS_49 += build/$(CONFIG)/bin/libest.a
endif
DEPS_49 += build/$(CONFIG)/obj/mprSsl.o
DEPS_49 += build/$(CONFIG)/bin/libmprssl.a
DEPS_49 += build/$(CONFIG)/obj/sslModule.o
ifeq ($(ME_COM_SSL),1)
    DEPS_49 += build/$(CONFIG)/bin/libmod_ssl.a
endif
DEPS_49 += build/$(CONFIG)/inc/zlib.h
DEPS_49 += build/$(CONFIG)/obj/zlib.o
ifeq ($(ME_COM_ZLIB),1)
    DEPS_49 += build/$(CONFIG)/bin/libzlib.a
endif
DEPS_49 += build/$(CONFIG)/inc/ejs.h
DEPS_49 += build/$(CONFIG)/inc/ejs.slots.h
DEPS_49 += build/$(CONFIG)/inc/ejsByteGoto.h
DEPS_49 += build/$(CONFIG)/obj/ejsLib.o
ifeq ($(ME_COM_EJS),1)
    DEPS_49 += build/$(CONFIG)/bin/libejs.a
endif
DEPS_49 += build/$(CONFIG)/obj/ejsHandler.o
ifeq ($(ME_COM_EJS),1)
    DEPS_49 += build/$(CONFIG)/bin/libmod_ejs.a
endif
DEPS_49 += build/$(CONFIG)/obj/phpHandler.o
ifeq ($(ME_COM_PHP),1)
    DEPS_49 += build/$(CONFIG)/bin/libmod_php.a
endif
DEPS_49 += build/$(CONFIG)/obj/cgiHandler.o
ifeq ($(ME_COM_CGI),1)
    DEPS_49 += build/$(CONFIG)/bin/libmod_cgi.a
endif
DEPS_49 += build/$(CONFIG)/obj/appweb.o
...
build/$(CONFIG)/bin/appweb: $(DEPS_49)
	@echo '      [Link] build/$(CONFIG)/bin/appweb'
	$(CC) -o build/$(CONFIG)/bin/appweb -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)     "build/$(CONFIG)/obj/appweb.o" $(LIBPATHS_49) $(LIBS_49) $(LIBS_49) $(LIBS) -lpam 

#
#   authpass.o
#
DEPS_50 += build/$(CONFIG)/inc/me.h
DEPS_50 += build/$(CONFIG)/inc/appweb.h
...
DEPS_51 += build/$(CONFIG)/inc/appweb.h
DEPS_51 += build/$(CONFIG)/inc/customize.h
DEPS_51 += build/$(CONFIG)/obj/config.o
DEPS_51 += build/$(CONFIG)/obj/convenience.o
DEPS_51 += build/$(CONFIG)/obj/dirHandler.o
DEPS_51 += build/$(CONFIG)/obj/fileHandler.o
DEPS_51 += build/$(CONFIG)/obj/log.o
DEPS_51 += build/$(CONFIG)/obj/server.o
DEPS_51 += build/$(CONFIG)/bin/libappweb.a
DEPS_51 += build/$(CONFIG)/obj/authpass.o
...
build/$(CONFIG)/bin/authpass: $(DEPS_51)
	@echo '      [Link] build/$(CONFIG)/bin/authpass'
	$(CC) -o build/$(CONFIG)/bin/authpass -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/authpass.o" $(LIBPATHS_51) $(LIBS_51) $(LIBS_51) $(LIBS) -lpam 
...
DEPS_53 += build/$(CONFIG)/obj/cgiProgram.o

build/$(CONFIG)/bin/cgiProgram: $(DEPS_53)
...
DEPS_55 += build/$(CONFIG)/bin/libejs.a
DEPS_55 += build/$(CONFIG)/obj/ejsc.o
...
build/$(CONFIG)/bin/ejsc: $(DEPS_55)
	@echo '      [Link] build/$(CONFIG)/bin/ejsc'
	$(CC) -o build/$(CONFIG)/bin/ejsc -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/ejsc.o" $(LIBPATHS_55) $(LIBS_55) $(LIBS_55) $(LIBS) -lpam 
endif
...
DEPS_56 += build/$(CONFIG)/bin/libejs.a
DEPS_56 += build/$(CONFIG)/obj/ejsc.o
DEPS_56 += build/$(CONFIG)/bin/ejsc

build/$(CONFIG)/bin/ejs.mod: $(DEPS_56)
	( \
	cd src/paks/ejs; \
...
DEPS_58 += build/$(CONFIG)/inc/zlib.h
DEPS_58 += build/$(CONFIG)/obj/zlib.o
ifeq ($(ME_COM_ZLIB),1)
    DEPS_58 += build/$(CONFIG)/bin/libzlib.a
endif
DEPS_58 += build/$(CONFIG)/inc/ejs.h
DEPS_58 += build/$(CONFIG)/inc/ejs.slots.h
DEPS_58 += build/$(CONFIG)/inc/ejsByteGoto.h
DEPS_58 += build/$(CONFIG)/obj/ejsLib.o
DEPS_58 += build/$(CONFIG)/bin/libejs.a
DEPS_58 += build/$(CONFIG)/obj/ejs.o
...
build/$(CONFIG)/bin/ejs: $(DEPS_58)
	@echo '      [Link] build/$(CONFIG)/bin/ejs'
	$(CC) -o build/$(CONFIG)/bin/ejs -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/ejs.o" $(LIBPATHS_58) $(LIBS_58) $(LIBS_58) $(LIBS) -lpam -ledit 
endif
...
build/$(CONFIG)/bin/esp.conf: $(DEPS_60)
...
DEPS_61 += build/$(CONFIG)/inc/esp.h
...
DEPS_62 += build/$(CONFIG)/bin/libappweb.a
DEPS_62 += build/$(CONFIG)/inc/esp.h
DEPS_62 += build/$(CONFIG)/obj/espLib.o
DEPS_62 += build/$(CONFIG)/bin/libmod_esp.a
DEPS_62 += build/$(CONFIG)/obj/esp.o
...
build/$(CONFIG)/bin/esp: $(DEPS_62)
	@echo '      [Link] build/$(CONFIG)/bin/esp'
	$(CC) -o build/$(CONFIG)/bin/esp -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/esp.o" $(LIBPATHS_62) $(LIBS_62) $(LIBS_62) $(LIBS) -lpam 
endif
...
build/$(CONFIG)/obj/http.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/http.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" "-I$(ME_COM_NANOSSL_PATH)/src" src/paks/http/http.c
...
ifeq ($(ME_COM_PCRE),1)
    DEPS_66 += build/$(CONFIG)/bin/libpcre.a
endif
DEPS_66 += build/$(CONFIG)/inc/http.h
DEPS_66 += build/$(CONFIG)/obj/httpLib.o
DEPS_66 += build/$(CONFIG)/bin/libhttp.a
DEPS_66 += build/$(CONFIG)/inc/est.h
DEPS_66 += build/$(CONFIG)/obj/estLib.o
ifeq ($(ME_COM_EST),1)
    DEPS_66 += build/$(CONFIG)/bin/libest.a
endif
DEPS_66 += build/$(CONFIG)/obj/mprSsl.o
DEPS_66 += build/$(CONFIG)/bin/libmprssl.a
DEPS_66 += build/$(CONFIG)/obj/http.o
...
build/$(CONFIG)/bin/http: $(DEPS_66)
	@echo '      [Link] build/$(CONFIG)/bin/http'
	$(CC) -o build/$(CONFIG)/bin/http -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)    "build/$(CONFIG)/obj/http.o" $(LIBPATHS_66) $(LIBS_66) $(LIBS_66) $(LIBS) -lpam 
endif
...
build/$(CONFIG)/bin/libsql.a: $(DEPS_69)
...
DEPS_71 += build/$(CONFIG)/bin/libmpr.a
...
build/$(CONFIG)/bin/appman: $(DEPS_71)
	...
	$(CC) -o build/$(CONFIG)/bin/appman -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/manager.o" $(LIBPATHS_71) $(LIBS_71) $(LIBS_71) $(LIBS) 
...
DEPS_74 += build/$(CONFIG)/bin/libsql.a
...
build/$(CONFIG)/bin/sqlite: $(DEPS_74)
	...
	$(CC) -o build/$(CONFIG)/bin/sqlite -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/sqlite.o" $(LIBPATHS_74) $(LIBS_74) $(LIBS_74) $(LIBS) 
endif
...
build/$(CONFIG)/obj/testAppweb.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/testAppweb.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) test/src/testAppweb.c
...
build/$(CONFIG)/obj/testHttp.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/testHttp.o -arch $(CC_ARCH) $(CFLAGS) $(IFLAGS) test/src/testHttp.c
...
DEPS_78 += build/$(CONFIG)/bin/libappweb.a
...
build/$(CONFIG)/bin/testAppweb: $(DEPS_78)
	...
	$(CC) -o build/$(CONFIG)/bin/testAppweb -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/testAppweb.o" "build/$(CONFIG)/obj/testHttp.o" $(LIBPATHS_78) $(LIBS_78) $(LIBS_78) $(LIBS) -lpam 
...
DEPS_79 += build/$(CONFIG)/bin/libappweb.a
...
DEPS_80 += build/$(CONFIG)/bin/libappweb.a
...
DEPS_82 += build/$(CONFIG)/bin/libappweb.a
...
installBinary: $(DEPS_84)
	...
	ln -s "4.6.3" "$(ME_APP_PREFIX)/latest" ; \
	...
	mkdir -p "$(ME_VAPP_PREFIX)/esp/esp-html-mvc/4.6.3" ; \
	mkdir -p "$(ME_VAPP_PREFIX)/esp/esp-html-mvc/4.6.3/client" ; \
	mkdir -p "$(ME_VAPP_PREFIX)/esp/esp-html-mvc/4.6.3/client/assets" ; \
	cp src/paks/esp-html-mvc/client/assets/favicon.ico $(ME_VAPP_PREFIX)/esp/esp-html-mvc/4.6.3/client/assets/favicon.ico ; \
	mkdir -p "$(ME_VAPP_PREFIX)/esp/esp-html-mvc/4.6.3/client/css" ; \
	cp src/paks/esp-html-mvc/client/css/all.css $(ME_VAPP_PREFIX)/esp/esp-html-mvc/4.6.3/client/css/all.css ; \
	cp src/paks/esp-html-mvc/client/css/all.less $(ME_VAPP_PREFIX)/esp/esp-html-mvc/4.6.3/client/css/all.less ; \
	cp src/paks/esp-html-mvc/client/index.esp $(ME_VAPP_PREFIX)/esp/esp-html-mvc/4.6.3/client/index.esp ; \
	mkdir -p "$(ME_VAPP_PREFIX)/esp/esp-html-mvc/4.6.3/css" ; \
	cp src/paks/esp-html-mvc/css/app.less $(ME_VAPP_PREFIX)/esp/esp-html-mvc/4.6.3/css/app.less ; \
	cp src/paks/esp-html-mvc/css/theme.less $(ME_VAPP_PREFIX)/esp/esp-html-mvc/4.6.3/css/theme.less ; \
	mkdir -p "$(ME_VAPP_PREFIX)/esp/esp-html-mvc/4.6.3/generate" ; \
	cp src/paks/esp-html-mvc/generate/appweb.conf $(ME_VAPP_PREFIX)/esp/esp-html-mvc/4.6.3/generate/appweb.conf ; \
	cp src/paks/esp-html-mvc/generate/controller.c $(ME_VAPP_PREFIX)/esp/esp-html-mvc/4.6.3/generate/controller.c ; \
	cp src/paks/esp-html-mvc/generate/controllerSingleton.c $(ME_VAPP_PREFIX)/esp/esp-html-mvc/4.6.3/generate/controllerSingleton.c ; \
	cp src/paks/esp-html-mvc/generate/edit.esp $(ME_VAPP_PREFIX)/esp/esp-html-mvc/4.6.3/generate/edit.esp ; \
	cp src/paks/esp-html-mvc/generate/list.esp $(ME_VAPP_PREFIX)/esp/esp-html-mvc/4.6.3/generate/list.esp ; \
	mkdir -p "$(ME_VAPP_PREFIX)/esp/esp-html-mvc/4.6.3/layouts" ; \
	cp src/paks/esp-html-mvc/layouts/default.esp $(ME_VAPP_PREFIX)/esp/esp-html-mvc/4.6.3/layouts/default.esp ; \
	cp src/paks/esp-html-mvc/package.json $(ME_VAPP_PREFIX)/esp/esp-html-mvc/4.6.3/package.json ; \
	mkdir -p "$(ME_VAPP_PREFIX)/esp/esp-legacy-mvc/4.6.3" ; \
	mkdir -p "$(ME_VAPP_PREFIX)/esp/esp-legacy-mvc/4.6.3/generate" ; \
	cp src/paks/esp-legacy-mvc/generate/appweb.conf $(ME_VAPP_PREFIX)/esp/esp-legacy-mvc/4.6.3/generate/appweb.conf ; \
	cp src/paks/esp-legacy-mvc/generate/controller.c $(ME_VAPP_PREFIX)/esp/esp-legacy-mvc/4.6.3/generate/controller.c ; \
	cp src/paks/esp-legacy-mvc/generate/edit.esp $(ME_VAPP_PREFIX)/esp/esp-legacy-mvc/4.6.3/generate/edit.esp ; \
	cp src/paks/esp-legacy-mvc/generate/list.esp $(ME_VAPP_PREFIX)/esp/esp-legacy-mvc/4.6.3/generate/list.esp ; \
	cp src/paks/esp-legacy-mvc/generate/migration.c $(ME_VAPP_PREFIX)/esp/esp-legacy-mvc/4.6.3/generate/migration.c ; \
	mkdir -p "$(ME_VAPP_PREFIX)/esp/esp-legacy-mvc/4.6.3/generate/src" ; \
	cp src/paks/esp-legacy-mvc/generate/src/app.c $(ME_VAPP_PREFIX)/esp/esp-legacy-mvc/4.6.3/generate/src/app.c ; \
	mkdir -p "$(ME_VAPP_PREFIX)/esp/esp-legacy-mvc/4.6.3/layouts" ; \
	cp src/paks/esp-legacy-mvc/layouts/default.esp $(ME_VAPP_PREFIX)/esp/esp-legacy-mvc/4.6.3/layouts/default.esp ; \
	cp src/paks/esp-legacy-mvc/package.json $(ME_VAPP_PREFIX)/esp/esp-legacy-mvc/4.6.3/package.json ; \
	mkdir -p "$(ME_VAPP_PREFIX)/esp/esp-legacy-mvc/4.6.3/static" ; \
	mkdir -p "$(ME_VAPP_PREFIX)/esp/esp-legacy-mvc/4.6.3/static/css" ; \
	cp src/paks/esp-legacy-mvc/static/css/all.css $(ME_VAPP_PREFIX)/esp/esp-legacy-mvc/4.6.3/static/css/all.css ; \
	mkdir -p "$(ME_VAPP_PREFIX)/esp/esp-legacy-mvc/4.6.3/static/images" ; \
	cp src/paks/esp-legacy-mvc/static/images/banner.jpg $(ME_VAPP_PREFIX)/esp/esp-legacy-mvc/4.6.3/static/images/banner.jpg ; \
	cp src/paks/esp-legacy-mvc/static/images/favicon.ico $(ME_VAPP_PREFIX)/esp/esp-legacy-mvc/4.6.3/static/images/favicon.ico ; \
	cp src/paks/esp-legacy-mvc/static/images/splash.jpg $(ME_VAPP_PREFIX)/esp/esp-legacy-mvc/4.6.3/static/images/splash.jpg ; \
	cp src/paks/esp-legacy-mvc/static/index.esp $(ME_VAPP_PREFIX)/esp/esp-legacy-mvc/4.6.3/static/index.esp ; \
	mkdir -p "$(ME_VAPP_PREFIX)/esp/esp-legacy-mvc/4.6.3/static/js" ; \
	cp src/paks/esp-legacy-mvc/static/js/jquery.esp.js $(ME_VAPP_PREFIX)/esp/esp-legacy-mvc/4.6.3/static/js/jquery.esp.js ; \
	cp src/paks/esp-legacy-mvc/static/js/jquery.js $(ME_VAPP_PREFIX)/esp/esp-legacy-mvc/4.6.3/static/js/jquery.js ; \
	mkdir -p "$(ME_VAPP_PREFIX)/esp/esp-mvc/4.6.3" ; \
	mkdir -p "$(ME_VAPP_PREFIX)/esp/esp-mvc/4.6.3/generate" ; \
	cp src/paks/esp-mvc/generate/appweb.conf $(ME_VAPP_PREFIX)/esp/esp-mvc/4.6.3/generate/appweb.conf ; \
	cp src/paks/esp-mvc/generate/controller.c $(ME_VAPP_PREFIX)/esp/esp-mvc/4.6.3/generate/controller.c ; \
	cp src/paks/esp-mvc/generate/migration.c $(ME_VAPP_PREFIX)/esp/esp-mvc/4.6.3/generate/migration.c ; \
	mkdir -p "$(ME_VAPP_PREFIX)/esp/esp-mvc/4.6.3/generate/src" ; \
	cp src/paks/esp-mvc/generate/src/app.c $(ME_VAPP_PREFIX)/esp/esp-mvc/4.6.3/generate/src/app.c ; \
	cp src/paks/esp-mvc/LICENSE.md $(ME_VAPP_PREFIX)/esp/esp-mvc/4.6.3/LICENSE.md ; \
	cp src/paks/esp-mvc/package.json $(ME_VAPP_PREFIX)/esp/esp-mvc/4.6.3/package.json ; \
	cp src/paks/esp-mvc/README.md $(ME_VAPP_PREFIX)/esp/esp-mvc/4.6.3/README.md ; \
	mkdir -p "$(ME_VAPP_PREFIX)/esp/esp-server/4.6.3" ; \
	mkdir -p "$(ME_VAPP_PREFIX)/esp/esp-server/4.6.3/generate" ; \
	cp src/paks/esp-server/generate/appweb.conf $(ME_VAPP_PREFIX)/esp/esp-server/4.6.3/generate/appweb.conf ; \
	cp src/paks/esp-server/package.json $(ME_VAPP_PREFIX)/esp/esp-server/4.6.3/package.json ; \
	fi ; \
	if [ "$(ME_COM_ESP)" = 1 ]; then true ; \
