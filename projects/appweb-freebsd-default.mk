...
$(CONFIG)/bin/ejs: $(DEPS_44)
	@echo '      [Link] $(CONFIG)/bin/ejs'
	$(CC) -o $(CONFIG)/bin/ejs $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejs.o" $(LIBPATHS_44) $(LIBS_44) $(LIBS_44) $(LIBS) $(LIBS) 
endif
...
$(CONFIG)/bin/esp: $(DEPS_50)
	...
	$(CC) -o $(CONFIG)/bin/esp $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/esp.o" $(LIBPATHS_50) $(LIBS_50) $(LIBS_50) $(LIBS) $(LIBS) 
endif
...
$(CONFIG)/bin/http: $(DEPS_54)
	...
	$(CC) -o $(CONFIG)/bin/http $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/http.o" $(LIBPATHS_54) $(LIBS_54) $(LIBS_54) $(LIBS) $(LIBS) 
endif
...
$(CONFIG)/bin/libmod_cgi.so: $(DEPS_59)
	@echo '      [Link] $(CONFIG)/bin/libmod_cgi.so'
	$(CC) -shared -o $(CONFIG)/bin/libmod_cgi.so $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/cgiHandler.o" $(LIBPATHS_59) $(LIBS_59) $(LIBS_59) $(LIBS) 
endif
...
$(CONFIG)/bin/libmod_ejs.so: $(DEPS_61)
	@echo '      [Link] $(CONFIG)/bin/libmod_ejs.so'
	$(CC) -shared -o $(CONFIG)/bin/libmod_ejs.so $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsHandler.o" $(LIBPATHS_61) $(LIBS_61) $(LIBS_61) $(LIBS) 
endif
...
DEPS_63 += $(CONFIG)/bin/libappweb.so
...
$(CONFIG)/bin/libmod_php.so: $(DEPS_63)
	@echo '      [Link] $(CONFIG)/bin/libmod_php.so'
	$(CC) -shared -o $(CONFIG)/bin/libmod_php.so $(LDFLAGS) $(LIBPATHS)  "$(CONFIG)/obj/phpHandler.o" $(LIBPATHS_63) $(LIBS_63) $(LIBS_63) $(LIBS) 
endif
...
$(CONFIG)/bin/libmprssl.so: $(DEPS_65)
	@echo '      [Link] $(CONFIG)/bin/libmprssl.so'
	$(CC) -shared -o $(CONFIG)/bin/libmprssl.so $(LDFLAGS) $(LIBPATHS)    "$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_65) $(LIBS_65) $(LIBS_65) $(LIBS) 
...
ifeq ($(ME_COM_EST),1)
    DEPS_67 += $(CONFIG)/bin/libest.so
endif
DEPS_67 += $(CONFIG)/obj/mprSsl.o
DEPS_67 += $(CONFIG)/bin/libmprssl.so
...
$(CONFIG)/bin/libmod_ssl.so: $(DEPS_67)
	@echo '      [Link] $(CONFIG)/bin/libmod_ssl.so'
	$(CC) -shared -o $(CONFIG)/bin/libmod_ssl.so $(LDFLAGS) $(LIBPATHS)    "$(CONFIG)/obj/sslModule.o" $(LIBPATHS_67) $(LIBS_67) $(LIBS_67) $(LIBS) 
endif
...
$(CONFIG)/bin/appman: $(DEPS_72)
	@echo '      [Link] $(CONFIG)/bin/appman'
	$(CC) -o $(CONFIG)/bin/appman $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/manager.o" $(LIBPATHS_72) $(LIBS_72) $(LIBS_72) $(LIBS) $(LIBS) 
...
DEPS_75 += $(CONFIG)/bin/libsql.so
DEPS_75 += $(CONFIG)/obj/sqlite.o

LIBS_75 += -lsql

$(CONFIG)/bin/sqlite: $(DEPS_75)
	@echo '      [Link] $(CONFIG)/bin/sqlite'
	$(CC) -o $(CONFIG)/bin/sqlite $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/sqlite.o" $(LIBPATHS_75) $(LIBS_75) $(LIBS_75) $(LIBS) $(LIBS) 
endif
...
$(CONFIG)/bin/testAppweb: $(DEPS_79)
	@echo '      [Link] $(CONFIG)/bin/testAppweb'
	$(CC) -o $(CONFIG)/bin/testAppweb $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/testAppweb.o" "$(CONFIG)/obj/testHttp.o" $(LIBPATHS_79) $(LIBS_79) $(LIBS_79) $(LIBS) $(LIBS) 
...
DEPS_82 += $(CONFIG)/bin/cgiProgram

test/cgi-bin/cgiProgram: $(DEPS_82)
	( \
	cd test; \
