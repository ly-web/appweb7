...
$(CONFIG)/bin/appman: $(DEPS_11)
	...
	$(CC) -o $(CONFIG)/bin/appman $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/manager.o $(LIBPATHS_11) $(LIBS_11) $(LIBS_11) $(LIBS) -lpthread -lm -ldl $(LDFLAGS) 
...
$(CONFIG)/bin/makerom: $(DEPS_13)
	...
	$(CC) -o $(CONFIG)/bin/makerom $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/makerom.o $(LIBPATHS_13) $(LIBS_13) $(LIBS_13) $(LIBS) -lpthread -lm -ldl $(LDFLAGS) 
