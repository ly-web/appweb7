...
$(CONFIG)/bin/http: $(DEPS_52)
	...
	$(CC) -o $(CONFIG)/bin/http $(LIBPATHS) "$(CONFIG)/obj/http.o" $(LIBPATHS_52) $(LIBS_52) $(LIBS_52) $(LIBS) $(LIBS) 
endif
...
$(CONFIG)/bin/libmod_cgi.so: $(DEPS_57)
	...
	$(CC) -shared -o $(CONFIG)/bin/libmod_cgi.so $(LIBPATHS) "$(CONFIG)/obj/cgiHandler.o" $(LIBPATHS_57) $(LIBS_57) $(LIBS_57) $(LIBS) 
endif
...
$(CONFIG)/bin/libmod_ejs.so: $(DEPS_59)
	...
	$(CC) -shared -o $(CONFIG)/bin/libmod_ejs.so $(LIBPATHS) "$(CONFIG)/obj/ejsHandler.o" $(LIBPATHS_59) $(LIBS_59) $(LIBS_59) $(LIBS) 
endif
...
$(CONFIG)/bin/libmprssl.so: $(DEPS_63)
	...
	$(CC) -shared -o $(CONFIG)/bin/libmprssl.so $(LIBPATHS)   "$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_63) $(LIBS_63) $(LIBS_63) $(LIBS) 
...
$(CONFIG)/bin/libmod_ssl.so: $(DEPS_65)
	...
	$(CC) -shared -o $(CONFIG)/bin/libmod_ssl.so $(LIBPATHS)   "$(CONFIG)/obj/sslModule.o" $(LIBPATHS_65) $(LIBS_65) $(LIBS_65) $(LIBS) 
endif
...
$(CONFIG)/bin/appman: $(DEPS_70)
	...
	$(CC) -o $(CONFIG)/bin/appman $(LIBPATHS) "$(CONFIG)/obj/manager.o" $(LIBPATHS_70) $(LIBS_70) $(LIBS_70) $(LIBS) $(LIBS) 
...
$(CONFIG)/bin/sqlite: $(DEPS_73)
	...
	$(CC) -o $(CONFIG)/bin/sqlite $(LIBPATHS) "$(CONFIG)/obj/sqlite.o" $(LIBPATHS_73) $(LIBS_73) $(LIBS_73) $(LIBS) $(LIBS) 
endif
...
$(CONFIG)/bin/testAppweb: $(DEPS_77)
	...
	$(CC) -o $(CONFIG)/bin/testAppweb $(LIBPATHS) "$(CONFIG)/obj/testAppweb.o" "$(CONFIG)/obj/testHttp.o" $(LIBPATHS_77) $(LIBS_77) $(LIBS_77) $(LIBS) $(LIBS) 
