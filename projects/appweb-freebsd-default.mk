...
$(CONFIG)/bin/libslink.so: $(DEPS_79)
	@echo '      [Link] libslink'
	$(CC) -shared -o $(CONFIG)/bin/libslink.so $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/slink.o $(LIBS_79) $(LIBS_79) $(LIBS) -lmpr
...
DEPS_81 += $(CONFIG)/bin/libslink.so
