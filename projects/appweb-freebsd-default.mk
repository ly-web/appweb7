...
$(BUILD)/obj/matrixssl.o: \
	...
	$(CC) -c -o $(BUILD)/obj/matrixssl.o $(LDFLAGS) $(CFLAGS) $(DFLAGS) "-I$(ME_COM_MATRIXSSL_PATH)" "-I$(ME_COM_MATRIXSSL_PATH)/matrixssl" src/mpr-matrixssl/matrixssl.c
...
$(BUILD)/obj/mbedtls.o: \
	...
	$(CC) -c -o $(BUILD)/obj/mbedtls.o $(LDFLAGS) $(CFLAGS) $(DFLAGS) "-I$(ME_COM_MBEDTLS_PATH)/include" src/mpr-mbedtls/mbedtls.c
...
$(BUILD)/obj/nanossl.o: \
	...
	$(CC) -c -o $(BUILD)/obj/nanossl.o $(LDFLAGS) $(CFLAGS) $(DFLAGS) "-I$(ME_COM_NANOSSL_PATH)/src" src/mpr-nanossl/nanossl.c
...
$(BUILD)/bin/esp: $(DEPS_52)
	...
	$(CC) -o $(BUILD)/bin/esp $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/esp.o" $(LIBPATHS_52) $(LIBS_52) $(LIBS_52) $(LIBS) $(LIBS) 
endif
...
$(BUILD)/bin/appman: $(DEPS_56)
	...
	$(CC) -o $(BUILD)/bin/appman $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/watchdog.o" $(LIBPATHS_56) $(LIBS_56) $(LIBS_56) $(LIBS) $(LIBS) 
