...
$(CONFIG)/bin/libappweb.so: $(DEPS_21)
	@echo '      [Link] $(CONFIG)/bin/libappweb.so'
	$(CC) -shared -o $(CONFIG)/bin/libappweb.so $(LIBPATHS) "$(CONFIG)/obj/config.o" "$(CONFIG)/obj/convenience.o" "$(CONFIG)/obj/dirHandler.o" "$(CONFIG)/obj/fileHandler.o" "$(CONFIG)/obj/log.o" "$(CONFIG)/obj/server.o" $(LIBPATHS_21) $(LIBS_21) $(LIBS_21) $(LIBS) 
...
DEPS_24 += $(CONFIG)/bin/libappweb.so
...
$(CONFIG)/bin/libmod_esp.so: $(DEPS_24)
	@echo '      [Link] $(CONFIG)/bin/libmod_esp.so'
	$(CC) -shared -o $(CONFIG)/bin/libmod_esp.so $(LIBPATHS) "$(CONFIG)/obj/espLib.o" $(LIBPATHS_24) $(LIBS_24) $(LIBS_24) $(LIBS) 
endif
...
DEPS_26 += $(CONFIG)/bin/libmod_esp.so
...
$(CONFIG)/bin/esp: $(DEPS_26)
	...
	$(CC) -o $(CONFIG)/bin/esp $(LIBPATHS) "$(CONFIG)/obj/esp.o" "$(CONFIG)/obj/espLib.o" $(LIBPATHS_26) $(LIBS_26) $(LIBS_26) $(LIBS) $(LIBS) 
endif
...
$(CONFIG)/bin/http: $(DEPS_34)
	...
	$(CC) -o $(CONFIG)/bin/http $(LIBPATHS) "$(CONFIG)/obj/http.o" $(LIBPATHS_34) $(LIBS_34) $(LIBS_34) $(LIBS) $(LIBS) 
...
$(CONFIG)/bin/libmprssl.so: $(DEPS_36)
	@echo '      [Link] $(CONFIG)/bin/libmprssl.so'
	$(CC) -shared -o $(CONFIG)/bin/libmprssl.so $(LIBPATHS) "$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_36) $(LIBS_36) $(LIBS_36) $(LIBS) 
...
$(CONFIG)/bin/appman: $(DEPS_38)
	...
	$(CC) -o $(CONFIG)/bin/appman $(LIBPATHS) "$(CONFIG)/obj/manager.o" $(LIBPATHS_38) $(LIBS_38) $(LIBS_38) $(LIBS) $(LIBS) 
...
$(CONFIG)/bin/libslink.so: $(DEPS_41)
...
DEPS_43 += $(CONFIG)/bin/libappweb.so
...
DEPS_43 += $(CONFIG)/bin/libmprssl.so
...
$(CONFIG)/bin/libmod_ssl.so: $(DEPS_43)
	@echo '      [Link] $(CONFIG)/bin/libmod_ssl.so'
	$(CC) -shared -o $(CONFIG)/bin/libmod_ssl.so $(LIBPATHS) "$(CONFIG)/obj/sslModule.o" $(LIBPATHS_43) $(LIBS_43) $(LIBS_43) $(LIBS) 
endif
...
DEPS_45 += $(CONFIG)/bin/libappweb.so
...
$(CONFIG)/bin/authpass: $(DEPS_45)
	@echo '      [Link] $(CONFIG)/bin/authpass'
	$(CC) -o $(CONFIG)/bin/authpass $(LIBPATHS) "$(CONFIG)/obj/authpass.o" $(LIBPATHS_45) $(LIBS_45) $(LIBS_45) $(LIBS) $(LIBS) 
...
DEPS_47 += $(CONFIG)/bin/libslink.so
...
$(CONFIG)/bin/appweb: $(DEPS_47)
	@echo '      [Link] $(CONFIG)/bin/appweb'
	$(CC) -o $(CONFIG)/bin/appweb $(LIBPATHS) "$(CONFIG)/obj/appweb.o" $(LIBPATHS_47) $(LIBS_47) $(LIBS_47) $(LIBS) $(LIBS) 
...
$(CONFIG)/bin/testAppweb: $(DEPS_52)
	@echo '      [Link] $(CONFIG)/bin/testAppweb'
	$(CC) -o $(CONFIG)/bin/testAppweb $(LIBPATHS) "$(CONFIG)/obj/testAppweb.o" "$(CONFIG)/obj/testHttp.o" $(LIBPATHS_52) $(LIBS_52) $(LIBS_52) $(LIBS) $(LIBS) 
