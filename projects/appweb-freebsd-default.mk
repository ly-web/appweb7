...
$(CONFIG)/bin/libhttp.so: $(DEPS_25)
	@echo '      [Link] $(CONFIG)/bin/libhttp.so'
	$(CC) -shared -o $(CONFIG)/bin/libhttp.so $(LIBPATHS) "$(CONFIG)/obj/httpLib.o" $(LIBPATHS_25) $(LIBS_25) $(LIBS_25) $(LIBS) 
...
$(CONFIG)/bin/sqlite: $(DEPS_32)
	...
	$(CC) -o $(CONFIG)/bin/sqlite $(LIBPATHS) "$(CONFIG)/obj/sqlite.o" $(LIBPATHS_32) $(LIBS_32) $(LIBS_32) $(LIBS) $(LIBS) 
endif
...
$(CONFIG)/bin/libappweb.so: $(DEPS_41)
	@echo '      [Link] $(CONFIG)/bin/libappweb.so'
	$(CC) -shared -o $(CONFIG)/bin/libappweb.so $(LIBPATHS) "$(CONFIG)/obj/config.o" "$(CONFIG)/obj/convenience.o" "$(CONFIG)/obj/dirHandler.o" "$(CONFIG)/obj/fileHandler.o" "$(CONFIG)/obj/log.o" "$(CONFIG)/obj/server.o" $(LIBPATHS_41) $(LIBS_41) $(LIBS_41) $(LIBS) 
...
$(CONFIG)/bin/libmod_esp.so: $(DEPS_54)
	...
	$(CC) -shared -o $(CONFIG)/bin/libmod_esp.so $(LIBPATHS) "$(CONFIG)/obj/edi.o" "$(CONFIG)/obj/espAbbrev.o" "$(CONFIG)/obj/espDeprecated.o" "$(CONFIG)/obj/espFramework.o" "$(CONFIG)/obj/espHandler.o" "$(CONFIG)/obj/espHtml.o" "$(CONFIG)/obj/espTemplate.o" "$(CONFIG)/obj/mdb.o" "$(CONFIG)/obj/sdb.o" $(LIBPATHS_54) $(LIBS_54) $(LIBS_54) $(LIBS) 
endif
...
$(CONFIG)/bin/esp: $(DEPS_56)
	...
	$(CC) -o $(CONFIG)/bin/esp $(LIBPATHS) "$(CONFIG)/obj/edi.o" "$(CONFIG)/obj/esp.o" "$(CONFIG)/obj/espAbbrev.o" "$(CONFIG)/obj/espDeprecated.o" "$(CONFIG)/obj/espFramework.o" "$(CONFIG)/obj/espHandler.o" "$(CONFIG)/obj/espHtml.o" "$(CONFIG)/obj/espTemplate.o" "$(CONFIG)/obj/mdb.o" "$(CONFIG)/obj/sdb.o" $(LIBPATHS_56) $(LIBS_56) $(LIBS_56) $(LIBS) $(LIBS) 
endif
...
$(CONFIG)/esp: $(DEPS_59)
	( \
	cd src/esp/paks; \
	mkdir -p "../../../$(CONFIG)/esp/angular/1.2.6" ; \
	cp angular/angular-animate.js ../../../$(CONFIG)/esp/angular/1.2.6/angular-animate.js ; \
	cp angular/angular-csp.css ../../../$(CONFIG)/esp/angular/1.2.6/angular-csp.css ; \
	cp angular/angular-route.js ../../../$(CONFIG)/esp/angular/1.2.6/angular-route.js ; \
	cp angular/angular.js ../../../$(CONFIG)/esp/angular/1.2.6/angular.js ; \
	cp angular/package.json ../../../$(CONFIG)/esp/angular/1.2.6/package.json ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-angular/4.5.4" ; \
	cp esp-angular/esp-click.js ../../../$(CONFIG)/esp/esp-angular/4.5.4/esp-click.js ; \
	cp esp-angular/esp-edit.js ../../../$(CONFIG)/esp/esp-angular/4.5.4/esp-edit.js ; \
	cp esp-angular/esp-field-errors.js ../../../$(CONFIG)/esp/esp-angular/4.5.4/esp-field-errors.js ; \
	cp esp-angular/esp-fixnum.js ../../../$(CONFIG)/esp/esp-angular/4.5.4/esp-fixnum.js ; \
	cp esp-angular/esp-format.js ../../../$(CONFIG)/esp/esp-angular/4.5.4/esp-format.js ; \
	cp esp-angular/esp-input-group.js ../../../$(CONFIG)/esp/esp-angular/4.5.4/esp-input-group.js ; \
	cp esp-angular/esp-input.js ../../../$(CONFIG)/esp/esp-angular/4.5.4/esp-input.js ; \
	cp esp-angular/esp-resource.js ../../../$(CONFIG)/esp/esp-angular/4.5.4/esp-resource.js ; \
	cp esp-angular/esp-session.js ../../../$(CONFIG)/esp/esp-angular/4.5.4/esp-session.js ; \
	cp esp-angular/esp-titlecase.js ../../../$(CONFIG)/esp/esp-angular/4.5.4/esp-titlecase.js ; \
	cp esp-angular/esp.js ../../../$(CONFIG)/esp/esp-angular/4.5.4/esp.js ; \
	cp esp-angular/package.json ../../../$(CONFIG)/esp/esp-angular/4.5.4/package.json ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-angular-mvc/4.5.4" ; \
	cp esp-angular-mvc/package.json ../../../$(CONFIG)/esp/esp-angular-mvc/4.5.4/package.json ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-angular-mvc/4.5.4/templates" ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc" ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/appweb.conf ../../../$(CONFIG)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/appweb.conf ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client" ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client/app" ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/client/app/main.js ../../../$(CONFIG)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client/app/main.js ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client/assets" ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/client/assets/favicon.ico ../../../$(CONFIG)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client/assets/favicon.ico ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client/css" ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/client/css/all.css ../../../$(CONFIG)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client/css/all.css ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/client/css/all.less ../../../$(CONFIG)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client/css/all.less ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/client/css/app.less ../../../$(CONFIG)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client/css/app.less ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/client/css/fix.css ../../../$(CONFIG)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client/css/fix.css ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/client/css/theme.less ../../../$(CONFIG)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client/css/theme.less ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/client/index.esp ../../../$(CONFIG)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client/index.esp ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client/pages" ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/client/pages/splash.html ../../../$(CONFIG)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client/pages/splash.html ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/controller-singleton.c ../../../$(CONFIG)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/controller-singleton.c ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/controller.c ../../../$(CONFIG)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/controller.c ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/controller.js ../../../$(CONFIG)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/controller.js ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/edit.html ../../../$(CONFIG)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/edit.html ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/list.html ../../../$(CONFIG)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/list.html ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/model.js ../../../$(CONFIG)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/model.js ; \
	cp esp-angular-mvc/templates/esp-angular-mvc/start.bit ../../../$(CONFIG)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/start.bit ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-html-mvc/4.5.4" ; \
	cp esp-html-mvc/package.json ../../../$(CONFIG)/esp/esp-html-mvc/4.5.4/package.json ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-html-mvc/4.5.4/templates" ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc" ; \
	cp esp-html-mvc/templates/esp-html-mvc/appweb.conf ../../../$(CONFIG)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/appweb.conf ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/client" ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/client/assets" ; \
	cp esp-html-mvc/templates/esp-html-mvc/client/assets/favicon.ico ../../../$(CONFIG)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/client/assets/favicon.ico ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/client/css" ; \
	cp esp-html-mvc/templates/esp-html-mvc/client/css/all.css ../../../$(CONFIG)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/client/css/all.css ; \
	cp esp-html-mvc/templates/esp-html-mvc/client/css/all.less ../../../$(CONFIG)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/client/css/all.less ; \
	cp esp-html-mvc/templates/esp-html-mvc/client/css/app.less ../../../$(CONFIG)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/client/css/app.less ; \
	cp esp-html-mvc/templates/esp-html-mvc/client/css/theme.less ../../../$(CONFIG)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/client/css/theme.less ; \
	cp esp-html-mvc/templates/esp-html-mvc/client/index.esp ../../../$(CONFIG)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/client/index.esp ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/client/layouts" ; \
	cp esp-html-mvc/templates/esp-html-mvc/client/layouts/default.esp ../../../$(CONFIG)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/client/layouts/default.esp ; \
	cp esp-html-mvc/templates/esp-html-mvc/controller-singleton.c ../../../$(CONFIG)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/controller-singleton.c ; \
	cp esp-html-mvc/templates/esp-html-mvc/controller.c ../../../$(CONFIG)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/controller.c ; \
	cp esp-html-mvc/templates/esp-html-mvc/edit.esp ../../../$(CONFIG)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/edit.esp ; \
	cp esp-html-mvc/templates/esp-html-mvc/list.esp ../../../$(CONFIG)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/list.esp ; \
	cp esp-html-mvc/templates/esp-html-mvc/start.bit ../../../$(CONFIG)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/start.bit ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-legacy-mvc/4.5.4" ; \
	cp esp-legacy-mvc/package.json ../../../$(CONFIG)/esp/esp-legacy-mvc/4.5.4/package.json ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-legacy-mvc/4.5.4/templates" ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc" ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/appweb.conf ../../../$(CONFIG)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/appweb.conf ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/controller.c ../../../$(CONFIG)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/controller.c ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/edit.esp ../../../$(CONFIG)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/edit.esp ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/layouts" ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/layouts/default.esp ../../../$(CONFIG)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/layouts/default.esp ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/list.esp ../../../$(CONFIG)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/list.esp ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/migration.c ../../../$(CONFIG)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/migration.c ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/src" ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/src/app.c ../../../$(CONFIG)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/src/app.c ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/static" ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/static/css" ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/static/css/all.css ../../../$(CONFIG)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/static/css/all.css ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/static/images" ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/static/images/banner.jpg ../../../$(CONFIG)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/static/images/banner.jpg ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/static/images/favicon.ico ../../../$(CONFIG)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/static/images/favicon.ico ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/static/images/splash.jpg ../../../$(CONFIG)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/static/images/splash.jpg ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/static/index.esp ../../../$(CONFIG)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/static/index.esp ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/static/js" ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/static/js/jquery.esp.js ../../../$(CONFIG)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/static/js/jquery.esp.js ; \
	cp esp-legacy-mvc/templates/esp-legacy-mvc/static/js/jquery.js ../../../$(CONFIG)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/static/js/jquery.js ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-server/4.5.4" ; \
	cp esp-server/package.json ../../../$(CONFIG)/esp/esp-server/4.5.4/package.json ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-server/4.5.4/templates" ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-server/4.5.4/templates/esp-server" ; \
	cp esp-server/templates/esp-server/appweb.conf ../../../$(CONFIG)/esp/esp-server/4.5.4/templates/esp-server/appweb.conf ; \
	cp esp-server/templates/esp-server/controller.c ../../../$(CONFIG)/esp/esp-server/4.5.4/templates/esp-server/controller.c ; \
	cp esp-server/templates/esp-server/migration.c ../../../$(CONFIG)/esp/esp-server/4.5.4/templates/esp-server/migration.c ; \
	mkdir -p "../../../$(CONFIG)/esp/esp-server/4.5.4/templates/esp-server/src" ; \
	cp esp-server/templates/esp-server/src/app.c ../../../$(CONFIG)/esp/esp-server/4.5.4/templates/esp-server/src/app.c ; \
	)
endif
...
$(CONFIG)/bin/libejs.so: $(DEPS_64)
	@echo '      [Link] $(CONFIG)/bin/libejs.so'
	$(CC) -shared -o $(CONFIG)/bin/libejs.so $(LIBPATHS) "$(CONFIG)/obj/ejsLib.o" $(LIBPATHS_64) $(LIBS_64) $(LIBS_64) $(LIBS) 
endif
...
$(CONFIG)/bin/ejs: $(DEPS_66)
	...
	$(CC) -o $(CONFIG)/bin/ejs $(LIBPATHS) "$(CONFIG)/obj/ejs.o" $(LIBPATHS_66) $(LIBS_66) $(LIBS_66) $(LIBS) $(LIBS) 
endif
...
$(CONFIG)/bin/ejsc: $(DEPS_68)
	...
	$(CC) -o $(CONFIG)/bin/ejsc $(LIBPATHS) "$(CONFIG)/obj/ejsc.o" $(LIBPATHS_68) $(LIBS_68) $(LIBS_68) $(LIBS) $(LIBS) 
endif
...
$(CONFIG)/bin/libmod_cgi.so: $(DEPS_71)
	@echo '      [Link] $(CONFIG)/bin/libmod_cgi.so'
	$(CC) -shared -o $(CONFIG)/bin/libmod_cgi.so $(LIBPATHS) "$(CONFIG)/obj/cgiHandler.o" $(LIBPATHS_71) $(LIBS_71) $(LIBS_71) $(LIBS) 
endif
...
$(CONFIG)/bin/libmod_ejs.so: $(DEPS_73)
	@echo '      [Link] $(CONFIG)/bin/libmod_ejs.so'
	$(CC) -shared -o $(CONFIG)/bin/libmod_ejs.so $(LIBPATHS) "$(CONFIG)/obj/ejsHandler.o" $(LIBPATHS_73) $(LIBS_73) $(LIBS_73) $(LIBS) 
endif
...
$(CONFIG)/bin/libmod_php.so: $(DEPS_75)
	@echo '      [Link] $(CONFIG)/bin/libmod_php.so'
	$(CC) -shared -o $(CONFIG)/bin/libmod_php.so $(LIBPATHS)  "$(CONFIG)/obj/phpHandler.o" $(LIBPATHS_75) $(LIBS_75) $(LIBS_75) $(LIBS) 
endif
...
ifeq ($(BIT_PACK_EST),1)
    DEPS_77 += $(CONFIG)/bin/libest.so
endif
DEPS_77 += $(CONFIG)/obj/mprSsl.o
DEPS_77 += $(CONFIG)/bin/libmprssl.so
...
$(CONFIG)/bin/libmod_ssl.so: $(DEPS_77)
	@echo '      [Link] $(CONFIG)/bin/libmod_ssl.so'
	$(CC) -shared -o $(CONFIG)/bin/libmod_ssl.so $(LIBPATHS)    "$(CONFIG)/obj/sslModule.o" $(LIBPATHS_77) $(LIBS_77) $(LIBS_77) $(LIBS) 
endif
...
$(CONFIG)/bin/authpass: $(DEPS_79)
	...
	$(CC) -o $(CONFIG)/bin/authpass $(LIBPATHS) "$(CONFIG)/obj/authpass.o" $(LIBPATHS_79) $(LIBS_79) $(LIBS_79) $(LIBS) $(LIBS) 
...
$(CONFIG)/bin/libslink.so: $(DEPS_84)
...
DEPS_86 += $(CONFIG)/bin/libslink.so
...
$(CONFIG)/bin/appweb: $(DEPS_86)
	...
	$(CC) -o $(CONFIG)/bin/appweb $(LIBPATHS) "$(CONFIG)/obj/appweb.o" $(LIBPATHS_86) $(LIBS_86) $(LIBS_86) $(LIBS) $(LIBS) 
...
$(CONFIG)/bin/testAppweb: $(DEPS_91)
	...
	$(CC) -o $(CONFIG)/bin/testAppweb $(LIBPATHS) "$(CONFIG)/obj/testAppweb.o" "$(CONFIG)/obj/testHttp.o" $(LIBPATHS_91) $(LIBS_91) $(LIBS_91) $(LIBS) $(LIBS) 
...
DEPS_92 += $(CONFIG)/bin/libappweb.so
...
DEPS_93 += $(CONFIG)/bin/libappweb.so
...
DEPS_94 += $(CONFIG)/bin/libappweb.so
...
installBinary: $(DEPS_97)
	...
	ln -s "4.5.4" "$(BIT_APP_PREFIX)/latest" ; \
	...
	if [ "$(BIT_PACK_ESP)" = 1 ]; then true ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/angular/1.2.6" ; \
	cp src/esp/paks/angular/angular-animate.js $(BIT_VAPP_PREFIX)/esp/angular/1.2.6/angular-animate.js ; \
	cp src/esp/paks/angular/angular-csp.css $(BIT_VAPP_PREFIX)/esp/angular/1.2.6/angular-csp.css ; \
	cp src/esp/paks/angular/angular-route.js $(BIT_VAPP_PREFIX)/esp/angular/1.2.6/angular-route.js ; \
	cp src/esp/paks/angular/angular.js $(BIT_VAPP_PREFIX)/esp/angular/1.2.6/angular.js ; \
	cp src/esp/paks/angular/package.json $(BIT_VAPP_PREFIX)/esp/angular/1.2.6/package.json ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-angular/4.5.4" ; \
	cp src/esp/paks/esp-angular/esp-click.js $(BIT_VAPP_PREFIX)/esp/esp-angular/4.5.4/esp-click.js ; \
	cp src/esp/paks/esp-angular/esp-edit.js $(BIT_VAPP_PREFIX)/esp/esp-angular/4.5.4/esp-edit.js ; \
	cp src/esp/paks/esp-angular/esp-field-errors.js $(BIT_VAPP_PREFIX)/esp/esp-angular/4.5.4/esp-field-errors.js ; \
	cp src/esp/paks/esp-angular/esp-fixnum.js $(BIT_VAPP_PREFIX)/esp/esp-angular/4.5.4/esp-fixnum.js ; \
	cp src/esp/paks/esp-angular/esp-format.js $(BIT_VAPP_PREFIX)/esp/esp-angular/4.5.4/esp-format.js ; \
	cp src/esp/paks/esp-angular/esp-input-group.js $(BIT_VAPP_PREFIX)/esp/esp-angular/4.5.4/esp-input-group.js ; \
	cp src/esp/paks/esp-angular/esp-input.js $(BIT_VAPP_PREFIX)/esp/esp-angular/4.5.4/esp-input.js ; \
	cp src/esp/paks/esp-angular/esp-resource.js $(BIT_VAPP_PREFIX)/esp/esp-angular/4.5.4/esp-resource.js ; \
	cp src/esp/paks/esp-angular/esp-session.js $(BIT_VAPP_PREFIX)/esp/esp-angular/4.5.4/esp-session.js ; \
	cp src/esp/paks/esp-angular/esp-titlecase.js $(BIT_VAPP_PREFIX)/esp/esp-angular/4.5.4/esp-titlecase.js ; \
	cp src/esp/paks/esp-angular/esp.js $(BIT_VAPP_PREFIX)/esp/esp-angular/4.5.4/esp.js ; \
	cp src/esp/paks/esp-angular/package.json $(BIT_VAPP_PREFIX)/esp/esp-angular/4.5.4/package.json ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-angular-mvc/4.5.4" ; \
	cp src/esp/paks/esp-angular-mvc/package.json $(BIT_VAPP_PREFIX)/esp/esp-angular-mvc/4.5.4/package.json ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-angular-mvc/4.5.4/templates" ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc" ; \
	cp src/esp/paks/esp-angular-mvc/templates/esp-angular-mvc/appweb.conf $(BIT_VAPP_PREFIX)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/appweb.conf ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client" ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client/app" ; \
	cp src/esp/paks/esp-angular-mvc/templates/esp-angular-mvc/client/app/main.js $(BIT_VAPP_PREFIX)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client/app/main.js ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client/assets" ; \
	cp src/esp/paks/esp-angular-mvc/templates/esp-angular-mvc/client/assets/favicon.ico $(BIT_VAPP_PREFIX)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client/assets/favicon.ico ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client/css" ; \
	cp src/esp/paks/esp-angular-mvc/templates/esp-angular-mvc/client/css/all.css $(BIT_VAPP_PREFIX)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client/css/all.css ; \
	cp src/esp/paks/esp-angular-mvc/templates/esp-angular-mvc/client/css/all.less $(BIT_VAPP_PREFIX)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client/css/all.less ; \
	cp src/esp/paks/esp-angular-mvc/templates/esp-angular-mvc/client/css/app.less $(BIT_VAPP_PREFIX)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client/css/app.less ; \
	cp src/esp/paks/esp-angular-mvc/templates/esp-angular-mvc/client/css/fix.css $(BIT_VAPP_PREFIX)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client/css/fix.css ; \
	cp src/esp/paks/esp-angular-mvc/templates/esp-angular-mvc/client/css/theme.less $(BIT_VAPP_PREFIX)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client/css/theme.less ; \
	cp src/esp/paks/esp-angular-mvc/templates/esp-angular-mvc/client/index.esp $(BIT_VAPP_PREFIX)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client/index.esp ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client/pages" ; \
	cp src/esp/paks/esp-angular-mvc/templates/esp-angular-mvc/client/pages/splash.html $(BIT_VAPP_PREFIX)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/client/pages/splash.html ; \
	cp src/esp/paks/esp-angular-mvc/templates/esp-angular-mvc/controller-singleton.c $(BIT_VAPP_PREFIX)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/controller-singleton.c ; \
	cp src/esp/paks/esp-angular-mvc/templates/esp-angular-mvc/controller.c $(BIT_VAPP_PREFIX)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/controller.c ; \
	cp src/esp/paks/esp-angular-mvc/templates/esp-angular-mvc/controller.js $(BIT_VAPP_PREFIX)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/controller.js ; \
	cp src/esp/paks/esp-angular-mvc/templates/esp-angular-mvc/edit.html $(BIT_VAPP_PREFIX)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/edit.html ; \
	cp src/esp/paks/esp-angular-mvc/templates/esp-angular-mvc/list.html $(BIT_VAPP_PREFIX)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/list.html ; \
	cp src/esp/paks/esp-angular-mvc/templates/esp-angular-mvc/model.js $(BIT_VAPP_PREFIX)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/model.js ; \
	cp src/esp/paks/esp-angular-mvc/templates/esp-angular-mvc/start.bit $(BIT_VAPP_PREFIX)/esp/esp-angular-mvc/4.5.4/templates/esp-angular-mvc/start.bit ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-html-mvc/4.5.4" ; \
	cp src/esp/paks/esp-html-mvc/package.json $(BIT_VAPP_PREFIX)/esp/esp-html-mvc/4.5.4/package.json ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-html-mvc/4.5.4/templates" ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc" ; \
	cp src/esp/paks/esp-html-mvc/templates/esp-html-mvc/appweb.conf $(BIT_VAPP_PREFIX)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/appweb.conf ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/client" ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/client/assets" ; \
	cp src/esp/paks/esp-html-mvc/templates/esp-html-mvc/client/assets/favicon.ico $(BIT_VAPP_PREFIX)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/client/assets/favicon.ico ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/client/css" ; \
	cp src/esp/paks/esp-html-mvc/templates/esp-html-mvc/client/css/all.css $(BIT_VAPP_PREFIX)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/client/css/all.css ; \
	cp src/esp/paks/esp-html-mvc/templates/esp-html-mvc/client/css/all.less $(BIT_VAPP_PREFIX)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/client/css/all.less ; \
	cp src/esp/paks/esp-html-mvc/templates/esp-html-mvc/client/css/app.less $(BIT_VAPP_PREFIX)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/client/css/app.less ; \
	cp src/esp/paks/esp-html-mvc/templates/esp-html-mvc/client/css/theme.less $(BIT_VAPP_PREFIX)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/client/css/theme.less ; \
	cp src/esp/paks/esp-html-mvc/templates/esp-html-mvc/client/index.esp $(BIT_VAPP_PREFIX)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/client/index.esp ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/client/layouts" ; \
	cp src/esp/paks/esp-html-mvc/templates/esp-html-mvc/client/layouts/default.esp $(BIT_VAPP_PREFIX)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/client/layouts/default.esp ; \
	cp src/esp/paks/esp-html-mvc/templates/esp-html-mvc/controller-singleton.c $(BIT_VAPP_PREFIX)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/controller-singleton.c ; \
	cp src/esp/paks/esp-html-mvc/templates/esp-html-mvc/controller.c $(BIT_VAPP_PREFIX)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/controller.c ; \
	cp src/esp/paks/esp-html-mvc/templates/esp-html-mvc/edit.esp $(BIT_VAPP_PREFIX)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/edit.esp ; \
	cp src/esp/paks/esp-html-mvc/templates/esp-html-mvc/list.esp $(BIT_VAPP_PREFIX)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/list.esp ; \
	cp src/esp/paks/esp-html-mvc/templates/esp-html-mvc/start.bit $(BIT_VAPP_PREFIX)/esp/esp-html-mvc/4.5.4/templates/esp-html-mvc/start.bit ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-legacy-mvc/4.5.4" ; \
	cp src/esp/paks/esp-legacy-mvc/package.json $(BIT_VAPP_PREFIX)/esp/esp-legacy-mvc/4.5.4/package.json ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-legacy-mvc/4.5.4/templates" ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc" ; \
	cp src/esp/paks/esp-legacy-mvc/templates/esp-legacy-mvc/appweb.conf $(BIT_VAPP_PREFIX)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/appweb.conf ; \
	cp src/esp/paks/esp-legacy-mvc/templates/esp-legacy-mvc/controller.c $(BIT_VAPP_PREFIX)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/controller.c ; \
	cp src/esp/paks/esp-legacy-mvc/templates/esp-legacy-mvc/edit.esp $(BIT_VAPP_PREFIX)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/edit.esp ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/layouts" ; \
	cp src/esp/paks/esp-legacy-mvc/templates/esp-legacy-mvc/layouts/default.esp $(BIT_VAPP_PREFIX)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/layouts/default.esp ; \
	cp src/esp/paks/esp-legacy-mvc/templates/esp-legacy-mvc/list.esp $(BIT_VAPP_PREFIX)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/list.esp ; \
	cp src/esp/paks/esp-legacy-mvc/templates/esp-legacy-mvc/migration.c $(BIT_VAPP_PREFIX)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/migration.c ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/src" ; \
	cp src/esp/paks/esp-legacy-mvc/templates/esp-legacy-mvc/src/app.c $(BIT_VAPP_PREFIX)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/src/app.c ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/static" ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/static/css" ; \
	cp src/esp/paks/esp-legacy-mvc/templates/esp-legacy-mvc/static/css/all.css $(BIT_VAPP_PREFIX)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/static/css/all.css ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/static/images" ; \
	cp src/esp/paks/esp-legacy-mvc/templates/esp-legacy-mvc/static/images/banner.jpg $(BIT_VAPP_PREFIX)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/static/images/banner.jpg ; \
	cp src/esp/paks/esp-legacy-mvc/templates/esp-legacy-mvc/static/images/favicon.ico $(BIT_VAPP_PREFIX)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/static/images/favicon.ico ; \
	cp src/esp/paks/esp-legacy-mvc/templates/esp-legacy-mvc/static/images/splash.jpg $(BIT_VAPP_PREFIX)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/static/images/splash.jpg ; \
	cp src/esp/paks/esp-legacy-mvc/templates/esp-legacy-mvc/static/index.esp $(BIT_VAPP_PREFIX)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/static/index.esp ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/static/js" ; \
	cp src/esp/paks/esp-legacy-mvc/templates/esp-legacy-mvc/static/js/jquery.esp.js $(BIT_VAPP_PREFIX)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/static/js/jquery.esp.js ; \
	cp src/esp/paks/esp-legacy-mvc/templates/esp-legacy-mvc/static/js/jquery.js $(BIT_VAPP_PREFIX)/esp/esp-legacy-mvc/4.5.4/templates/esp-legacy-mvc/static/js/jquery.js ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-server/4.5.4" ; \
	cp src/esp/paks/esp-server/package.json $(BIT_VAPP_PREFIX)/esp/esp-server/4.5.4/package.json ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-server/4.5.4/templates" ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-server/4.5.4/templates/esp-server" ; \
	cp src/esp/paks/esp-server/templates/esp-server/appweb.conf $(BIT_VAPP_PREFIX)/esp/esp-server/4.5.4/templates/esp-server/appweb.conf ; \
	cp src/esp/paks/esp-server/templates/esp-server/controller.c $(BIT_VAPP_PREFIX)/esp/esp-server/4.5.4/templates/esp-server/controller.c ; \
	cp src/esp/paks/esp-server/templates/esp-server/migration.c $(BIT_VAPP_PREFIX)/esp/esp-server/4.5.4/templates/esp-server/migration.c ; \
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/esp-server/4.5.4/templates/esp-server/src" ; \
	cp src/esp/paks/esp-server/templates/esp-server/src/app.c $(BIT_VAPP_PREFIX)/esp/esp-server/4.5.4/templates/esp-server/src/app.c ; \
	fi ; \
	if [ "$(BIT_PACK_ESP)" = 1 ]; then true ; \
