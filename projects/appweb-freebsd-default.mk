...
$(CONFIG)/bin/libmod_esp.so: $(DEPS_49)
	...
	$(CC) -shared -o $(CONFIG)/bin/libmod_esp.so $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/espLib.o" $(LIBPATHS_49) $(LIBS_49) $(LIBS_49) $(LIBS) 
endif
...
DEPS_51 += $(CONFIG)/bin/libmod_esp.so
...
$(CONFIG)/bin/esp: $(DEPS_51)
	@echo '      [Link] $(CONFIG)/bin/esp'
	$(CC) -o $(CONFIG)/bin/esp $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/esp.o" $(LIBPATHS_51) $(LIBS_51) $(LIBS_51) $(LIBS) $(LIBS) 
endif
...
#   http-ca-crt
#
DEPS_53 += src/paks/http/ca.crt

$(CONFIG)/bin/ca.crt: $(DEPS_53)
...
$(CONFIG)/bin/http: $(DEPS_55)
	...
	$(CC) -o $(CONFIG)/bin/http $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/http.o" $(LIBPATHS_55) $(LIBS_55) $(LIBS_55) $(LIBS) $(LIBS) 
endif

#
#   est.h
#
$(CONFIG)/inc/est.h: $(DEPS_56)
...
DEPS_58 += $(CONFIG)/obj/estLib.o

$(CONFIG)/bin/libest.so: $(DEPS_58)
...
$(CONFIG)/obj/cgiHandler.o: \
    src/modules/cgiHandler.c $(DEPS_59)
...
DEPS_60 += $(CONFIG)/obj/cgiHandler.o
...
$(CONFIG)/bin/libmod_cgi.so: $(DEPS_60)
	@echo '      [Link] $(CONFIG)/bin/libmod_cgi.so'
	$(CC) -shared -o $(CONFIG)/bin/libmod_cgi.so $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/cgiHandler.o" $(LIBPATHS_60) $(LIBS_60) $(LIBS_60) $(LIBS) 
endif
...
$(CONFIG)/obj/ejsHandler.o: \
    src/modules/ejsHandler.c $(DEPS_61)
...
DEPS_62 += $(CONFIG)/inc/zlib.h
DEPS_62 += $(CONFIG)/obj/zlib.o
ifeq ($(ME_COM_ZLIB),1)
    DEPS_62 += $(CONFIG)/bin/libzlib.so
endif
...
DEPS_62 += $(CONFIG)/obj/ejsHandler.o
...
$(CONFIG)/bin/libmod_ejs.so: $(DEPS_62)
	@echo '      [Link] $(CONFIG)/bin/libmod_ejs.so'
	$(CC) -shared -o $(CONFIG)/bin/libmod_ejs.so $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsHandler.o" $(LIBPATHS_62) $(LIBS_62) $(LIBS_62) $(LIBS) 
endif
...
$(CONFIG)/obj/phpHandler.o: \
    src/modules/phpHandler.c $(DEPS_63)
...
DEPS_64 += $(CONFIG)/bin/libappweb.so
DEPS_64 += $(CONFIG)/obj/phpHandler.o
...
$(CONFIG)/bin/libmod_php.so: $(DEPS_64)
	@echo '      [Link] $(CONFIG)/bin/libmod_php.so'
	$(CC) -shared -o $(CONFIG)/bin/libmod_php.so $(LDFLAGS) $(LIBPATHS)  "$(CONFIG)/obj/phpHandler.o" $(LIBPATHS_64) $(LIBS_64) $(LIBS_64) $(LIBS) 
endif
...
$(CONFIG)/bin/libmprssl.so: $(DEPS_66)
	@echo '      [Link] $(CONFIG)/bin/libmprssl.so'
	$(CC) -shared -o $(CONFIG)/bin/libmprssl.so $(LDFLAGS) $(LIBPATHS)    "$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_66) $(LIBS_66) $(LIBS_66) $(LIBS) 
...
$(CONFIG)/obj/sslModule.o: \
    src/modules/sslModule.c $(DEPS_67)
...
ifeq ($(ME_COM_EST),1)
    DEPS_68 += $(CONFIG)/bin/libest.so
endif
DEPS_68 += $(CONFIG)/obj/mprSsl.o
DEPS_68 += $(CONFIG)/bin/libmprssl.so
DEPS_68 += $(CONFIG)/obj/sslModule.o
...
$(CONFIG)/bin/libmod_ssl.so: $(DEPS_68)
	@echo '      [Link] $(CONFIG)/bin/libmod_ssl.so'
	$(CC) -shared -o $(CONFIG)/bin/libmod_ssl.so $(LDFLAGS) $(LIBPATHS)    "$(CONFIG)/obj/sslModule.o" $(LIBPATHS_68) $(LIBS_68) $(LIBS_68) $(LIBS) 
endif
