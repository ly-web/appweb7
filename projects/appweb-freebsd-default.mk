...
ifeq ($(ME_EXT_EST),1)
    DEPS_46 += $(CONFIG)/bin/libest.so
endif
DEPS_46 += $(CONFIG)/obj/mprSsl.o
DEPS_46 += $(CONFIG)/bin/libmprssl.so
...
$(CONFIG)/bin/libmod_ssl.so: $(DEPS_46)
	@echo '      [Link] $(CONFIG)/bin/libmod_ssl.so'
	$(CC) -shared -o $(CONFIG)/bin/libmod_ssl.so $(LIBPATHS) "$(CONFIG)/obj/sslModule.o" $(LIBPATHS_46) $(LIBS_46) $(LIBS_46) $(LIBS) 
endif
...
$(CONFIG)/bin/authpass: $(DEPS_48)
	...
	$(CC) -o $(CONFIG)/bin/authpass $(LIBPATHS) "$(CONFIG)/obj/authpass.o" $(LIBPATHS_48) $(LIBS_48) $(LIBS_48) $(LIBS) $(LIBS) 
...
DEPS_50 += $(CONFIG)/bin/libslink.so
...
$(CONFIG)/bin/appweb: $(DEPS_50)
	...
	$(CC) -o $(CONFIG)/bin/appweb $(LIBPATHS) "$(CONFIG)/obj/appweb.o" $(LIBPATHS_50) $(LIBS_50) $(LIBS_50) $(LIBS) $(LIBS) 
...
DEPS_55 += $(CONFIG)/bin/libappweb.so
...
$(CONFIG)/bin/testAppweb: $(DEPS_55)
	...
	$(CC) -o $(CONFIG)/bin/testAppweb $(LIBPATHS) "$(CONFIG)/obj/testAppweb.o" "$(CONFIG)/obj/testHttp.o" $(LIBPATHS_55) $(LIBS_55) $(LIBS_55) $(LIBS) $(LIBS) 
