...
$(CONFIG)/bin/httpcmd: $(DEPS_34)
	@echo '      [Link] $(CONFIG)/bin/httpcmd'
	$(CC) -o $(CONFIG)/bin/httpcmd $(LIBPATHS) "$(CONFIG)/obj/http.o" $(LIBPATHS_34) $(LIBS_34) $(LIBS_34) $(LIBS) $(LIBS) 
...
$(CONFIG)/bin/libslink.so: $(DEPS_44)
...
$(CONFIG)/bin/libmod_cgi.so: $(DEPS_46)
	@echo '      [Link] $(CONFIG)/bin/libmod_cgi.so'
	$(CC) -shared -o $(CONFIG)/bin/libmod_cgi.so $(LIBPATHS) "$(CONFIG)/obj/cgiHandler.o" $(LIBPATHS_46) $(LIBS_46) $(LIBS_46) $(LIBS) 
endif
...
ifeq ($(ME_EXT_EST),1)
    DEPS_48 += $(CONFIG)/bin/libest.so
endif
DEPS_48 += $(CONFIG)/obj/mprSsl.o
DEPS_48 += $(CONFIG)/bin/libmprssl.so
...
$(CONFIG)/bin/libmod_ssl.so: $(DEPS_48)
	@echo '      [Link] $(CONFIG)/bin/libmod_ssl.so'
	$(CC) -shared -o $(CONFIG)/bin/libmod_ssl.so $(LIBPATHS) "$(CONFIG)/obj/sslModule.o" $(LIBPATHS_48) $(LIBS_48) $(LIBS_48) $(LIBS) 
endif
...
$(CONFIG)/bin/authpass: $(DEPS_50)
	...
	$(CC) -o $(CONFIG)/bin/authpass $(LIBPATHS) "$(CONFIG)/obj/authpass.o" $(LIBPATHS_50) $(LIBS_50) $(LIBS_50) $(LIBS) $(LIBS) 
...
DEPS_54 += $(CONFIG)/bin/libslink.so
...
$(CONFIG)/bin/appweb: $(DEPS_54)
	...
	$(CC) -o $(CONFIG)/bin/appweb $(LIBPATHS) "$(CONFIG)/obj/appweb.o" $(LIBPATHS_54) $(LIBS_54) $(LIBS_54) $(LIBS) $(LIBS) 
...
$(CONFIG)/bin/testAppweb: $(DEPS_59)
	...
	$(CC) -o $(CONFIG)/bin/testAppweb $(LIBPATHS) "$(CONFIG)/obj/testAppweb.o" "$(CONFIG)/obj/testHttp.o" $(LIBPATHS_59) $(LIBS_59) $(LIBS_59) $(LIBS) $(LIBS) 
