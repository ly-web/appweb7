/*
    bit.h -- Build It Configuration Header for macosx-x64-mine
...
/* Profile */
    ...
    #define BIT_CONFIG_CMD "bit -d -q -platform macosx-x64-mine -configure . -with ejscript -with est -with sdb -gen xcode"
#endif
#ifndef BIT_APPWEB_PRODUCT
    #define BIT_APPWEB_PRODUCT 1
#endif
#ifndef BIT_PROFILE
    #define BIT_PROFILE "mine"
#endif
