/*
    bit.h -- Build It Configuration Header for solaris-x86-static
...
/* Profile */
    ...
    #define BIT_CONFIG_CMD "bit -d -q -platform solaris-x86-static -without default -static -configure . -gen sh,make"
#endif
