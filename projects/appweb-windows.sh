...
"${CC}" -c -Fo${CONFIG}/obj/ejsHandler.obj -Fd${CONFIG}/obj/ejsHandler.pdb ${CFLAGS} ${DFLAGS} -I${CONFIG}/inc src/modules/ejsHandler.c

"${LD}" -dll -out:${CONFIG}/bin/mod_ejs.dll -entry:_DllMainCRTStartup@12 -def:${CONFIG}/bin/mod_ejs.def ${LDFLAGS} ${LIBPATHS} ${CONFIG}/obj/ejsHandler.obj ${LIBS} libejs.lib libhttp.lib libmpr.lib libpcre.lib libsqlite3.lib libappweb.lib
