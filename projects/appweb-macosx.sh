...
${CC} -dynamiclib -o ${CONFIG}\bin\libmprssl.dylib -arch x86_64 ${LDFLAGS} -compatibility_version 4.1.0 -current_version 4.1.0 ${LIBPATHS} -install_name @rpath/libmprssl.dylib ${CONFIG}\obj\mprSsl.o -lmpr ${LIBS}
...
${CC} -dynamiclib -o ${CONFIG}\bin\libhttp.dylib -arch x86_64 ${LDFLAGS} -compatibility_version 4.1.0 -current_version 4.1.0 ${LIBPATHS} -install_name @rpath/libhttp.dylib ${CONFIG}\obj\httpLib.o -lpcre -lmpr ${LIBS}
...
${CC} -c -o ${CONFIG}\obj\sqlite3.o -arch x86_64 -Wno-deprecated-declarations -g -w ${DFLAGS} -I${CONFIG}\inc src/deps/sqlite/sqlite3.c
...
${CC} -dynamiclib -o ${CONFIG}\bin\mod_cgi.dylib -arch x86_64 ${LDFLAGS} -compatibility_version 4.1.0 -current_version 4.1.0 ${LIBPATHS} -install_name @rpath/mod_cgi.dylib ${CONFIG}\obj\cgiHandler.o -lappweb ${LIBS} -lhttp -lpcre -lmpr
