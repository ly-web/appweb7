...
${CC} -c -o ${CONFIG}/obj/ejsLib.o -mtune=generic -Wall -fPIC ${LDFLAGS} ${DFLAGS} -I${CONFIG}/inc src/deps/ejs/ejsLib.c

${CC} -shared -o ${CONFIG}/bin/libejs.so ${LDFLAGS} ${LIBPATHS} ${CONFIG}/obj/ejsLib.o -lpcre -lsqlite3 -lhttp ${LIBS} -lpcre -lmpr

${CC} -c -o ${CONFIG}/obj/ejs.o -mtune=generic -Wall -fPIC ${LDFLAGS} ${DFLAGS} -I${CONFIG}/inc src/deps/ejs/ejs.c

${CC} -o ${CONFIG}/bin/ejs ${LDFLAGS} ${LIBPATHS} ${CONFIG}/obj/ejs.o -lejs ${LIBS} -lpcre -lsqlite3 -lhttp -lmpr ${LDFLAGS}

${CC} -c -o ${CONFIG}/obj/ejsc.o -mtune=generic -Wall -fPIC ${LDFLAGS} ${DFLAGS} -I${CONFIG}/inc src/deps/ejs/ejsc.c
