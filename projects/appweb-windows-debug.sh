...
"${CC}" -c -Fo${CONFIG}/obj/mprLib.obj -Fd${CONFIG}/obj/mprLib.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/deps/mpr/mprLib.c
...
"${CC}" -c -Fo${CONFIG}/obj/mprSsl.obj -Fd${CONFIG}/obj/mprSsl.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/deps/mpr/mprSsl.c

"${LD}" -dll -out:${CONFIG}/bin/libmprssl.dll -entry:_DllMainCRTStartup@12 ${LDFLAGS} ${LIBPATHS} ${CONFIG}/obj/mprSsl.obj libmpr.lib ${LIBS}

"${CC}" -c -Fo${CONFIG}/obj/manager.obj -Fd${CONFIG}/obj/manager.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/deps/mpr/manager.c
...
"${CC}" -c -Fo${CONFIG}/obj/makerom.obj -Fd${CONFIG}/obj/makerom.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/deps/mpr/makerom.c
...
"${CC}" -c -Fo${CONFIG}/obj/pcre.obj -Fd${CONFIG}/obj/pcre.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/deps/pcre/pcre.c
...
"${CC}" -c -Fo${CONFIG}/obj/httpLib.obj -Fd${CONFIG}/obj/httpLib.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/deps/http/httpLib.c
...
"${CC}" -c -Fo${CONFIG}/obj/http.obj -Fd${CONFIG}/obj/http.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/deps/http/http.c
...
"${CC}" -c -Fo${CONFIG}/obj/sqlite3.obj -Fd${CONFIG}/obj/sqlite3.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/deps/sqlite/sqlite3.c

"${LD}" -dll -out:${CONFIG}/bin/libsqlite3.dll -entry:_DllMainCRTStartup@12 ${LDFLAGS} ${LIBPATHS} ${CONFIG}/obj/sqlite3.obj ${LIBS}

"${CC}" -c -Fo${CONFIG}/obj/sqlite.obj -Fd${CONFIG}/obj/sqlite.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/deps/sqlite/sqlite.c
...
"${CC}" -c -Fo${CONFIG}/obj/config.obj -Fd${CONFIG}/obj/config.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/config.c

"${CC}" -c -Fo${CONFIG}/obj/convenience.obj -Fd${CONFIG}/obj/convenience.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/convenience.c

"${CC}" -c -Fo${CONFIG}/obj/dirHandler.obj -Fd${CONFIG}/obj/dirHandler.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/dirHandler.c

"${CC}" -c -Fo${CONFIG}/obj/fileHandler.obj -Fd${CONFIG}/obj/fileHandler.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/fileHandler.c

"${CC}" -c -Fo${CONFIG}/obj/log.obj -Fd${CONFIG}/obj/log.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/log.c

"${CC}" -c -Fo${CONFIG}/obj/server.obj -Fd${CONFIG}/obj/server.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/server.c
...
"${CC}" -c -Fo${CONFIG}/obj/edi.obj -Fd${CONFIG}/obj/edi.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/esp/edi.c

"${CC}" -c -Fo${CONFIG}/obj/espAbbrev.obj -Fd${CONFIG}/obj/espAbbrev.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/esp/espAbbrev.c

"${CC}" -c -Fo${CONFIG}/obj/espFramework.obj -Fd${CONFIG}/obj/espFramework.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/esp/espFramework.c

"${CC}" -c -Fo${CONFIG}/obj/espHandler.obj -Fd${CONFIG}/obj/espHandler.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/esp/espHandler.c

"${CC}" -c -Fo${CONFIG}/obj/espHtml.obj -Fd${CONFIG}/obj/espHtml.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/esp/espHtml.c

"${CC}" -c -Fo${CONFIG}/obj/espSession.obj -Fd${CONFIG}/obj/espSession.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/esp/espSession.c

"${CC}" -c -Fo${CONFIG}/obj/espTemplate.obj -Fd${CONFIG}/obj/espTemplate.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/esp/espTemplate.c

"${CC}" -c -Fo${CONFIG}/obj/mdb.obj -Fd${CONFIG}/obj/mdb.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/esp/mdb.c

"${CC}" -c -Fo${CONFIG}/obj/sdb.obj -Fd${CONFIG}/obj/sdb.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/esp/sdb.c
...
"${CC}" -c -Fo${CONFIG}/obj/esp.obj -Fd${CONFIG}/obj/esp.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/esp/esp.c
...
"${CC}" -c -Fo${CONFIG}/obj/cgiHandler.obj -Fd${CONFIG}/obj/cgiHandler.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/modules/cgiHandler.c
...
"${CC}" -c -Fo${CONFIG}/obj/authpass.obj -Fd${CONFIG}/obj/authpass.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/utils/authpass.c
...
"${CC}" -c -Fo${CONFIG}/obj/cgiProgram.obj -Fd${CONFIG}/obj/cgiProgram.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/utils/cgiProgram.c

"${LD}" -out:${CONFIG}/bin/cgiProgram.exe -entry:mainCRTStartup -subsystem:console ${LDFLAGS} ${LIBPATHS} ${CONFIG}/obj/cgiProgram.obj ${LIBS}

"${CC}" -c -Fo${CONFIG}/obj/setConfig.obj -Fd${CONFIG}/obj/setConfig.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/utils/setConfig.c
...
"${CC}" -c -Fo${CONFIG}/obj/appweb.obj -Fd${CONFIG}/obj/appweb.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/server/appweb.c
...
"${CC}" -c -Fo${CONFIG}/obj/appwebMonitor.obj -Fd${CONFIG}/obj/appwebMonitor.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/server/windows/appwebMonitor.c
...
"${CC}" -c -Fo${CONFIG}/obj/testAppweb.obj -Fd${CONFIG}/obj/testAppweb.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc test/testAppweb.c

"${CC}" -c -Fo${CONFIG}/obj/testHttp.obj -Fd${CONFIG}/obj/testHttp.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc test/testHttp.c
...
"${CC}" -c -Fo${CONFIG}/obj/removeFiles.obj -Fd${CONFIG}/obj/removeFiles.pdb ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc package/windows/removeFiles.c
