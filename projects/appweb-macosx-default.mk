...
$(CONFIG)/bin/httpcmd: $(DEPS_34)
	...
	$(CC) -o $(CONFIG)/bin/httpcmd -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/http.o" $(LIBPATHS_34) $(LIBS_34) $(LIBS_34) $(LIBS) -lpam 
...
$(CONFIG)/bin/libmod_cgi.dylib: $(DEPS_46)
	@echo '      [Link] $(CONFIG)/bin/libmod_cgi.dylib'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmod_cgi.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmod_cgi.dylib -compatibility_version 5.0.0 -current_version 5.0.0 "$(CONFIG)/obj/cgiHandler.o" $(LIBPATHS_46) $(LIBS_46) $(LIBS_46) $(LIBS) -lpam 
endif
...
ifeq ($(ME_EXT_EST),1)
    DEPS_48 += $(CONFIG)/bin/libest.dylib
endif
DEPS_48 += $(CONFIG)/obj/mprSsl.o
DEPS_48 += $(CONFIG)/bin/libmprssl.dylib
...
$(CONFIG)/bin/libmod_ssl.dylib: $(DEPS_48)
	@echo '      [Link] $(CONFIG)/bin/libmod_ssl.dylib'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmod_ssl.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmod_ssl.dylib -compatibility_version 5.0.0 -current_version 5.0.0 "$(CONFIG)/obj/sslModule.o" $(LIBPATHS_48) $(LIBS_48) $(LIBS_48) $(LIBS) -lpam 
endif
...
DEPS_54 += $(CONFIG)/bin/libslink.dylib
...
$(CONFIG)/bin/appweb: $(DEPS_54)
	...
	$(CC) -o $(CONFIG)/bin/appweb -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/appweb.o" $(LIBPATHS_54) $(LIBS_54) $(LIBS_54) $(LIBS) -lpam 
...
$(CONFIG)/bin/testAppweb: $(DEPS_59)
	...
	$(CC) -o $(CONFIG)/bin/testAppweb -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/testAppweb.o" "$(CONFIG)/obj/testHttp.o" $(LIBPATHS_59) $(LIBS_59) $(LIBS_59) $(LIBS) -lpam 
