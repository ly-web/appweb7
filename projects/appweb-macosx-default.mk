...
$(BUILD)/obj/httpLib.o: \
    src/paks/http/httpLib.c $(DEPS_30)
...
$(BUILD)/obj/makerom.o: \
    src/paks/mpr/makerom.c $(DEPS_31)
...
$(BUILD)/obj/manager.o: \
    src/paks/mpr/manager.c $(DEPS_32)
...
$(BUILD)/obj/phpHandler.o: \
    src/modules/phpHandler.c $(DEPS_36)
...
DEPS_37 += $(BUILD)/inc/esp.h

$(BUILD)/obj/slink.o: \
    src/server/slink.c $(DEPS_37)
...
$(BUILD)/obj/sslModule.o: \
    src/modules/sslModule.c $(DEPS_41)
...
src/paks/zlib/zlib.h: $(DEPS_42)

#
#   zlib.o
#
DEPS_43 += $(BUILD)/inc/me.h
DEPS_43 += src/paks/zlib/zlib.h

$(BUILD)/obj/zlib.o: \
    src/paks/zlib/zlib.c $(DEPS_43)
...
$(BUILD)/bin/libhttp.dylib: $(DEPS_46)
	...
	$(CC) -dynamiclib -o $(BUILD)/bin/libhttp.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libhttp.dylib -compatibility_version 5.2 -current_version 5.2 "$(BUILD)/obj/httpLib.o" $(LIBPATHS_46) $(LIBS_46) $(LIBS_46) $(LIBS) -lpam 
endif
...
DEPS_47 += $(BUILD)/inc/customize.h
DEPS_47 += $(BUILD)/obj/config.o
DEPS_47 += $(BUILD)/obj/convenience.o
...
$(BUILD)/bin/libappweb.dylib: $(DEPS_47)
	@echo '      [Link] $(BUILD)/bin/libappweb.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libappweb.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libappweb.dylib -compatibility_version 5.2 -current_version 5.2 "$(BUILD)/obj/config.o" "$(BUILD)/obj/convenience.o" $(LIBPATHS_47) $(LIBS_47) $(LIBS_47) $(LIBS) -lpam 

#
#   libslink
#
DEPS_48 += $(BUILD)/obj/slink.o

$(BUILD)/bin/libslink.dylib: $(DEPS_48)
...
DEPS_49 += $(BUILD)/bin/libslink.dylib
...
ifeq ($(ME_COM_ZLIB),1)
    DEPS_52 += $(BUILD)/bin/libzlib.dylib
endif
DEPS_52 += $(BUILD)/inc/ejs.h
DEPS_52 += $(BUILD)/inc/ejs.slots.h
DEPS_52 += $(BUILD)/inc/ejsByteGoto.h
DEPS_52 += $(BUILD)/obj/ejsLib.o
...
$(BUILD)/bin/libejs.dylib: $(DEPS_52)
	@echo '      [Link] $(BUILD)/bin/libejs.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libejs.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libejs.dylib -compatibility_version 5.2 -current_version 5.2 "$(BUILD)/obj/ejsLib.o" $(LIBPATHS_52) $(LIBS_52) $(LIBS_52) $(LIBS) -lpam 
endif
...
$(BUILD)/bin/ejsc: $(DEPS_53)
	@echo '      [Link] $(BUILD)/bin/ejsc'
	$(CC) -o $(BUILD)/bin/ejsc -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/ejsc.o" $(LIBPATHS_53) $(LIBS_53) $(LIBS_53) $(LIBS) -lpam 
endif
...
#   ejs.mod
#
DEPS_54 += src/paks/ejs/ejs.es
DEPS_54 += $(BUILD)/bin/ejsc

$(BUILD)/bin/ejs.mod: $(DEPS_54)
	( \
	cd src/paks/ejs; \
...
$(BUILD)/bin/ejs: $(DEPS_55)
	@echo '      [Link] $(BUILD)/bin/ejs'
	$(CC) -o $(BUILD)/bin/ejs -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/ejs.o" $(LIBPATHS_55) $(LIBS_55) $(LIBS_55) $(LIBS) -lpam -ledit 
endif
...
#   esp-paks
#
DEPS_56 += src/paks/esp-html-mvc/client/assets/favicon.ico
DEPS_56 += src/paks/esp-html-mvc/client/css/all.css
DEPS_56 += src/paks/esp-html-mvc/client/css/all.less
DEPS_56 += src/paks/esp-html-mvc/client/index.esp
DEPS_56 += src/paks/esp-html-mvc/css/app.less
DEPS_56 += src/paks/esp-html-mvc/css/theme.less
DEPS_56 += src/paks/esp-html-mvc/generate/appweb.conf
DEPS_56 += src/paks/esp-html-mvc/generate/controller.c
DEPS_56 += src/paks/esp-html-mvc/generate/controllerSingleton.c
DEPS_56 += src/paks/esp-html-mvc/generate/edit.esp
DEPS_56 += src/paks/esp-html-mvc/generate/list.esp
DEPS_56 += src/paks/esp-html-mvc/layouts/default.esp
DEPS_56 += src/paks/esp-html-mvc/LICENSE.md
DEPS_56 += src/paks/esp-html-mvc/package.json
DEPS_56 += src/paks/esp-html-mvc/README.md
DEPS_56 += src/paks/esp-mvc/generate/appweb.conf
DEPS_56 += src/paks/esp-mvc/generate/controller.c
DEPS_56 += src/paks/esp-mvc/generate/migration.c
DEPS_56 += src/paks/esp-mvc/generate/src/app.c
DEPS_56 += src/paks/esp-mvc/LICENSE.md
DEPS_56 += src/paks/esp-mvc/package.json
DEPS_56 += src/paks/esp-mvc/README.md
DEPS_56 += src/paks/esp-server/generate/appweb.conf
DEPS_56 += src/paks/esp-server/LICENSE.md
DEPS_56 += src/paks/esp-server/package.json
DEPS_56 += src/paks/esp-server/README.md
...
#   esp.conf
#
DEPS_57 += src/paks/esp/esp.conf

$(BUILD)/bin/esp.conf: $(DEPS_57)
...
$(BUILD)/bin/libmod_esp.dylib: $(DEPS_58)
	@echo '      [Link] $(BUILD)/bin/libmod_esp.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libmod_esp.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmod_esp.dylib -compatibility_version 5.2 -current_version 5.2 "$(BUILD)/obj/espLib.o" $(LIBPATHS_58) $(LIBS_58) $(LIBS_58) $(LIBS) -lpam 
endif
...
$(BUILD)/bin/esp: $(DEPS_59)
	@echo '      [Link] $(BUILD)/bin/esp'
	$(CC) -o $(BUILD)/bin/esp -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/esp.o" $(LIBPATHS_59) $(LIBS_59) $(LIBS_59) $(LIBS) -lpam 
endif
...
#   genslink
#
DEPS_60 += $(BUILD)/bin/libmod_esp.dylib
...
#   httpcmd
#
DEPS_62 += $(BUILD)/bin/libhttp.dylib
...
$(BUILD)/bin/http: $(DEPS_62)
	@echo '      [Link] $(BUILD)/bin/http'
	$(CC) -o $(BUILD)/bin/http -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/http.o" $(LIBPATHS_62) $(LIBS_62) $(LIBS_62) $(LIBS) -lpam 
endif
...
DEPS_63 += $(BUILD)/inc/est.h
DEPS_63 += $(BUILD)/obj/estLib.o

$(BUILD)/bin/libest.dylib: $(DEPS_63)
...
$(BUILD)/bin/libmod_cgi.dylib: $(DEPS_64)
	@echo '      [Link] $(BUILD)/bin/libmod_cgi.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libmod_cgi.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmod_cgi.dylib -compatibility_version 5.2 -current_version 5.2 "$(BUILD)/obj/cgiHandler.o" $(LIBPATHS_64) $(LIBS_64) $(LIBS_64) $(LIBS) -lpam 
endif
...
DEPS_65 += $(BUILD)/obj/ejsHandler.o
...
$(BUILD)/bin/libmod_ejs.dylib: $(DEPS_65)
	@echo '      [Link] $(BUILD)/bin/libmod_ejs.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libmod_ejs.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmod_ejs.dylib -compatibility_version 5.2 -current_version 5.2 "$(BUILD)/obj/ejsHandler.o" $(LIBPATHS_65) $(LIBS_65) $(LIBS_65) $(LIBS) -lpam 
endif
...
DEPS_66 += $(BUILD)/obj/phpHandler.o
...
LIBS_66 += -lphp5
LIBPATHS_66 += -L$(ME_COM_PHP_PATH)/libs

$(BUILD)/bin/libmod_php.dylib: $(DEPS_66)
	@echo '      [Link] $(BUILD)/bin/libmod_php.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libmod_php.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libmod_php.dylib -compatibility_version 5.2 -current_version 5.2 "$(BUILD)/obj/phpHandler.o" $(LIBPATHS_66) $(LIBS_66) $(LIBS_66) $(LIBS) -lpam 
endif
...
ifeq ($(ME_COM_EST),1)
    DEPS_67 += $(BUILD)/bin/libest.dylib
endif
...
$(BUILD)/bin/libmprssl.dylib: $(DEPS_67)
	@echo '      [Link] $(BUILD)/bin/libmprssl.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libmprssl.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libmprssl.dylib -compatibility_version 5.2 -current_version 5.2 "$(BUILD)/obj/mprSsl.o" $(LIBPATHS_67) $(LIBS_67) $(LIBS_67) $(LIBS) 
...
DEPS_68 += $(BUILD)/bin/libmprssl.dylib
DEPS_68 += $(BUILD)/obj/sslModule.o
...
$(BUILD)/bin/libmod_ssl.dylib: $(DEPS_68)
	@echo '      [Link] $(BUILD)/bin/libmod_ssl.dylib'
	$(CC) -dynamiclib -o $(BUILD)/bin/libmod_ssl.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libmod_ssl.dylib -compatibility_version 5.2 -current_version 5.2 "$(BUILD)/obj/sslModule.o" $(LIBPATHS_68) $(LIBS_68) $(LIBS_68) $(LIBS) -lpam 
endif
...
#   libsql
#
DEPS_69 += $(BUILD)/inc/sqlite3.h
DEPS_69 += $(BUILD)/obj/sqlite3.o

$(BUILD)/bin/libsql.dylib: $(DEPS_69)
...
#   manager
#
DEPS_70 += $(BUILD)/bin/libmpr.dylib
DEPS_70 += $(BUILD)/obj/manager.o

LIBS_70 += -lmpr

$(BUILD)/bin/appman: $(DEPS_70)
	@echo '      [Link] $(BUILD)/bin/appman'
	$(CC) -o $(BUILD)/bin/appman -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/manager.o" $(LIBPATHS_70) $(LIBS_70) $(LIBS_70) $(LIBS) 
