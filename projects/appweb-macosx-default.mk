...
TARGETS     += $(CONFIG)/bin/libapp.dylib
...
#   libmprssl
#
DEPS_8 += $(CONFIG)/bin/libmpr.dylib
DEPS_8 += $(CONFIG)/obj/mprSsl.o

LIBS_8 += -lmpr

$(CONFIG)/bin/libmprssl.dylib: $(DEPS_8)
	@echo '      [Link] libmprssl'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmprssl.dylib $(LDFLAGS) -compatibility_version 4.3.0 -current_version 4.3.0 $(LIBPATHS) -install_name @rpath/libmprssl.dylib $(CONFIG)/obj/mprSsl.o $(LIBS_8) $(LIBS_8) $(LIBS)
...
$(CONFIG)/bin/appman: $(DEPS_10)
	@echo '      [Link] manager'
	$(CC) -o $(CONFIG)/bin/appman -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/manager.o $(LIBS_10) $(LIBS_10) $(LIBS)
...
$(CONFIG)/bin/makerom: $(DEPS_12)
	@echo '      [Link] makerom'
	$(CC) -o $(CONFIG)/bin/makerom -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/makerom.o $(LIBS_12) $(LIBS_12) $(LIBS)
...
$(CONFIG)/bin/libhttp.dylib: $(DEPS_19)
	@echo '      [Link] libhttp'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libhttp.dylib $(LDFLAGS) -compatibility_version 4.3.0 -current_version 4.3.0 $(LIBPATHS) -install_name @rpath/libhttp.dylib $(CONFIG)/obj/httpLib.o $(LIBS_19) $(LIBS_19) $(LIBS) -lpam
...
$(CONFIG)/bin/http: $(DEPS_21)
	@echo '      [Link] http'
	$(CC) -o $(CONFIG)/bin/http -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/http.o $(LIBS_21) $(LIBS_21) $(LIBS) -lpam
...
$(CONFIG)/bin/libsqlite3.dylib: $(DEPS_24)
...
#
ifeq ($(BIT_PACK_SQLITE),1)
    DEPS_26 += $(CONFIG)/bin/libsqlite3.dylib
endif
...
$(CONFIG)/bin/sqlite: $(DEPS_26)
	@echo '      [Link] sqlite'
	$(CC) -o $(CONFIG)/bin/sqlite -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/sqlite.o $(LIBS_26) $(LIBS_26) $(LIBS)
endif
...
$(CONFIG)/bin/libappweb.dylib: $(DEPS_35)
	@echo '      [Link] libappweb'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libappweb.dylib $(LDFLAGS) -compatibility_version 4.3.0 -current_version 4.3.0 $(LIBPATHS) -install_name @rpath/libappweb.dylib $(CONFIG)/obj/config.o $(CONFIG)/obj/convenience.o $(CONFIG)/obj/dirHandler.o $(CONFIG)/obj/fileHandler.o $(CONFIG)/obj/log.o $(CONFIG)/obj/server.o $(LIBS_35) $(LIBS_35) $(LIBS) -lpam
...
$(CONFIG)/bin/libmod_esp.dylib: $(DEPS_49)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmod_esp.dylib $(LDFLAGS) -compatibility_version 4.3.0 -current_version 4.3.0 $(LIBPATHS) -install_name @rpath/libmod_esp.dylib $(CONFIG)/obj/edi.o $(CONFIG)/obj/esp.o $(CONFIG)/obj/espAbbrev.o $(CONFIG)/obj/espFramework.o $(CONFIG)/obj/espHandler.o $(CONFIG)/obj/espHtml.o $(CONFIG)/obj/espTemplate.o $(CONFIG)/obj/mdb.o $(CONFIG)/obj/sdb.o $(LIBS_49) $(LIBS_49) $(LIBS) -lpam
endif
...
$(CONFIG)/bin/esp: $(DEPS_50)
	@echo '      [Link] esp'
	$(CC) -o $(CONFIG)/bin/esp -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/edi.o $(CONFIG)/obj/esp.o $(CONFIG)/obj/espAbbrev.o $(CONFIG)/obj/espFramework.o $(CONFIG)/obj/espHandler.o $(CONFIG)/obj/espHtml.o $(CONFIG)/obj/espTemplate.o $(CONFIG)/obj/mdb.o $(CONFIG)/obj/sdb.o $(LIBS_50) $(LIBS_50) $(LIBS) -lpam
endif
...
ifeq ($(BIT_PACK_SQLITE),1)
    DEPS_59 += $(CONFIG)/bin/libsqlite3.dylib
endif
...
$(CONFIG)/bin/libejs.dylib: $(DEPS_59)
	@echo '      [Link] libejs'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libejs.dylib $(LDFLAGS) -compatibility_version 4.3.0 -current_version 4.3.0 $(LIBPATHS) -install_name @rpath/libejs.dylib $(CONFIG)/obj/ejsLib.o $(LIBS_59) $(LIBS_59) $(LIBS) -lpam
endif
...
#
ifeq ($(BIT_PACK_EJSCRIPT),1)
    DEPS_61 += $(CONFIG)/bin/libejs.dylib
endif
...
$(CONFIG)/bin/ejs: $(DEPS_61)
	@echo '      [Link] ejs'
	$(CC) -o $(CONFIG)/bin/ejs -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejs.o $(LIBS_61) $(LIBS_61) $(LIBS) -ledit
endif
...
$(CONFIG)/bin/ejsc: $(DEPS_63)
	@echo '      [Link] ejsc'
	$(CC) -o $(CONFIG)/bin/ejsc -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsc.o $(LIBS_63) $(LIBS_63) $(LIBS) -lpam
endif
...
$(CONFIG)/bin/libmod_cgi.dylib: $(DEPS_66)
	@echo '      [Link] libmod_cgi'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmod_cgi.dylib $(LDFLAGS) -compatibility_version 4.3.0 -current_version 4.3.0 $(LIBPATHS) -install_name @rpath/libmod_cgi.dylib $(CONFIG)/obj/cgiHandler.o $(LIBS_66) $(LIBS_66) $(LIBS) -lpam
endif
...
$(CONFIG)/bin/libmod_ejs.dylib: $(DEPS_68)
	@echo '      [Link] libmod_ejs'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmod_ejs.dylib $(LDFLAGS) -compatibility_version 4.3.0 -current_version 4.3.0 $(LIBPATHS) -install_name @rpath/libmod_ejs.dylib $(CONFIG)/obj/ejsHandler.o $(LIBS_68) $(LIBS_68) $(LIBS) -lsqlite3
endif
...
$(CONFIG)/bin/authpass: $(DEPS_70)
	@echo '      [Link] authpass'
	$(CC) -o $(CONFIG)/bin/authpass -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/authpass.o $(LIBS_70) $(LIBS_70) $(LIBS) -lpam
...
ifeq ($(BIT_PACK_ESP),1)
    DEPS_75 += $(CONFIG)/bin/libmod_esp.dylib
endif
...
$(CONFIG)/bin/libapp.dylib: $(DEPS_75)
	@echo '      [Link] libapp'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libapp.dylib $(LDFLAGS) -compatibility_version 4.3.0 -current_version 4.3.0 $(LIBPATHS) -install_name @rpath/libapp.dylib $(CONFIG)/obj/slink.o $(LIBS_75) $(LIBS_75) $(LIBS) -lpam
...
ifeq ($(BIT_PACK_ESP),1)
    DEPS_77 += $(CONFIG)/bin/libmod_esp.dylib
endif
ifeq ($(BIT_PACK_EJSCRIPT),1)
    DEPS_77 += $(CONFIG)/bin/libmod_ejs.dylib
endif
ifeq ($(BIT_PACK_CGI),1)
    DEPS_77 += $(CONFIG)/bin/libmod_cgi.dylib
endif
DEPS_77 += $(CONFIG)/bin/libapp.dylib
...
$(CONFIG)/bin/appweb: $(DEPS_77)
	@echo '      [Link] appweb'
	$(CC) -o $(CONFIG)/bin/appweb -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/appweb.o $(LIBS_77) $(LIBS_77) $(LIBS) -lsqlite3
...
$(CONFIG)/bin/testAppweb: $(DEPS_82)
	...
	$(CC) -o $(CONFIG)/bin/testAppweb -arch x86_64 $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/testAppweb.o $(CONFIG)/obj/testHttp.o $(LIBS_82) $(LIBS_82) $(LIBS) -lpam
...
ifeq ($(BIT_PACK_ESP),1)
	...
	cp "$(CONFIG)/bin/libapp.dylib" "$(BIT_VAPP_PREFIX)/bin/libapp.dylib"
