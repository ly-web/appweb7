...
$(CONFIG)/bin/libmod_esp.dylib: $(DEPS_50)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmod_esp.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmod_esp.dylib -compatibility_version 4.3.4 -current_version 4.3.4 "$(CONFIG)/obj/edi.o" "$(CONFIG)/obj/espAbbrev.o" "$(CONFIG)/obj/espFramework.o" "$(CONFIG)/obj/espHandler.o" "$(CONFIG)/obj/espHtml.o" "$(CONFIG)/obj/espTemplate.o" "$(CONFIG)/obj/mdb.o" "$(CONFIG)/obj/sdb.o" $(LIBPATHS_50) $(LIBS_50) $(LIBS_50) $(LIBS) -lpam 
endif
...
$(CONFIG)/bin/libejs.dylib: $(DEPS_60)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libejs.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libejs.dylib -compatibility_version 4.3.4 -current_version 4.3.4 "$(CONFIG)/obj/ejsLib.o" $(LIBPATHS_60) $(LIBS_60) $(LIBS_60) $(LIBS) -lpam 
endif
...
$(CONFIG)/bin/libmod_cgi.dylib: $(DEPS_67)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmod_cgi.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmod_cgi.dylib -compatibility_version 4.3.4 -current_version 4.3.4 "$(CONFIG)/obj/cgiHandler.o" $(LIBPATHS_67) $(LIBS_67) $(LIBS_67) $(LIBS) -lpam 
endif
...
$(CONFIG)/bin/libmod_ejs.dylib: $(DEPS_69)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmod_ejs.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmod_ejs.dylib -compatibility_version 4.3.4 -current_version 4.3.4 "$(CONFIG)/obj/ejsHandler.o" $(LIBPATHS_69) $(LIBS_69) $(LIBS_69) $(LIBS) -lpam 
endif
...
$(CONFIG)/bin/libmod_php.dylib: $(DEPS_71)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmod_php.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libmod_php.dylib -compatibility_version 4.3.4 -current_version 4.3.4 "$(CONFIG)/obj/phpHandler.o" $(LIBPATHS_71) $(LIBS_71) $(LIBS_71) $(LIBS) -lpam 
endif
...
$(CONFIG)/bin/libmod_ssl.dylib: $(DEPS_73)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmod_ssl.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmod_ssl.dylib -compatibility_version 4.3.4 -current_version 4.3.4 "$(CONFIG)/obj/sslModule.o" $(LIBPATHS_73) $(LIBS_73) $(LIBS_73) $(LIBS) -lpam 
endif
...
$(CONFIG)/bin/libslink.dylib: $(DEPS_80)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libslink.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libslink.dylib -compatibility_version 4.3.4 -current_version 4.3.4 "$(CONFIG)/obj/slink.o" $(LIBPATHS_80) $(LIBS_80) $(LIBS_80) $(LIBS) -lpam 
...
ifeq ($(BIT_PACK_ESP),1)
	cp src/esp/esp-legacy $(BIT_VAPP_PREFIX)/bin/esp-legacy
endif
ifeq ($(BIT_PACK_ESP),1)
	cp src/esp/esp-ng $(BIT_VAPP_PREFIX)/bin/esp-ng
endif
ifeq ($(BIT_PACK_ESP),1)
