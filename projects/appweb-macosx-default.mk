...
ifeq ($(BIT_PACK_ESP),1)
	...
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/proto/components/angular-esp/client/lib/angular-esp"
	cp src/esp/proto/components/angular-esp/client/lib/angular-esp/Esp.js $(BIT_VAPP_PREFIX)/esp/proto/components/angular-esp/client/lib/angular-esp/Esp.js
	...
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/proto/components/angular-local/client/lib/angular-local"
	cp src/esp/proto/components/angular-local/client/lib/angular-local/LocalStore.js $(BIT_VAPP_PREFIX)/esp/proto/components/angular-local/client/lib/angular-local/LocalStore.js
	...
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/proto/components/angular-mvc/client/templates"
	cp src/esp/proto/components/angular-mvc/client/templates/splash.html $(BIT_VAPP_PREFIX)/esp/proto/components/angular-mvc/client/templates/splash.html
	...
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/proto/components/angular-session/client/lib/angular-session"
	cp src/esp/proto/components/angular-session/client/lib/angular-session/SessionStore.js $(BIT_VAPP_PREFIX)/esp/proto/components/angular-session/client/lib/angular-session/SessionStore.js
