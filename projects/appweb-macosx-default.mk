...
$(CONFIG)/obj/mprLib.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/mprLib.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/deps/mpr/mprLib.c
...
$(CONFIG)/obj/mprSsl.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/mprSsl.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" "-I$(BIT_PACK_MATRIXSSL_PATH)" "-I$(BIT_PACK_MATRIXSSL_PATH)/matrixssl" "-I$(BIT_PACK_NANOSSL_PATH)/src" "-I$(BIT_PACK_OPENSSL_PATH)/include" src/deps/mpr/mprSsl.c
...
$(CONFIG)/obj/manager.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/manager.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/deps/mpr/manager.c
...
$(CONFIG)/obj/makerom.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/makerom.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/deps/mpr/makerom.c
...
$(CONFIG)/obj/pcre.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/pcre.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/deps/pcre/pcre.c
...
$(CONFIG)/obj/httpLib.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/httpLib.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/deps/http/httpLib.c
...
$(CONFIG)/obj/http.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/http.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/deps/http/http.c
...
$(CONFIG)/obj/sqlite.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/sqlite.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/deps/sqlite/sqlite.c
...
$(CONFIG)/obj/config.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/config.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/config.c
...
$(CONFIG)/obj/convenience.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/convenience.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/convenience.c
...
$(CONFIG)/obj/dirHandler.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/dirHandler.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/dirHandler.c
...
$(CONFIG)/obj/fileHandler.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/fileHandler.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/fileHandler.c
...
$(CONFIG)/obj/log.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/log.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/log.c
...
$(CONFIG)/obj/server.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/server.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/server.c
...
$(CONFIG)/obj/edi.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/edi.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/esp/edi.c
...
$(CONFIG)/obj/espAbbrev.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/espAbbrev.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/esp/espAbbrev.c
...
$(CONFIG)/obj/espFramework.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/espFramework.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/esp/espFramework.c
...
$(CONFIG)/obj/espHandler.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/espHandler.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/esp/espHandler.c
...
$(CONFIG)/obj/espHtml.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/espHtml.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/esp/espHtml.c
...
$(CONFIG)/obj/espTemplate.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/espTemplate.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/esp/espTemplate.c
...
$(CONFIG)/obj/mdb.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/mdb.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/esp/mdb.c
...
$(CONFIG)/obj/sdb.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/sdb.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/esp/sdb.c
...
$(CONFIG)/obj/esp.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/esp.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/esp/esp.c
...
$(CONFIG)/obj/ejsLib.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsLib.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/deps/ejs/ejsLib.c
...
$(CONFIG)/obj/ejs.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejs.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/deps/ejs/ejs.c
...
$(CONFIG)/obj/ejsc.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsc.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/deps/ejs/ejsc.c
...
$(CONFIG)/obj/cgiHandler.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/cgiHandler.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/modules/cgiHandler.c
...
$(CONFIG)/obj/ejsHandler.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/ejsHandler.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/modules/ejsHandler.c
...
$(CONFIG)/obj/sslModule.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/sslModule.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/modules/sslModule.c
...
$(CONFIG)/obj/authpass.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/authpass.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/utils/authpass.c
...
$(CONFIG)/obj/cgiProgram.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/cgiProgram.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/utils/cgiProgram.c
...
$(CONFIG)/obj/slink.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/slink.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/server/slink.c
...
$(CONFIG)/bin/libslink.dylib: $(DEPS_80)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libslink.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libslink.dylib -compatibility_version 4.4.0 -current_version 4.4.0 "$(CONFIG)/obj/slink.o" $(LIBPATHS_80) $(LIBS_80) $(LIBS_80) $(LIBS) -lpam 
...
$(CONFIG)/obj/appweb.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/appweb.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" src/server/appweb.c
...
$(CONFIG)/obj/testAppweb.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/testAppweb.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" test/src/testAppweb.c
...
$(CONFIG)/obj/testHttp.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/testHttp.o -arch $(CC_ARCH) $(CFLAGS) "$(IFLAGS)" test/src/testHttp.c
...
ifeq ($(BIT_PACK_ESP),1)
	...
	cp src/esp/proto/angular/app.conf $(BIT_VAPP_PREFIX)/bin/esp-proto/proto/angular/app.conf
	cp src/esp/proto/angular/appweb.conf $(BIT_VAPP_PREFIX)/bin/esp-proto/proto/angular/appweb.conf
	...
	cp src/esp/proto/angular/client/config.json $(BIT_VAPP_PREFIX)/bin/esp-proto/proto/angular/client/config.json
	...
	cp src/esp/proto/angular/client/lib/all.js $(BIT_VAPP_PREFIX)/bin/esp-proto/proto/angular/client/lib/all.js
	cp src/esp/proto/angular/client/lib/angular-bootstrap-prettify.js $(BIT_VAPP_PREFIX)/bin/esp-proto/proto/angular/client/lib/angular-bootstrap-prettify.js
	cp src/esp/proto/angular/client/lib/angular-bootstrap-prettify.min.js $(BIT_VAPP_PREFIX)/bin/esp-proto/proto/angular/client/lib/angular-bootstrap-prettify.min.js
	...
	cp src/esp/proto/angular/client/lib/angular-mobile.js $(BIT_VAPP_PREFIX)/bin/esp-proto/proto/angular/client/lib/angular-mobile.js
	cp src/esp/proto/angular/client/lib/angular-mobile.min.js $(BIT_VAPP_PREFIX)/bin/esp-proto/proto/angular/client/lib/angular-mobile.min.js
	...
	mkdir -p "$(BIT_VAPP_PREFIX)/bin/esp-proto/proto/legacy"
	cp src/esp/proto/legacy/app.conf $(BIT_VAPP_PREFIX)/bin/esp-proto/proto/legacy/app.conf
	cp src/esp/proto/legacy/appweb.conf $(BIT_VAPP_PREFIX)/bin/esp-proto/proto/legacy/appweb.conf
	...
	mkdir -p "$(BIT_VAPP_PREFIX)/bin/esp-proto/proto/LocalStore"
	cp src/esp/proto/LocalStore/LocalStore.js $(BIT_VAPP_PREFIX)/bin/esp-proto/proto/LocalStore/LocalStore.js
	...
	mkdir -p "$(BIT_VAPP_PREFIX)/bin/esp-proto/proto/SessionStore/client/components/SessionStore"
	cp src/esp/proto/SessionStore/client/components/SessionStore/SessionStore.js $(BIT_VAPP_PREFIX)/bin/esp-proto/proto/SessionStore/client/components/SessionStore/SessionStore.js
endif
ifeq ($(BIT_PACK_ESP),1)
