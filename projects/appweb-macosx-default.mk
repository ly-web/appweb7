...
$(CONFIG)/bin/libslink.dylib: $(DEPS_41)
...
DEPS_43 += $(CONFIG)/bin/libappweb.dylib
DEPS_43 += $(CONFIG)/inc/est.h
DEPS_43 += $(CONFIG)/obj/estLib.o
ifeq ($(ME_EXT_EST),1)
    DEPS_43 += $(CONFIG)/bin/libest.dylib
endif
DEPS_43 += $(CONFIG)/obj/mprSsl.o
DEPS_43 += $(CONFIG)/bin/libmprssl.dylib
...
$(CONFIG)/bin/libmod_ssl.dylib: $(DEPS_43)
	@echo '      [Link] $(CONFIG)/bin/libmod_ssl.dylib'
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmod_ssl.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmod_ssl.dylib -compatibility_version 5.0.0 -current_version 5.0.0 "$(CONFIG)/obj/sslModule.o" $(LIBPATHS_43) $(LIBS_43) $(LIBS_43) $(LIBS) -lpam 
endif
...
DEPS_45 += $(CONFIG)/bin/libappweb.dylib
...
$(CONFIG)/bin/authpass: $(DEPS_45)
	...
	$(CC) -o $(CONFIG)/bin/authpass -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/authpass.o" $(LIBPATHS_45) $(LIBS_45) $(LIBS_45) $(LIBS) -lpam 
...
DEPS_47 += $(CONFIG)/bin/libslink.dylib
...
$(CONFIG)/bin/appweb: $(DEPS_47)
	...
	$(CC) -o $(CONFIG)/bin/appweb -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/appweb.o" $(LIBPATHS_47) $(LIBS_47) $(LIBS_47) $(LIBS) -lpam 
...
$(CONFIG)/bin/testAppweb: $(DEPS_52)
	...
	$(CC) -o $(CONFIG)/bin/testAppweb -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/testAppweb.o" "$(CONFIG)/obj/testHttp.o" $(LIBPATHS_52) $(LIBS_52) $(LIBS_52) $(LIBS) -lpam 
