...
$(CONFIG)/bin/libmpr.dylib: $(DEPS_6)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmpr.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmpr.dylib -compatibility_version 4.4.1 -current_version 4.4.1 "$(CONFIG)/obj/mprLib.o" $(LIBS) 
...
$(CONFIG)/bin/libest.dylib: $(DEPS_9)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libest.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libest.dylib -compatibility_version 4.4.1 -current_version 4.4.1 "$(CONFIG)/obj/estLib.o" $(LIBS) 
endif
...
$(CONFIG)/bin/libmprssl.dylib: $(DEPS_11)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmprssl.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)    -install_name @rpath/libmprssl.dylib -compatibility_version 4.4.1 -current_version 4.4.1 "$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_11) $(LIBS_11) $(LIBS_11) $(LIBS) 
...
$(CONFIG)/bin/libpcre.dylib: $(DEPS_19)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libpcre.dylib -arch $(CC_ARCH) $(LDFLAGS) -compatibility_version 4.4.1 -current_version 4.4.1 $(LIBPATHS) -install_name @rpath/libpcre.dylib -compatibility_version 4.4.1 -current_version 4.4.1 "$(CONFIG)/obj/pcre.o" $(LIBS) 
endif
...
$(CONFIG)/bin/libhttp.dylib: $(DEPS_22)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libhttp.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libhttp.dylib -compatibility_version 4.4.1 -current_version 4.4.1 "$(CONFIG)/obj/httpLib.o" $(LIBPATHS_22) $(LIBS_22) $(LIBS_22) $(LIBS) -lpam 
...
$(CONFIG)/bin/libsqlite3.dylib: $(DEPS_27)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libsqlite3.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libsqlite3.dylib -compatibility_version 4.4.1 -current_version 4.4.1 "$(CONFIG)/obj/sqlite3.o" $(LIBS) 
endif
...
$(CONFIG)/bin/libappweb.dylib: $(DEPS_38)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libappweb.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libappweb.dylib -compatibility_version 4.4.1 -current_version 4.4.1 "$(CONFIG)/obj/config.o" "$(CONFIG)/obj/convenience.o" "$(CONFIG)/obj/dirHandler.o" "$(CONFIG)/obj/fileHandler.o" "$(CONFIG)/obj/log.o" "$(CONFIG)/obj/server.o" $(LIBPATHS_38) $(LIBS_38) $(LIBS_38) $(LIBS) -lpam 
...
$(CONFIG)/bin/libmod_esp.dylib: $(DEPS_50)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmod_esp.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmod_esp.dylib -compatibility_version 4.4.1 -current_version 4.4.1 "$(CONFIG)/obj/edi.o" "$(CONFIG)/obj/espAbbrev.o" "$(CONFIG)/obj/espFramework.o" "$(CONFIG)/obj/espHandler.o" "$(CONFIG)/obj/espHtml.o" "$(CONFIG)/obj/espTemplate.o" "$(CONFIG)/obj/mdb.o" "$(CONFIG)/obj/sdb.o" $(LIBPATHS_50) $(LIBS_50) $(LIBS_50) $(LIBS) -lpam 
endif
...
$(CONFIG)/bin/libejs.dylib: $(DEPS_60)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libejs.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libejs.dylib -compatibility_version 4.4.1 -current_version 4.4.1 "$(CONFIG)/obj/ejsLib.o" $(LIBPATHS_60) $(LIBS_60) $(LIBS_60) $(LIBS) -lpam 
endif
...
$(CONFIG)/bin/libmod_cgi.dylib: $(DEPS_67)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmod_cgi.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmod_cgi.dylib -compatibility_version 4.4.1 -current_version 4.4.1 "$(CONFIG)/obj/cgiHandler.o" $(LIBPATHS_67) $(LIBS_67) $(LIBS_67) $(LIBS) -lpam 
endif
...
$(CONFIG)/bin/libmod_ejs.dylib: $(DEPS_69)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmod_ejs.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmod_ejs.dylib -compatibility_version 4.4.1 -current_version 4.4.1 "$(CONFIG)/obj/ejsHandler.o" $(LIBPATHS_69) $(LIBS_69) $(LIBS_69) $(LIBS) -lpam 
endif
...
$(CONFIG)/bin/libmod_php.dylib: $(DEPS_71)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmod_php.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libmod_php.dylib -compatibility_version 4.4.1 -current_version 4.4.1 "$(CONFIG)/obj/phpHandler.o" $(LIBPATHS_71) $(LIBS_71) $(LIBS_71) $(LIBS) -lpam 
endif
...
$(CONFIG)/bin/libmod_ssl.dylib: $(DEPS_73)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmod_ssl.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)    -install_name @rpath/libmod_ssl.dylib -compatibility_version 4.4.1 -current_version 4.4.1 "$(CONFIG)/obj/sslModule.o" $(LIBPATHS_73) $(LIBS_73) $(LIBS_73) $(LIBS) -lpam 
endif
...
$(CONFIG)/bin/libslink.dylib: $(DEPS_80)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libslink.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libslink.dylib -compatibility_version 4.4.1 -current_version 4.4.1 "$(CONFIG)/obj/slink.o" $(LIBS) 
...
ifeq ($(BIT_PACK_ESP),1)
	...
	cp src/esp/proto/components/angular-esp/client/lib/angular-esp/ext/esp-click.js $(BIT_VAPP_PREFIX)/esp/proto/components/angular-esp/client/lib/angular-esp/ext/esp-click.js
	...
	cp src/esp/proto/components/angular-esp/client/lib/angular-esp/ext/esp-resource.js $(BIT_VAPP_PREFIX)/esp/proto/components/angular-esp/client/lib/angular-esp/ext/esp-resource.js
