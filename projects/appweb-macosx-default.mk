...
$(CONFIG)/bin/libmpr.dylib: $(DEPS_6)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmpr.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmpr.dylib -compatibility_version 4.5.2 -current_version 4.5.2 "$(CONFIG)/obj/mprLib.o" $(LIBS) 
...
$(CONFIG)/bin/libest.dylib: $(DEPS_9)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libest.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libest.dylib -compatibility_version 4.5.2 -current_version 4.5.2 "$(CONFIG)/obj/estLib.o" $(LIBS) 
endif
...
$(CONFIG)/bin/libmprssl.dylib: $(DEPS_11)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmprssl.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)    -install_name @rpath/libmprssl.dylib -compatibility_version 4.5.2 -current_version 4.5.2 "$(CONFIG)/obj/mprSsl.o" $(LIBPATHS_11) $(LIBS_11) $(LIBS_11) $(LIBS) 
...
$(CONFIG)/bin/libpcre.dylib: $(DEPS_19)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libpcre.dylib -arch $(CC_ARCH) $(LDFLAGS) -compatibility_version 4.5.2 -current_version 4.5.2 $(LIBPATHS) -install_name @rpath/libpcre.dylib -compatibility_version 4.5.2 -current_version 4.5.2 "$(CONFIG)/obj/pcre.o" $(LIBS) 
endif
...
$(CONFIG)/bin/libzlib.dylib: $(DEPS_22)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libzlib.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libzlib.dylib -compatibility_version 4.5.2 -current_version 4.5.2 "$(CONFIG)/obj/zlib.o" $(LIBS) 
endif
...
$(CONFIG)/bin/libhttp.dylib: $(DEPS_25)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libhttp.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libhttp.dylib -compatibility_version 4.5.2 -current_version 4.5.2 "$(CONFIG)/obj/httpLib.o" $(LIBPATHS_25) $(LIBS_25) $(LIBS_25) $(LIBS) -lpam 
...
$(CONFIG)/bin/libsql.dylib: $(DEPS_30)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libsql.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libsql.dylib -compatibility_version 4.5.2 -current_version 4.5.2 "$(CONFIG)/obj/sqlite3.o" $(LIBS) 
endif
...
$(CONFIG)/bin/libappweb.dylib: $(DEPS_41)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libappweb.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libappweb.dylib -compatibility_version 4.5.2 -current_version 4.5.2 "$(CONFIG)/obj/config.o" "$(CONFIG)/obj/convenience.o" "$(CONFIG)/obj/dirHandler.o" "$(CONFIG)/obj/fileHandler.o" "$(CONFIG)/obj/log.o" "$(CONFIG)/obj/server.o" $(LIBPATHS_41) $(LIBS_41) $(LIBS_41) $(LIBS) -lpam 
...
$(CONFIG)/bin/libmod_esp.dylib: $(DEPS_54)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmod_esp.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmod_esp.dylib -compatibility_version 4.5.2 -current_version 4.5.2 "$(CONFIG)/obj/edi.o" "$(CONFIG)/obj/espAbbrev.o" "$(CONFIG)/obj/espDeprecated.o" "$(CONFIG)/obj/espFramework.o" "$(CONFIG)/obj/espHandler.o" "$(CONFIG)/obj/espHtml.o" "$(CONFIG)/obj/espTemplate.o" "$(CONFIG)/obj/mdb.o" "$(CONFIG)/obj/sdb.o" $(LIBPATHS_54) $(LIBS_54) $(LIBS_54) $(LIBS) -lpam 
endif
...
$(CONFIG)/bin/libejs.dylib: $(DEPS_64)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libejs.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libejs.dylib -compatibility_version 4.5.2 -current_version 4.5.2 "$(CONFIG)/obj/ejsLib.o" $(LIBPATHS_64) $(LIBS_64) $(LIBS_64) $(LIBS) -lpam 
endif
...
$(CONFIG)/bin/libmod_cgi.dylib: $(DEPS_71)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmod_cgi.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmod_cgi.dylib -compatibility_version 4.5.2 -current_version 4.5.2 "$(CONFIG)/obj/cgiHandler.o" $(LIBPATHS_71) $(LIBS_71) $(LIBS_71) $(LIBS) -lpam 
endif
...
$(CONFIG)/bin/libmod_ejs.dylib: $(DEPS_73)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmod_ejs.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libmod_ejs.dylib -compatibility_version 4.5.2 -current_version 4.5.2 "$(CONFIG)/obj/ejsHandler.o" $(LIBPATHS_73) $(LIBS_73) $(LIBS_73) $(LIBS) -lpam 
endif
...
$(CONFIG)/bin/libmod_php.dylib: $(DEPS_75)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmod_php.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)  -install_name @rpath/libmod_php.dylib -compatibility_version 4.5.2 -current_version 4.5.2 "$(CONFIG)/obj/phpHandler.o" $(LIBPATHS_75) $(LIBS_75) $(LIBS_75) $(LIBS) -lpam 
endif
...
$(CONFIG)/bin/libmod_ssl.dylib: $(DEPS_77)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libmod_ssl.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS)    -install_name @rpath/libmod_ssl.dylib -compatibility_version 4.5.2 -current_version 4.5.2 "$(CONFIG)/obj/sslModule.o" $(LIBPATHS_77) $(LIBS_77) $(LIBS_77) $(LIBS) -lpam 
endif
...
$(CONFIG)/bin/libslink.dylib: $(DEPS_84)
	...
	$(CC) -dynamiclib -o $(CONFIG)/bin/libslink.dylib -arch $(CC_ARCH) $(LDFLAGS) $(LIBPATHS) -install_name @rpath/libslink.dylib -compatibility_version 4.5.2 -current_version 4.5.2 "$(CONFIG)/obj/slink.o" $(LIBS) 
