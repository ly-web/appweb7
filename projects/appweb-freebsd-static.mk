...
$(BUILD)/bin/libmod_esp.so: $(DEPS_42)
...
ifeq ($(ME_COM_ESP),1)
    DEPS_43 += $(BUILD)/bin/libmod_esp.so
endif
DEPS_43 += $(BUILD)/obj/slink.o

$(BUILD)/bin/libslink.so: $(DEPS_43)
...
DEPS_45 += $(BUILD)/bin/libmprssl.so
DEPS_45 += $(BUILD)/obj/sslModule.o

$(BUILD)/bin/libmod_ssl.so: $(DEPS_45)
...
$(BUILD)/bin/libmod_cgi.so: $(DEPS_46)
...
DEPS_47 += $(BUILD)/bin/libslink.so
ifeq ($(ME_COM_ESP),1)
    DEPS_47 += $(BUILD)/bin/libmod_esp.so
endif
ifeq ($(ME_COM_SSL),1)
    DEPS_47 += $(BUILD)/bin/libmod_ssl.so
endif
ifeq ($(ME_COM_CGI),1)
    DEPS_47 += $(BUILD)/bin/libmod_cgi.so
endif
