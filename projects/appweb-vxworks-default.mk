...
$(CONFIG)/bin/esp.out: $(DEPS_53)
	...
	$(CC) -o $(CONFIG)/bin/esp.out $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/edi.o $(CONFIG)/obj/esp.o $(CONFIG)/obj/espAbbrev.o $(CONFIG)/obj/espFramework.o $(CONFIG)/obj/espHandler.o $(CONFIG)/obj/espHtml.o $(CONFIG)/obj/espTemplate.o $(CONFIG)/obj/mdb.o $(CONFIG)/obj/sdb.o $(LIBS) $(LDFLAGS) 
endif
...
$(CONFIG)/bin/libslink.out: $(DEPS_83)
...
#   appweb
#
DEPS_85 += $(CONFIG)/bin/libappweb.out
DEPS_85 += $(CONFIG)/bin/libslink.out
DEPS_85 += $(CONFIG)/obj/appweb.o

$(CONFIG)/bin/appweb.out: $(DEPS_85)
...
$(CONFIG)/bin/testAppweb.out: $(DEPS_90)
...
#   test-cgiProgram
#
DEPS_94 += $(CONFIG)/bin/cgiProgram.out

test/cgi-bin/cgiProgram.out: $(DEPS_94)
