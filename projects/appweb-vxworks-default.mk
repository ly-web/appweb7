...
$(BUILD)/bin/libslink.out: $(DEPS_51)
...
DEPS_52 += $(BUILD)/bin/libslink.out
...
$(BUILD)/bin/cgiProgram.out: $(DEPS_53)
...
ifeq ($(ME_COM_PCRE),1)
    DEPS_55 += $(BUILD)/bin/libpcre.out
endif
DEPS_55 += $(BUILD)/bin/libmpr.out
ifeq ($(ME_COM_ZLIB),1)
    DEPS_55 += $(BUILD)/bin/libzlib.out
endif
...
#   ejsc
#
DEPS_56 += $(BUILD)/bin/libejs.out
DEPS_56 += $(BUILD)/obj/ejsc.o

$(BUILD)/bin/ejsc.out: $(DEPS_56)
...
$(BUILD)/bin/libmod_esp.out: $(DEPS_60)
...
$(BUILD)/bin/libmod_cgi.out: $(DEPS_65)
...
$(BUILD)/bin/libmod_ejs.out: $(DEPS_66)
...
$(BUILD)/bin/libmprssl.out: $(DEPS_68)
	@echo '      [Link] $(BUILD)/bin/libmprssl.out'
	$(CC) -r -o $(BUILD)/bin/libmprssl.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/mprSsl.o" $(LIBPATHS_68) $(LIBS_68) $(LIBS_68) $(LIBS) 
...
$(BUILD)/bin/libmod_ssl.out: $(DEPS_69)
	@echo '      [Link] $(BUILD)/bin/libmod_ssl.out'
	$(CC) -r -o $(BUILD)/bin/libmod_ssl.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/sslModule.o" $(LIBPATHS_69) $(LIBS_69) $(LIBS_69) $(LIBS) 
endif
