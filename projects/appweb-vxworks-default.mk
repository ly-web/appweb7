...
DEPS_56 += $(BUILD)/bin/libslink.out
DEPS_56 += $(BUILD)/obj/appweb.o

$(BUILD)/bin/appweb.out: $(DEPS_56)
...
$(BUILD)/bin/authpass.out: $(DEPS_57)
...
$(BUILD)/bin/libmod_esp.out: $(DEPS_65)
...
#   espcmd
#
DEPS_66 += $(BUILD)/bin/libmod_esp.out
DEPS_66 += $(BUILD)/obj/esp.o

$(BUILD)/bin/esp.out: $(DEPS_66)
...
#   genslink
#
DEPS_67 += $(BUILD)/bin/libmod_esp.out
...
$(BUILD)/bin/libmod_cgi.out: $(DEPS_71)
...
DEPS_72 += $(BUILD)/bin/libejs.out
DEPS_72 += $(BUILD)/obj/ejsHandler.o

$(BUILD)/bin/libmod_ejs.out: $(DEPS_72)
...
$(BUILD)/bin/libmod_php.out: $(DEPS_73)
	@echo '      [Link] $(BUILD)/bin/libmod_php.out'
	$(CC) -r -o $(BUILD)/bin/libmod_php.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/phpHandler.o" $(LIBPATHS_73) $(LIBS_73) $(LIBS_73) $(LIBS) 
endif
...
$(BUILD)/bin/libmprssl.out: $(DEPS_74)
	@echo '      [Link] $(BUILD)/bin/libmprssl.out'
	$(CC) -r -o $(BUILD)/bin/libmprssl.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/mprSsl.o" $(LIBPATHS_74) $(LIBS_74) $(LIBS_74) $(LIBS) 

ifeq ($(ME_COM_SSL),1)
#
#   libmod_ssl
#
DEPS_75 += $(BUILD)/bin/libappweb.out
...
$(BUILD)/bin/libmod_ssl.out: $(DEPS_75)
	@echo '      [Link] $(BUILD)/bin/libmod_ssl.out'
	$(CC) -r -o $(BUILD)/bin/libmod_ssl.out $(LDFLAGS) $(LIBPATHS)  "$(BUILD)/obj/sslModule.o" $(LIBPATHS_75) $(LIBS_75) $(LIBS_75) $(LIBS) 
endif
