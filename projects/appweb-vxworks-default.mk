...
$(BUILD)/obj/mbedtls.o: \
	...
	$(CC) -c -o $(BUILD)/obj/mbedtls.o $(CFLAGS) -DMBEDTLS_USER_CONFIG_FILE=\"embedtls.h\" $(IFLAGS) src/mbedtls/mbedtls.c
...
$(BUILD)/bin/libmpr.out: $(DEPS_44)
	@echo '      [Link] $(BUILD)/bin/libmpr.out'
	$(CC) -r -o $(BUILD)/bin/libmpr.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/mprLib.o" -lmpr-mbedtls -lmbedtls $(LIBPATHS_44) $(LIBS_44) $(LIBS_44) $(LIBS) 
...
$(BUILD)/bin/libhttp.out: $(DEPS_46)
	@echo '      [Link] $(BUILD)/bin/libhttp.out'
	$(CC) -r -o $(BUILD)/bin/libhttp.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/httpLib.o" $(LIBPATHS_46) $(LIBS_46) $(LIBS_46) $(LIBS) -lmpr-mbedtls -lmbedtls 
endif
...
$(BUILD)/bin/libesp.out: $(DEPS_48)
	...
	$(CC) -r -o $(BUILD)/bin/libesp.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/espLib.o" -lmpr-version $(LIBPATHS_48) $(LIBS_48) $(LIBS_48) $(LIBS) -lmpr-mbedtls -lmbedtls 
endif
...
$(BUILD)/bin/libappweb.out: $(DEPS_49)
	@echo '      [Link] $(BUILD)/bin/libappweb.out'
	$(CC) -r -o $(BUILD)/bin/libappweb.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/config.o" "$(BUILD)/obj/convenience.o" "$(BUILD)/obj/romFiles.o" "$(BUILD)/obj/cgiHandler.o" "$(BUILD)/obj/espHandler.o" $(LIBPATHS_49) $(LIBS_49) $(LIBS_49) $(LIBS) -lmpr-version -lmpr-mbedtls -lmbedtls 
...
$(BUILD)/bin/appweb.out: $(DEPS_50)
	@echo '      [Link] $(BUILD)/bin/appweb.out'
	$(CC) -o $(BUILD)/bin/appweb.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/appweb.o" $(LIBPATHS_50) $(LIBS_50) $(LIBS_50) $(LIBS) -lmpr-version -lmpr-mbedtls -lmbedtls -Wl,-r 
...
$(BUILD)/bin/authpass.out: $(DEPS_51)
	@echo '      [Link] $(BUILD)/bin/authpass.out'
	$(CC) -o $(BUILD)/bin/authpass.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/authpass.o" $(LIBPATHS_51) $(LIBS_51) $(LIBS_51) $(LIBS) -lmpr-version -lmpr-mbedtls -lmbedtls -Wl,-r 
...
$(BUILD)/bin/http.out: $(DEPS_54)
	...
	$(CC) -o $(BUILD)/bin/http.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/http.o" $(LIBPATHS_54) $(LIBS_54) $(LIBS_54) $(LIBS) -lmpr-mbedtls -lmbedtls -Wl,-r 
endif
...
$(BUILD)/bin/appman.out: $(DEPS_57)
	...
	$(CC) -o $(BUILD)/bin/appman.out $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/watchdog.o" -lmpr-mbedtls -lmbedtls $(LIBPATHS_57) $(LIBS_57) $(LIBS_57) $(LIBS) -Wl,-r 
endif
