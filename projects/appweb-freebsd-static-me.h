/*
    me.h -- MakeMe Configuration Header for freebsd-x86-static
...
/* Prefixes */
    ...
    #define ME_VAPP_PREFIX "/usr/local/lib/appweb/4.6.5"
#endif
    ...
    #define ME_SRC_PREFIX "appweb-4.6.5"
#endif
...
/* Profile */
    ...
    #define ME_CONFIG_CMD "me -d -q -platform freebsd-x86-static -static -configure . -with est -gen make"
#endif
