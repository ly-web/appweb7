...
build/$(CONFIG)/obj/slink.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/slink.o $(LDFLAGS) $(IFLAGS) src/server/slink.c
...
build/$(CONFIG)/obj/sslModule.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/sslModule.o $(LDFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/modules/sslModule.c
...
build/$(CONFIG)/obj/appweb.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/appweb.o $(LDFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" "-I$(ME_COM_PHP_PATH)" "-I$(ME_COM_PHP_PATH)/main" "-I$(ME_COM_PHP_PATH)/Zend" "-I$(ME_COM_PHP_PATH)/TSRM" src/server/appweb.c
...
build/$(CONFIG)/bin/appweb: $(DEPS_44)
	...
	$(CC) -o build/$(CONFIG)/bin/appweb $(LDFLAGS) $(LIBPATHS)   "build/$(CONFIG)/obj/appweb.o" $(LIBPATHS_44) $(LIBS_44) $(LIBS_44) $(LIBS) $(LIBS) 
...
build/$(CONFIG)/bin/authpass: $(DEPS_46)
	...
	$(CC) -o build/$(CONFIG)/bin/authpass $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/authpass.o" $(LIBPATHS_46) $(LIBS_46) $(LIBS_46) $(LIBS) $(LIBS) 
...
build/$(CONFIG)/bin/ejsc: $(DEPS_50)
	...
	$(CC) -o build/$(CONFIG)/bin/ejsc $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/ejsc.o" $(LIBPATHS_50) $(LIBS_50) $(LIBS_50) $(LIBS) $(LIBS) 
endif
...
build/$(CONFIG)/bin/ejs: $(DEPS_53)
	...
	$(CC) -o build/$(CONFIG)/bin/ejs $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/ejs.o" $(LIBPATHS_53) $(LIBS_53) $(LIBS_53) $(LIBS) $(LIBS) 
endif
...
build/$(CONFIG)/bin/esp: $(DEPS_57)
	...
	$(CC) -o build/$(CONFIG)/bin/esp $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/esp.o" $(LIBPATHS_57) $(LIBS_57) $(LIBS_57) $(LIBS) $(LIBS) 
endif
...
build/$(CONFIG)/obj/http.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/http.o $(LDFLAGS) $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" src/paks/http/http.c
...
build/$(CONFIG)/bin/http: $(DEPS_61)
	...
	$(CC) -o build/$(CONFIG)/bin/http $(LDFLAGS) $(LIBPATHS)  "build/$(CONFIG)/obj/http.o" $(LIBPATHS_61) $(LIBS_61) $(LIBS_61) $(LIBS) $(LIBS) 
endif
