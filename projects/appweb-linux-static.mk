...
#   ejs.slots.h
#
DEPS_10 += paks/ejs/dist/ejs.slots.h
...
#   ejsByteGoto.h
#
DEPS_11 += paks/ejs/dist/ejsByteGoto.h
...
#   sqlite3.h
#
DEPS_14 += paks/sqlite/dist/sqlite3.h
...
paks/ejs/dist/ejs.h: $(DEPS_23)

#
#   ejs.o
#
DEPS_24 += paks/ejs/dist/ejs.h

$(BUILD)/obj/ejs.o: \
    paks/ejs/dist/ejs.c $(DEPS_24)
	@echo '   [Compile] $(BUILD)/obj/ejs.o'
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/ejs.o $(LDFLAGS) $(IFLAGS) paks/ejs/dist/ejs.c
...
$(BUILD)/obj/ejsLib.o: \
    paks/ejs/dist/ejsLib.c $(DEPS_26)
	@echo '   [Compile] $(BUILD)/obj/ejsLib.o'
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/ejsLib.o $(LDFLAGS) $(IFLAGS) paks/ejs/dist/ejsLib.c

#
#   ejsc.o
#
DEPS_27 += paks/ejs/dist/ejs.h

$(BUILD)/obj/ejsc.o: \
    paks/ejs/dist/ejsc.c $(DEPS_27)
	@echo '   [Compile] $(BUILD)/obj/ejsc.o'
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/ejsc.o $(LDFLAGS) $(IFLAGS) paks/ejs/dist/ejsc.c

#
#   esp.h
#

paks/esp/dist/esp.h: $(DEPS_28)

#
#   esp.o
#
DEPS_29 += paks/esp/dist/esp.h

$(BUILD)/obj/esp.o: \
    paks/esp/dist/esp.c $(DEPS_29)
...
#   espLib.o
#
DEPS_31 += paks/esp/dist/esp.h
DEPS_31 += $(BUILD)/inc/pcre.h
DEPS_31 += $(BUILD)/inc/http.h

$(BUILD)/obj/espLib.o: \
    paks/esp/dist/espLib.c $(DEPS_31)
...
#   httpLib.o
#
DEPS_34 += paks/http/dist/http.h

$(BUILD)/obj/httpLib.o: \
    paks/http/dist/httpLib.c $(DEPS_34)
...
$(BUILD)/obj/makerom.o: \
    paks/mpr/dist/makerom.c $(DEPS_36)
...
$(BUILD)/obj/manager.o: \
    paks/mpr/dist/manager.c $(DEPS_37)
...
$(BUILD)/obj/mprLib.o: \
    paks/mpr/dist/mprLib.c $(DEPS_38)
...
#   mprSsl.o
#
DEPS_39 += paks/mpr/dist/mpr.h

$(BUILD)/obj/mprSsl.o: \
    paks/mpr/dist/mprSsl.c $(DEPS_39)
...
paks/pcre/dist/pcre.h: $(DEPS_40)

#
#   pcre.o
#
DEPS_41 += $(BUILD)/inc/me.h
DEPS_41 += paks/pcre/dist/pcre.h

$(BUILD)/obj/pcre.o: \
    paks/pcre/dist/pcre.c $(DEPS_41)
...
paks/sqlite/dist/sqlite3.h: $(DEPS_44)
...
$(BUILD)/obj/sqlite.o: \
    paks/sqlite/dist/sqlite.c $(DEPS_45)
...
DEPS_46 += paks/sqlite/dist/sqlite3.h

$(BUILD)/obj/sqlite3.o: \
    paks/sqlite/dist/sqlite3.c $(DEPS_46)
...
paks/zlib/dist/zlib.h: $(DEPS_48)

#
#   zlib.o
#
DEPS_49 += $(BUILD)/inc/me.h
DEPS_49 += paks/zlib/dist/zlib.h

$(BUILD)/obj/zlib.o: \
    paks/zlib/dist/zlib.c $(DEPS_49)
	@echo '   [Compile] $(BUILD)/obj/zlib.o'
	$(CC) -c $(DFLAGS) -o $(BUILD)/obj/zlib.o $(LDFLAGS) $(IFLAGS) paks/zlib/dist/zlib.c
...
DEPS_57 += $(BUILD)/obj/mprSsl.o

$(BUILD)/bin/libmprssl.so: $(DEPS_57)
...
DEPS_58 += $(BUILD)/bin/libmprssl.so
DEPS_58 += $(BUILD)/obj/sslModule.o

$(BUILD)/bin/libmod_ssl.so: $(DEPS_58)
...
DEPS_61 += $(BUILD)/obj/ejsHandler.o

$(BUILD)/bin/libmod_ejs.so: $(DEPS_61)
...
DEPS_62 += $(BUILD)/obj/phpHandler.o

$(BUILD)/bin/libmod_php.so: $(DEPS_62)
...
$(BUILD)/bin/libmod_cgi.so: $(DEPS_63)
...
ifeq ($(ME_COM_SSL),1)
    DEPS_64 += $(BUILD)/bin/libmod_ssl.so
endif
ifeq ($(ME_COM_EJS),1)
    DEPS_64 += $(BUILD)/bin/libmod_ejs.so
endif
ifeq ($(ME_COM_PHP),1)
    DEPS_64 += $(BUILD)/bin/libmod_php.so
endif
ifeq ($(ME_COM_CGI),1)
    DEPS_64 += $(BUILD)/bin/libmod_cgi.so
endif
...
$(BUILD)/bin/ejsc: $(DEPS_66)
	@echo '      [Link] $(BUILD)/bin/ejsc'
	$(CC) -o $(BUILD)/bin/ejsc $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/ejsc.o" $(LIBPATHS_66) $(LIBS_66) $(LIBS_66) $(LIBS) $(LIBS) 
endif
...
#   ejs.mod
#
DEPS_67 += paks/ejs/dist/ejs.es
DEPS_67 += $(BUILD)/bin/ejsc

$(BUILD)/bin/ejs.mod: $(DEPS_67)
	( \
	cd paks/ejs/dist; \
...
$(BUILD)/bin/ejs: $(DEPS_68)
	@echo '      [Link] $(BUILD)/bin/ejs'
	$(CC) -o $(BUILD)/bin/ejs $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/ejs.o" $(LIBPATHS_68) $(LIBS_68) $(LIBS_68) $(LIBS) $(LIBS) 
endif
...
#   esp-compile.json
#
DEPS_69 += paks/esp/dist/esp-compile.json

$(BUILD)/bin/esp-compile.json: $(DEPS_69)
...
$(BUILD)/bin/esp: $(DEPS_70)
	@echo '      [Link] $(BUILD)/bin/esp'
	$(CC) -o $(BUILD)/bin/esp $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/esp.o" $(LIBPATHS_70) $(LIBS_70) $(LIBS_70) $(LIBS) $(LIBS) 
endif
...
#   httpcmd
#
DEPS_73 += $(BUILD)/bin/libhttp.so
DEPS_73 += $(BUILD)/bin/libmprssl.so
DEPS_73 += $(BUILD)/obj/http.o
...
$(BUILD)/bin/http: $(DEPS_73)
	@echo '      [Link] $(BUILD)/bin/http'
	$(CC) -o $(BUILD)/bin/http $(LDFLAGS) $(LIBPATHS)   "$(BUILD)/obj/http.o" $(LIBPATHS_73) $(LIBS_73) $(LIBS_73) $(LIBS) $(LIBS) 
endif
