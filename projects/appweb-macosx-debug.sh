...
${CC} -c -o ${CONFIG}/obj/sqlite3.o -arch x86_64 -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/deps/sqlite/sqlite3.c
...
${CC} -c -o ${CONFIG}/obj/config.o -arch x86_64 ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/config.c

${CC} -c -o ${CONFIG}/obj/convenience.o -arch x86_64 ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/convenience.c

${CC} -c -o ${CONFIG}/obj/dirHandler.o -arch x86_64 ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/dirHandler.c

${CC} -c -o ${CONFIG}/obj/fileHandler.o -arch x86_64 ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/fileHandler.c

${CC} -c -o ${CONFIG}/obj/log.o -arch x86_64 ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/log.c

${CC} -c -o ${CONFIG}/obj/server.o -arch x86_64 ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/server.c
...
${CC} -c -o ${CONFIG}/obj/edi.o -arch x86_64 ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/esp/edi.c

${CC} -c -o ${CONFIG}/obj/espAbbrev.o -arch x86_64 ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/esp/espAbbrev.c

${CC} -c -o ${CONFIG}/obj/espFramework.o -arch x86_64 ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/esp/espFramework.c

${CC} -c -o ${CONFIG}/obj/espHandler.o -arch x86_64 ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/esp/espHandler.c

${CC} -c -o ${CONFIG}/obj/espHtml.o -arch x86_64 ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/esp/espHtml.c

${CC} -c -o ${CONFIG}/obj/espSession.o -arch x86_64 ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/esp/espSession.c

${CC} -c -o ${CONFIG}/obj/espTemplate.o -arch x86_64 ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/esp/espTemplate.c

${CC} -c -o ${CONFIG}/obj/mdb.o -arch x86_64 ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/esp/mdb.c

${CC} -c -o ${CONFIG}/obj/sdb.o -arch x86_64 ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/esp/sdb.c
...
${CC} -c -o ${CONFIG}/obj/esp.o -arch x86_64 ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/esp/esp.c
...
${CC} -c -o ${CONFIG}/obj/cgiHandler.o -arch x86_64 ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/modules/cgiHandler.c
...
${CC} -c -o ${CONFIG}/obj/authpass.o -arch x86_64 ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/utils/authpass.c

${CC} -o ${CONFIG}/bin/authpass -arch x86_64 ${LDFLAGS} ${LIBPATHS} ${CONFIG}/obj/authpass.o -lappweb ${LIBS} -lhttp -lpcre -lmpr -lpam

${CC} -c -o ${CONFIG}/obj/cgiProgram.o -arch x86_64 ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/utils/cgiProgram.c

${CC} -o ${CONFIG}/bin/cgiProgram -arch x86_64 ${LDFLAGS} ${LIBPATHS} ${CONFIG}/obj/cgiProgram.o ${LIBS}

${CC} -c -o ${CONFIG}/obj/setConfig.o -arch x86_64 ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/utils/setConfig.c

${CC} -o ${CONFIG}/bin/setConfig -arch x86_64 ${LDFLAGS} ${LIBPATHS} ${CONFIG}/obj/setConfig.o -lmpr ${LIBS}

${CC} -c -o ${CONFIG}/obj/appweb.o -arch x86_64 ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc src/server/appweb.c
...
${CC} -c -o ${CONFIG}/obj/testAppweb.o -arch x86_64 ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc test/testAppweb.c

${CC} -c -o ${CONFIG}/obj/testHttp.o -arch x86_64 ${CFLAGS} -DEMBEDTHIS=1 ${DFLAGS} -I${CONFIG}/inc test/testHttp.c
