...
${CC} -dynamiclib -o ${CONFIG}/bin/libejs.dylib -arch x86_64 ${LDFLAGS} -compatibility_version 4.2.0 -current_version 4.2.0 ${LIBPATHS} -install_name @rpath/libejs.dylib ${CONFIG}/obj/ejsLib.o -lpcre -lsqlite3 -lhttp ${LIBS} -lpcre -lmpr -lpam
...
${CC} -c -o ${CONFIG}/obj/cgiProgram.o -arch x86_64 -mtune=generic ${CFLAGS} ${DFLAGS} -I${CONFIG}/inc src/utils/cgiProgram.c
