...
${CC} -dynamiclib -o ${CONFIG}/bin/libapp.dylib -arch x86_64 ${LDFLAGS} -compatibility_version 4.3.0 -current_version 4.3.0 ${LIBPATHS} -install_name @rpath/libapp.dylib ${CONFIG}/obj/slink.o ${CONFIG}/obj/web.o ${LIBS}

${CC} -c -o ${CONFIG}/obj/appweb.o -arch x86_64 ${CFLAGS} ${DFLAGS} -I${CONFIG}/inc src/server/appweb.c

${CC} -o ${CONFIG}/bin/appweb -arch x86_64 ${LDFLAGS} ${LIBPATHS} ${CONFIG}/obj/appweb.o -lapp -lmod_ssl -lappweb ${LIBS} -lhttp -lpcre -lmpr -lpam
