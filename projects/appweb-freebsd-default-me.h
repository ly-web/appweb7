/*
    me.h -- MakeMe Configure Header for freebsd-x86-default
...
/* Prefixes */
    ...
    #define ME_VAPP_PREFIX "/usr/local/lib/appweb/5.5.0"
#endif
    ...
    #define ME_SRC_PREFIX "appweb-5.5.0"
#endif
