...
#   espLib.o
#
DEPS_23 += paks/esp/dist/esp.h
DEPS_23 += $(BUILD)/inc/pcre.h
DEPS_23 += $(BUILD)/inc/http.h

$(BUILD)/obj/espLib.o: \
    paks/esp/dist/espLib.c $(DEPS_23)
...
#   httpLib.o
#
DEPS_26 += paks/http/dist/http.h

$(BUILD)/obj/httpLib.o: \
    paks/http/dist/httpLib.c $(DEPS_26)
...
$(BUILD)/obj/makerom.o: \
    paks/mpr/dist/makerom.c $(DEPS_28)
...
$(BUILD)/obj/manager.o: \
    paks/mpr/dist/manager.c $(DEPS_29)
...
$(BUILD)/obj/mprLib.o: \
    paks/mpr/dist/mprLib.c $(DEPS_30)
...
#   mprSsl.o
#
DEPS_31 += paks/mpr/dist/mpr.h

$(BUILD)/obj/mprSsl.o: \
    paks/mpr/dist/mprSsl.c $(DEPS_31)
...
paks/pcre/dist/pcre.h: $(DEPS_32)

#
#   pcre.o
#
DEPS_33 += $(BUILD)/inc/me.h
DEPS_33 += paks/pcre/dist/pcre.h

$(BUILD)/obj/pcre.o: \
    paks/pcre/dist/pcre.c $(DEPS_33)
...
paks/sqlite/dist/sqlite3.h: $(DEPS_35)
...
$(BUILD)/obj/sqlite.o: \
    paks/sqlite/dist/sqlite.c $(DEPS_36)
...
DEPS_37 += paks/sqlite/dist/sqlite3.h

$(BUILD)/obj/sqlite3.o: \
    paks/sqlite/dist/sqlite3.c $(DEPS_37)
...
$(BUILD)/obj/sslModule.o: \
    src/modules/sslModule.c $(DEPS_38)
...
$(BUILD)/bin/libappweb.so: $(DEPS_44)
	...
	$(CC) -shared -o $(BUILD)/bin/libappweb.so $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/config.o" "$(BUILD)/obj/convenience.o" $(LIBPATHS_44) $(LIBS_44) $(LIBS_44) $(LIBS) 

#
#   libslink
#
DEPS_45 += $(BUILD)/obj/slink.o

$(BUILD)/bin/libslink.so: $(DEPS_45)
...
$(BUILD)/bin/esp: $(DEPS_50)
	...
	$(CC) -o $(BUILD)/bin/esp $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/esp.o" $(LIBPATHS_50) $(LIBS_50) $(LIBS_50) $(LIBS) $(LIBS) 
endif
...
DEPS_54 += $(BUILD)/obj/cgiHandler.o
...
$(BUILD)/bin/libmod_cgi.so: $(DEPS_54)
	@echo '      [Link] $(BUILD)/bin/libmod_cgi.so'
	$(CC) -shared -o $(BUILD)/bin/libmod_cgi.so $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/cgiHandler.o" $(LIBPATHS_54) $(LIBS_54) $(LIBS_54) $(LIBS) 
endif
...
$(BUILD)/bin/libmod_esp.so: $(DEPS_55)
	...
	$(CC) -shared -o $(BUILD)/bin/libmod_esp.so $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/espHandler.o" $(LIBPATHS_55) $(LIBS_55) $(LIBS_55) $(LIBS) 
endif
...
$(BUILD)/bin/libmprssl.so: $(DEPS_56)
	...
	$(CC) -shared -o $(BUILD)/bin/libmprssl.so $(LDFLAGS) $(LIBPATHS)   "$(BUILD)/obj/mprSsl.o" $(LIBPATHS_56) $(LIBS_56) $(LIBS_56) $(LIBS) 
...
$(BUILD)/bin/libmod_ssl.so: $(DEPS_57)
	...
	$(CC) -shared -o $(BUILD)/bin/libmod_ssl.so $(LDFLAGS) $(LIBPATHS)   "$(BUILD)/obj/sslModule.o" $(LIBPATHS_57) $(LIBS_57) $(LIBS_57) $(LIBS) 
endif
...
#   libsql
#
DEPS_58 += $(BUILD)/inc/sqlite3.h
DEPS_58 += $(BUILD)/obj/sqlite3.o

$(BUILD)/bin/libsql.so: $(DEPS_58)
...
DEPS_60 += $(BUILD)/obj/manager.o

LIBS_60 += -lmpr

$(BUILD)/bin/appman: $(DEPS_60)
	@echo '      [Link] $(BUILD)/bin/appman'
	$(CC) -o $(BUILD)/bin/appman $(LDFLAGS) $(LIBPATHS) "$(BUILD)/obj/manager.o" $(LIBPATHS_60) $(LIBS_60) $(LIBS_60) $(LIBS) $(LIBS) 

#
#   server-cache
#

src/server/cache: $(DEPS_61)
	( \
	cd src/server; \
	mkdir -p "cache" ; \
	)
