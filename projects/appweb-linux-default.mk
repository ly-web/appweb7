...
$(CONFIG)/bin/appman: $(DEPS_13)
	@echo '      [Link] manager'
	$(CC) -o $(CONFIG)/bin/appman $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/manager.o $(LIBS_13) $(LIBS_13) $(LIBS) -lpthread -lm -lrt -ldl $(LDFLAGS) 
...
$(CONFIG)/bin/esp: $(DEPS_53)
	@echo '      [Link] esp'
	$(CC) -o $(CONFIG)/bin/esp $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/edi.o $(CONFIG)/obj/esp.o $(CONFIG)/obj/espAbbrev.o $(CONFIG)/obj/espFramework.o $(CONFIG)/obj/espHandler.o $(CONFIG)/obj/espHtml.o $(CONFIG)/obj/espTemplate.o $(CONFIG)/obj/mdb.o $(CONFIG)/obj/sdb.o $(LIBS_53) $(LIBS_53) $(LIBS) -lpthread -lm -lrt -ldl $(LDFLAGS) 
endif
...
$(CONFIG)/bin/ejs: $(DEPS_64)
	@echo '      [Link] ejs'
	$(CC) -o $(CONFIG)/bin/ejs $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejs.o $(LIBS_64) $(LIBS_64) $(LIBS) -lpthread -lm -lrt -ldl $(LDFLAGS) 
endif
...
$(CONFIG)/bin/ejsc: $(DEPS_66)
	@echo '      [Link] ejsc'
	$(CC) -o $(CONFIG)/bin/ejsc $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/ejsc.o $(LIBS_66) $(LIBS_66) $(LIBS) -lpthread -lm -lrt -ldl $(LDFLAGS) 
endif
...
$(CONFIG)/bin/authpass: $(DEPS_77)
	@echo '      [Link] authpass'
	$(CC) -o $(CONFIG)/bin/authpass $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/authpass.o $(LIBS_77) $(LIBS_77) $(LIBS) -lpthread -lm -lrt -ldl $(LDFLAGS) 
...
$(CONFIG)/bin/appweb: $(DEPS_84)
	@echo '      [Link] appweb'
	$(CC) -o $(CONFIG)/bin/appweb $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/appweb.o $(LIBS_84) $(LIBS_84) $(LIBS) -lpthread -lm -lrt -ldl $(LDFLAGS) 
...
$(CONFIG)/bin/testAppweb: $(DEPS_89)
	...
	$(CC) -o $(CONFIG)/bin/testAppweb $(LDFLAGS) $(LIBPATHS) $(CONFIG)/obj/testAppweb.o $(CONFIG)/obj/testHttp.o $(LIBS_89) $(LIBS_89) $(LIBS) -lpthread -lm -lrt -ldl $(LDFLAGS) 
