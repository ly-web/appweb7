...
$(CONFIG)/bin/libappweb.so: $(DEPS_38)
	...
	$(CC) -shared -o $(CONFIG)/bin/libappweb.so $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/config.o" "$(CONFIG)/obj/convenience.o" "$(CONFIG)/obj/dirHandler.o" "$(CONFIG)/obj/fileHandler.o" "$(CONFIG)/obj/log.o" "$(CONFIG)/obj/server.o" $(LIBPATHS_38) $(LIBS_38) $(LIBS_38) $(LIBS) 
...
$(CONFIG)/bin/libmod_esp.so: $(DEPS_51)
	...
	$(CC) -shared -o $(CONFIG)/bin/libmod_esp.so $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/edi.o" "$(CONFIG)/obj/espAbbrev.o" "$(CONFIG)/obj/espDeprecated.o" "$(CONFIG)/obj/espFramework.o" "$(CONFIG)/obj/espHandler.o" "$(CONFIG)/obj/espHtml.o" "$(CONFIG)/obj/espTemplate.o" "$(CONFIG)/obj/mdb.o" "$(CONFIG)/obj/sdb.o" $(LIBPATHS_51) $(LIBS_51) $(LIBS_51) $(LIBS) 
endif
...
DEPS_53 += $(CONFIG)/bin/libmod_esp.so
...
$(CONFIG)/bin/esp: $(DEPS_53)
	...
	$(CC) -o $(CONFIG)/bin/esp $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/edi.o" "$(CONFIG)/obj/esp.o" "$(CONFIG)/obj/espAbbrev.o" "$(CONFIG)/obj/espDeprecated.o" "$(CONFIG)/obj/espFramework.o" "$(CONFIG)/obj/espHandler.o" "$(CONFIG)/obj/espHtml.o" "$(CONFIG)/obj/espTemplate.o" "$(CONFIG)/obj/mdb.o" "$(CONFIG)/obj/sdb.o" $(LIBPATHS_53) $(LIBS_53) $(LIBS_53) $(LIBS) $(LIBS) 
endif
...
$(CONFIG)/bin/libejs.so: $(DEPS_61)
	...
	$(CC) -shared -o $(CONFIG)/bin/libejs.so $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsLib.o" $(LIBPATHS_61) $(LIBS_61) $(LIBS_61) $(LIBS) 
endif
...
ifeq ($(BIT_PACK_PCRE),1)
    DEPS_63 += $(CONFIG)/bin/libpcre.so
endif
DEPS_63 += $(CONFIG)/inc/http.h
DEPS_63 += $(CONFIG)/obj/httpLib.o
DEPS_63 += $(CONFIG)/bin/libhttp.so
...
$(CONFIG)/bin/libmod_cgi.so: $(DEPS_68)
	...
	$(CC) -shared -o $(CONFIG)/bin/libmod_cgi.so $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/cgiHandler.o" $(LIBPATHS_68) $(LIBS_68) $(LIBS_68) $(LIBS) 
endif
...
ifeq ($(BIT_PACK_PCRE),1)
    DEPS_70 += $(CONFIG)/bin/libpcre.so
endif
DEPS_70 += $(CONFIG)/inc/http.h
DEPS_70 += $(CONFIG)/obj/httpLib.o
DEPS_70 += $(CONFIG)/bin/libhttp.so
...
$(CONFIG)/bin/libmod_ejs.so: $(DEPS_70)
	...
	$(CC) -shared -o $(CONFIG)/bin/libmod_ejs.so $(LDFLAGS) $(LIBPATHS) "$(CONFIG)/obj/ejsHandler.o" $(LIBPATHS_70) $(LIBS_70) $(LIBS_70) $(LIBS) 
endif
...
$(CONFIG)/bin/libmod_php.so: $(DEPS_72)
	@echo '      [Link] $(CONFIG)/bin/libmod_php.so'
	$(CC) -shared -o $(CONFIG)/bin/libmod_php.so $(LDFLAGS) $(LIBPATHS)  "$(CONFIG)/obj/phpHandler.o" $(LIBPATHS_72) $(LIBS_72) $(LIBS_72) $(LIBS) 
endif
...
ifeq ($(BIT_PACK_PCRE),1)
    DEPS_74 += $(CONFIG)/bin/libpcre.so
endif
DEPS_74 += $(CONFIG)/inc/http.h
DEPS_74 += $(CONFIG)/obj/httpLib.o
DEPS_74 += $(CONFIG)/bin/libhttp.so
...
ifeq ($(BIT_PACK_EST),1)
    DEPS_74 += $(CONFIG)/bin/libest.so
endif
DEPS_74 += $(CONFIG)/obj/mprSsl.o
DEPS_74 += $(CONFIG)/bin/libmprssl.so
...
$(CONFIG)/bin/libmod_ssl.so: $(DEPS_74)
	@echo '      [Link] $(CONFIG)/bin/libmod_ssl.so'
	$(CC) -shared -o $(CONFIG)/bin/libmod_ssl.so $(LDFLAGS) $(LIBPATHS)    "$(CONFIG)/obj/sslModule.o" $(LIBPATHS_74) $(LIBS_74) $(LIBS_74) $(LIBS) 
endif
...
DEPS_76 += $(CONFIG)/bin/libappweb.so
...
$(CONFIG)/bin/libslink.so: $(DEPS_81)
...
ifeq ($(BIT_PACK_PCRE),1)
    DEPS_88 += $(CONFIG)/bin/libpcre.so
endif
DEPS_88 += $(CONFIG)/inc/http.h
DEPS_88 += $(CONFIG)/obj/httpLib.o
DEPS_88 += $(CONFIG)/bin/libhttp.so
...
DEPS_88 += $(CONFIG)/bin/libappweb.so
...
DEPS_89 += $(CONFIG)/bin/libappweb.so
...
DEPS_90 += $(CONFIG)/bin/libappweb.so
...
DEPS_91 += $(CONFIG)/bin/libappweb.so
...
ifeq ($(BIT_PACK_SQLITE),1)
	cp $(CONFIG)/bin/libsql.so $(BIT_VAPP_PREFIX)/bin/libsql.so
endif
ifeq ($(BIT_PACK_ESP),1)
...
ifeq ($(BIT_PACK_ESP),1)
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/angular/client/lib/angular"
	cp src/esp/proto/angular/client/lib/angular/angular-animate.js $(BIT_VAPP_PREFIX)/esp/angular/client/lib/angular/angular-animate.js
	cp src/esp/proto/angular/client/lib/angular/angular-bootstrap-prettify.js $(BIT_VAPP_PREFIX)/esp/angular/client/lib/angular/angular-bootstrap-prettify.js
	cp src/esp/proto/angular/client/lib/angular/angular-bootstrap.js $(BIT_VAPP_PREFIX)/esp/angular/client/lib/angular/angular-bootstrap.js
	cp src/esp/proto/angular/client/lib/angular/angular-cookies.js $(BIT_VAPP_PREFIX)/esp/angular/client/lib/angular/angular-cookies.js
	cp src/esp/proto/angular/client/lib/angular/angular-loader.js $(BIT_VAPP_PREFIX)/esp/angular/client/lib/angular/angular-loader.js
	cp src/esp/proto/angular/client/lib/angular/angular-mocks.js $(BIT_VAPP_PREFIX)/esp/angular/client/lib/angular/angular-mocks.js
	cp src/esp/proto/angular/client/lib/angular/angular-resource.js $(BIT_VAPP_PREFIX)/esp/angular/client/lib/angular/angular-resource.js
	cp src/esp/proto/angular/client/lib/angular/angular-route.js $(BIT_VAPP_PREFIX)/esp/angular/client/lib/angular/angular-route.js
	cp src/esp/proto/angular/client/lib/angular/angular-sanitize.js $(BIT_VAPP_PREFIX)/esp/angular/client/lib/angular/angular-sanitize.js
	cp src/esp/proto/angular/client/lib/angular/angular-scenario.js $(BIT_VAPP_PREFIX)/esp/angular/client/lib/angular/angular-scenario.js
	cp src/esp/proto/angular/client/lib/angular/angular-touch.js $(BIT_VAPP_PREFIX)/esp/angular/client/lib/angular/angular-touch.js
	cp src/esp/proto/angular/client/lib/angular/angular.js $(BIT_VAPP_PREFIX)/esp/angular/client/lib/angular/angular.js
	cp src/esp/proto/angular/client/lib/angular/errors.json $(BIT_VAPP_PREFIX)/esp/angular/client/lib/angular/errors.json
	cp src/esp/proto/angular/client/lib/angular/version.json $(BIT_VAPP_PREFIX)/esp/angular/client/lib/angular/version.json
	cp src/esp/proto/angular/client/lib/angular/version.txt $(BIT_VAPP_PREFIX)/esp/angular/client/lib/angular/version.txt
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/angular"
	cp src/esp/proto/angular/esp.json $(BIT_VAPP_PREFIX)/esp/angular/esp.json
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/angular-esp/client/lib/angular-esp"
	cp src/esp/proto/angular-esp/client/lib/angular-esp/esp-click.js $(BIT_VAPP_PREFIX)/esp/angular-esp/client/lib/angular-esp/esp-click.js
	cp src/esp/proto/angular-esp/client/lib/angular-esp/esp-confirm.js $(BIT_VAPP_PREFIX)/esp/angular-esp/client/lib/angular-esp/esp-confirm.js
	cp src/esp/proto/angular-esp/client/lib/angular-esp/esp-field-errors.js $(BIT_VAPP_PREFIX)/esp/angular-esp/client/lib/angular-esp/esp-field-errors.js
	cp src/esp/proto/angular-esp/client/lib/angular-esp/esp-format.js $(BIT_VAPP_PREFIX)/esp/angular-esp/client/lib/angular-esp/esp-format.js
	cp src/esp/proto/angular-esp/client/lib/angular-esp/esp-gauge.js $(BIT_VAPP_PREFIX)/esp/angular-esp/client/lib/angular-esp/esp-gauge.js
	cp src/esp/proto/angular-esp/client/lib/angular-esp/esp-input-group.js $(BIT_VAPP_PREFIX)/esp/angular-esp/client/lib/angular-esp/esp-input-group.js
	cp src/esp/proto/angular-esp/client/lib/angular-esp/esp-input.js $(BIT_VAPP_PREFIX)/esp/angular-esp/client/lib/angular-esp/esp-input.js
	cp src/esp/proto/angular-esp/client/lib/angular-esp/esp-local.es $(BIT_VAPP_PREFIX)/esp/angular-esp/client/lib/angular-esp/esp-local.es
	cp src/esp/proto/angular-esp/client/lib/angular-esp/esp-local.js $(BIT_VAPP_PREFIX)/esp/angular-esp/client/lib/angular-esp/esp-local.js
	cp src/esp/proto/angular-esp/client/lib/angular-esp/esp-modal.js $(BIT_VAPP_PREFIX)/esp/angular-esp/client/lib/angular-esp/esp-modal.js
	cp src/esp/proto/angular-esp/client/lib/angular-esp/esp-resource.es $(BIT_VAPP_PREFIX)/esp/angular-esp/client/lib/angular-esp/esp-resource.es
	cp src/esp/proto/angular-esp/client/lib/angular-esp/esp-resource.js $(BIT_VAPP_PREFIX)/esp/angular-esp/client/lib/angular-esp/esp-resource.js
	cp src/esp/proto/angular-esp/client/lib/angular-esp/esp-session.es $(BIT_VAPP_PREFIX)/esp/angular-esp/client/lib/angular-esp/esp-session.es
	cp src/esp/proto/angular-esp/client/lib/angular-esp/esp-session.js $(BIT_VAPP_PREFIX)/esp/angular-esp/client/lib/angular-esp/esp-session.js
	cp src/esp/proto/angular-esp/client/lib/angular-esp/esp-titlecase.js $(BIT_VAPP_PREFIX)/esp/angular-esp/client/lib/angular-esp/esp-titlecase.js
	cp src/esp/proto/angular-esp/client/lib/angular-esp/esp.es $(BIT_VAPP_PREFIX)/esp/angular-esp/client/lib/angular-esp/esp.es
	cp src/esp/proto/angular-esp/client/lib/angular-esp/esp.js $(BIT_VAPP_PREFIX)/esp/angular-esp/client/lib/angular-esp/esp.js
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/angular-esp"
	cp src/esp/proto/angular-esp/esp.json $(BIT_VAPP_PREFIX)/esp/angular-esp/esp.json
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/angular-esp-extras/client/lib/angular-esp-extras"
	cp src/esp/proto/angular-esp-extras/client/lib/angular-esp-extras/esp-svg-gauge.js $(BIT_VAPP_PREFIX)/esp/angular-esp-extras/client/lib/angular-esp-extras/esp-svg-gauge.js
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/angular-esp-extras"
	cp src/esp/proto/angular-esp-extras/esp.json $(BIT_VAPP_PREFIX)/esp/angular-esp-extras/esp.json
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/angular-mvc"
	cp src/esp/proto/angular-mvc/appweb.conf $(BIT_VAPP_PREFIX)/esp/angular-mvc/appweb.conf
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/angular-mvc/client/app"
	cp src/esp/proto/angular-mvc/client/app/main.js $(BIT_VAPP_PREFIX)/esp/angular-mvc/client/app/main.js
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/angular-mvc/client/assets"
	cp src/esp/proto/angular-mvc/client/assets/favicon.ico $(BIT_VAPP_PREFIX)/esp/angular-mvc/client/assets/favicon.ico
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/angular-mvc/client/css"
	cp src/esp/proto/angular-mvc/client/css/all.less $(BIT_VAPP_PREFIX)/esp/angular-mvc/client/css/all.less
	cp src/esp/proto/angular-mvc/client/css/app.less $(BIT_VAPP_PREFIX)/esp/angular-mvc/client/css/app.less
	cp src/esp/proto/angular-mvc/client/css/fix.less $(BIT_VAPP_PREFIX)/esp/angular-mvc/client/css/fix.less
	cp src/esp/proto/angular-mvc/client/css/theme.less $(BIT_VAPP_PREFIX)/esp/angular-mvc/client/css/theme.less
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/angular-mvc/client"
	cp src/esp/proto/angular-mvc/client/index.esp $(BIT_VAPP_PREFIX)/esp/angular-mvc/client/index.esp
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/angular-mvc/client/pages"
	cp src/esp/proto/angular-mvc/client/pages/splash.html $(BIT_VAPP_PREFIX)/esp/angular-mvc/client/pages/splash.html
	cp src/esp/proto/angular-mvc/esp.json $(BIT_VAPP_PREFIX)/esp/angular-mvc/esp.json
	cp src/esp/proto/angular-mvc/hosted.conf $(BIT_VAPP_PREFIX)/esp/angular-mvc/hosted.conf
	cp src/esp/proto/angular-mvc/start.bit $(BIT_VAPP_PREFIX)/esp/angular-mvc/start.bit
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/angular-mvc/templates"
	cp src/esp/proto/angular-mvc/templates/controller-singleton.c $(BIT_VAPP_PREFIX)/esp/angular-mvc/templates/controller-singleton.c
	cp src/esp/proto/angular-mvc/templates/controller.c $(BIT_VAPP_PREFIX)/esp/angular-mvc/templates/controller.c
	cp src/esp/proto/angular-mvc/templates/controller.js $(BIT_VAPP_PREFIX)/esp/angular-mvc/templates/controller.js
	cp src/esp/proto/angular-mvc/templates/edit.html $(BIT_VAPP_PREFIX)/esp/angular-mvc/templates/edit.html
	cp src/esp/proto/angular-mvc/templates/list.html $(BIT_VAPP_PREFIX)/esp/angular-mvc/templates/list.html
	cp src/esp/proto/angular-mvc/templates/model.js $(BIT_VAPP_PREFIX)/esp/angular-mvc/templates/model.js
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/angular-ui-bootstrap/client/lib/angular-ui-bootstrap"
	cp src/esp/proto/angular-ui-bootstrap/client/lib/angular-ui-bootstrap/ui-bootstrap-tpls.js $(BIT_VAPP_PREFIX)/esp/angular-ui-bootstrap/client/lib/angular-ui-bootstrap/ui-bootstrap-tpls.js
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/angular-ui-bootstrap"
	cp src/esp/proto/angular-ui-bootstrap/esp.json $(BIT_VAPP_PREFIX)/esp/angular-ui-bootstrap/esp.json
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/animate/client/css"
	cp src/esp/proto/animate/client/css/animate.css $(BIT_VAPP_PREFIX)/esp/animate/client/css/animate.css
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/animate"
	cp src/esp/proto/animate/esp.json $(BIT_VAPP_PREFIX)/esp/animate/esp.json
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/css"
	cp src/esp/proto/bootstrap/client/lib/bootstrap/css/bootstrap-theme.css $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/css/bootstrap-theme.css
	cp src/esp/proto/bootstrap/client/lib/bootstrap/css/bootstrap-theme.min.css $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/css/bootstrap-theme.min.css
	cp src/esp/proto/bootstrap/client/lib/bootstrap/css/bootstrap.css $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/css/bootstrap.css
	cp src/esp/proto/bootstrap/client/lib/bootstrap/css/bootstrap.min.css $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/css/bootstrap.min.css
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/fonts"
	cp src/esp/proto/bootstrap/client/lib/bootstrap/fonts/glyphicons-halflings-regular.eot $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/fonts/glyphicons-halflings-regular.eot
	cp src/esp/proto/bootstrap/client/lib/bootstrap/fonts/glyphicons-halflings-regular.svg $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/fonts/glyphicons-halflings-regular.svg
	cp src/esp/proto/bootstrap/client/lib/bootstrap/fonts/glyphicons-halflings-regular.ttf $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/fonts/glyphicons-halflings-regular.ttf
	cp src/esp/proto/bootstrap/client/lib/bootstrap/fonts/glyphicons-halflings-regular.woff $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/fonts/glyphicons-halflings-regular.woff
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/js"
	cp src/esp/proto/bootstrap/client/lib/bootstrap/js/bootstrap.js $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/js/bootstrap.js
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less"
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/alerts.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/alerts.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/badges.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/badges.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/bootstrap.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/bootstrap.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/breadcrumbs.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/breadcrumbs.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/button-groups.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/button-groups.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/buttons.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/buttons.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/carousel.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/carousel.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/close.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/close.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/code.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/code.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/component-animations.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/component-animations.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/dropdowns.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/dropdowns.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/forms.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/forms.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/glyphicons.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/glyphicons.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/grid.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/grid.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/input-groups.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/input-groups.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/jumbotron.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/jumbotron.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/labels.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/labels.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/list-group.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/list-group.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/media.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/media.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/mixins.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/mixins.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/modals.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/modals.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/navbar.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/navbar.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/navs.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/navs.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/normalize.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/normalize.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/pager.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/pager.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/pagination.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/pagination.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/panels.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/panels.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/popovers.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/popovers.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/print.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/print.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/progress-bars.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/progress-bars.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/responsive-utilities.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/responsive-utilities.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/scaffolding.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/scaffolding.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/tables.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/tables.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/theme.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/theme.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/thumbnails.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/thumbnails.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/tooltip.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/tooltip.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/type.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/type.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/utilities.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/utilities.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/variables.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/variables.less
	cp src/esp/proto/bootstrap/client/lib/bootstrap/less/wells.less $(BIT_VAPP_PREFIX)/esp/bootstrap/client/lib/bootstrap/less/wells.less
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/bootstrap"
	cp src/esp/proto/bootstrap/esp.json $(BIT_VAPP_PREFIX)/esp/bootstrap/esp.json
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/d3/client/lib/d3"
	cp src/esp/proto/d3/client/lib/d3/d3.v3.js $(BIT_VAPP_PREFIX)/esp/d3/client/lib/d3/d3.v3.js
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/d3"
	cp src/esp/proto/d3/esp.json $(BIT_VAPP_PREFIX)/esp/d3/esp.json
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/flot/client/lib/flot"
	cp src/esp/proto/flot/client/lib/flot/excanvas.js $(BIT_VAPP_PREFIX)/esp/flot/client/lib/flot/excanvas.js
	cp src/esp/proto/flot/client/lib/flot/jquery.colorhelpers.js $(BIT_VAPP_PREFIX)/esp/flot/client/lib/flot/jquery.colorhelpers.js
	cp src/esp/proto/flot/client/lib/flot/jquery.flot.canvas.js $(BIT_VAPP_PREFIX)/esp/flot/client/lib/flot/jquery.flot.canvas.js
	cp src/esp/proto/flot/client/lib/flot/jquery.flot.categories.js $(BIT_VAPP_PREFIX)/esp/flot/client/lib/flot/jquery.flot.categories.js
	cp src/esp/proto/flot/client/lib/flot/jquery.flot.crosshair.js $(BIT_VAPP_PREFIX)/esp/flot/client/lib/flot/jquery.flot.crosshair.js
	cp src/esp/proto/flot/client/lib/flot/jquery.flot.errorbars.js $(BIT_VAPP_PREFIX)/esp/flot/client/lib/flot/jquery.flot.errorbars.js
	cp src/esp/proto/flot/client/lib/flot/jquery.flot.fillbetween.js $(BIT_VAPP_PREFIX)/esp/flot/client/lib/flot/jquery.flot.fillbetween.js
	cp src/esp/proto/flot/client/lib/flot/jquery.flot.image.js $(BIT_VAPP_PREFIX)/esp/flot/client/lib/flot/jquery.flot.image.js
	cp src/esp/proto/flot/client/lib/flot/jquery.flot.js $(BIT_VAPP_PREFIX)/esp/flot/client/lib/flot/jquery.flot.js
	cp src/esp/proto/flot/client/lib/flot/jquery.flot.navigate.js $(BIT_VAPP_PREFIX)/esp/flot/client/lib/flot/jquery.flot.navigate.js
	cp src/esp/proto/flot/client/lib/flot/jquery.flot.pie.js $(BIT_VAPP_PREFIX)/esp/flot/client/lib/flot/jquery.flot.pie.js
	cp src/esp/proto/flot/client/lib/flot/jquery.flot.resize.js $(BIT_VAPP_PREFIX)/esp/flot/client/lib/flot/jquery.flot.resize.js
	cp src/esp/proto/flot/client/lib/flot/jquery.flot.selection.js $(BIT_VAPP_PREFIX)/esp/flot/client/lib/flot/jquery.flot.selection.js
	cp src/esp/proto/flot/client/lib/flot/jquery.flot.stack.js $(BIT_VAPP_PREFIX)/esp/flot/client/lib/flot/jquery.flot.stack.js
	cp src/esp/proto/flot/client/lib/flot/jquery.flot.symbol.js $(BIT_VAPP_PREFIX)/esp/flot/client/lib/flot/jquery.flot.symbol.js
	cp src/esp/proto/flot/client/lib/flot/jquery.flot.threshold.js $(BIT_VAPP_PREFIX)/esp/flot/client/lib/flot/jquery.flot.threshold.js
	cp src/esp/proto/flot/client/lib/flot/jquery.flot.time.js $(BIT_VAPP_PREFIX)/esp/flot/client/lib/flot/jquery.flot.time.js
	cp src/esp/proto/flot/client/lib/flot/jquery.js $(BIT_VAPP_PREFIX)/esp/flot/client/lib/flot/jquery.js
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/flot"
	cp src/esp/proto/flot/esp.json $(BIT_VAPP_PREFIX)/esp/flot/esp.json
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/css"
	cp src/esp/proto/font-awesome/client/lib/font-awesome/css/font-awesome-ie7.css $(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/css/font-awesome-ie7.css
	cp src/esp/proto/font-awesome/client/lib/font-awesome/css/font-awesome-ie7.min.css $(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/css/font-awesome-ie7.min.css
	cp src/esp/proto/font-awesome/client/lib/font-awesome/css/font-awesome.css $(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/css/font-awesome.css
	cp src/esp/proto/font-awesome/client/lib/font-awesome/css/font-awesome.min.css $(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/css/font-awesome.min.css
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/font"
	cp src/esp/proto/font-awesome/client/lib/font-awesome/font/fontawesome-webfont.eot $(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/font/fontawesome-webfont.eot
	cp src/esp/proto/font-awesome/client/lib/font-awesome/font/fontawesome-webfont.svg $(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/font/fontawesome-webfont.svg
	cp src/esp/proto/font-awesome/client/lib/font-awesome/font/fontawesome-webfont.ttf $(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/font/fontawesome-webfont.ttf
	cp src/esp/proto/font-awesome/client/lib/font-awesome/font/fontawesome-webfont.woff $(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/font/fontawesome-webfont.woff
	cp src/esp/proto/font-awesome/client/lib/font-awesome/font/FontAwesome.otf $(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/font/FontAwesome.otf
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/less"
	cp src/esp/proto/font-awesome/client/lib/font-awesome/less/bootstrap.less $(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/less/bootstrap.less
	cp src/esp/proto/font-awesome/client/lib/font-awesome/less/core.less $(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/less/core.less
	cp src/esp/proto/font-awesome/client/lib/font-awesome/less/extras.less $(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/less/extras.less
	cp src/esp/proto/font-awesome/client/lib/font-awesome/less/font-awesome-ie7.less $(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/less/font-awesome-ie7.less
	cp src/esp/proto/font-awesome/client/lib/font-awesome/less/font-awesome.less $(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/less/font-awesome.less
	cp src/esp/proto/font-awesome/client/lib/font-awesome/less/icons.less $(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/less/icons.less
	cp src/esp/proto/font-awesome/client/lib/font-awesome/less/mixins.less $(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/less/mixins.less
	cp src/esp/proto/font-awesome/client/lib/font-awesome/less/path.less $(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/less/path.less
	cp src/esp/proto/font-awesome/client/lib/font-awesome/less/variables.less $(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/less/variables.less
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/scss"
	cp src/esp/proto/font-awesome/client/lib/font-awesome/scss/_bootstrap.scss $(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/scss/_bootstrap.scss
	cp src/esp/proto/font-awesome/client/lib/font-awesome/scss/_core.scss $(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/scss/_core.scss
	cp src/esp/proto/font-awesome/client/lib/font-awesome/scss/_extras.scss $(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/scss/_extras.scss
	cp src/esp/proto/font-awesome/client/lib/font-awesome/scss/_icons.scss $(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/scss/_icons.scss
	cp src/esp/proto/font-awesome/client/lib/font-awesome/scss/_mixins.scss $(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/scss/_mixins.scss
	cp src/esp/proto/font-awesome/client/lib/font-awesome/scss/_path.scss $(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/scss/_path.scss
	cp src/esp/proto/font-awesome/client/lib/font-awesome/scss/_variables.scss $(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/scss/_variables.scss
	cp src/esp/proto/font-awesome/client/lib/font-awesome/scss/font-awesome-ie7.scss $(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/scss/font-awesome-ie7.scss
	cp src/esp/proto/font-awesome/client/lib/font-awesome/scss/font-awesome.scss $(BIT_VAPP_PREFIX)/esp/font-awesome/client/lib/font-awesome/scss/font-awesome.scss
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/font-awesome"
	cp src/esp/proto/font-awesome/esp.json $(BIT_VAPP_PREFIX)/esp/font-awesome/esp.json
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/html-mvc"
	cp src/esp/proto/html-mvc/appweb.conf $(BIT_VAPP_PREFIX)/esp/html-mvc/appweb.conf
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/html-mvc/client/assets"
	cp src/esp/proto/html-mvc/client/assets/favicon.ico $(BIT_VAPP_PREFIX)/esp/html-mvc/client/assets/favicon.ico
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/html-mvc/client/css"
	cp src/esp/proto/html-mvc/client/css/all.less $(BIT_VAPP_PREFIX)/esp/html-mvc/client/css/all.less
	cp src/esp/proto/html-mvc/client/css/app.less $(BIT_VAPP_PREFIX)/esp/html-mvc/client/css/app.less
	cp src/esp/proto/html-mvc/client/css/fix.less $(BIT_VAPP_PREFIX)/esp/html-mvc/client/css/fix.less
	cp src/esp/proto/html-mvc/client/css/theme.less $(BIT_VAPP_PREFIX)/esp/html-mvc/client/css/theme.less
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/html-mvc/client"
	cp src/esp/proto/html-mvc/client/index.esp $(BIT_VAPP_PREFIX)/esp/html-mvc/client/index.esp
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/html-mvc/client/layouts"
	cp src/esp/proto/html-mvc/client/layouts/default.esp $(BIT_VAPP_PREFIX)/esp/html-mvc/client/layouts/default.esp
	cp src/esp/proto/html-mvc/esp.json $(BIT_VAPP_PREFIX)/esp/html-mvc/esp.json
	cp src/esp/proto/html-mvc/hosted.conf $(BIT_VAPP_PREFIX)/esp/html-mvc/hosted.conf
	cp src/esp/proto/html-mvc/start.bit $(BIT_VAPP_PREFIX)/esp/html-mvc/start.bit
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/html-mvc/templates"
	cp src/esp/proto/html-mvc/templates/controller-singleton.c $(BIT_VAPP_PREFIX)/esp/html-mvc/templates/controller-singleton.c
	cp src/esp/proto/html-mvc/templates/controller.c $(BIT_VAPP_PREFIX)/esp/html-mvc/templates/controller.c
	cp src/esp/proto/html-mvc/templates/edit.esp $(BIT_VAPP_PREFIX)/esp/html-mvc/templates/edit.esp
	cp src/esp/proto/html-mvc/templates/list.esp $(BIT_VAPP_PREFIX)/esp/html-mvc/templates/list.esp
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/html5shiv/client/lib/html5shiv"
	cp src/esp/proto/html5shiv/client/lib/html5shiv/html5shiv.js $(BIT_VAPP_PREFIX)/esp/html5shiv/client/lib/html5shiv/html5shiv.js
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/html5shiv"
	cp src/esp/proto/html5shiv/esp.json $(BIT_VAPP_PREFIX)/esp/html5shiv/esp.json
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/jquery/client/lib/jquery"
	cp src/esp/proto/jquery/client/lib/jquery/jquery.js $(BIT_VAPP_PREFIX)/esp/jquery/client/lib/jquery/jquery.js
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/jquery"
	cp src/esp/proto/jquery/esp.json $(BIT_VAPP_PREFIX)/esp/jquery/esp.json
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/legacy-mvc"
	cp src/esp/proto/legacy-mvc/esp.json $(BIT_VAPP_PREFIX)/esp/legacy-mvc/esp.json
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/legacy-mvc/layouts"
	...
	cp src/esp/proto/less/esp.json $(BIT_VAPP_PREFIX)/esp/less/esp.json
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/more/client/css"
	cp src/esp/proto/more/client/css/more.less $(BIT_VAPP_PREFIX)/esp/more/client/css/more.less
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/more"
	cp src/esp/proto/more/esp.json $(BIT_VAPP_PREFIX)/esp/more/esp.json
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/normalize/client/css"
	cp src/esp/proto/normalize/client/css/normalize.less $(BIT_VAPP_PREFIX)/esp/normalize/client/css/normalize.less
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/normalize"
	cp src/esp/proto/normalize/esp.json $(BIT_VAPP_PREFIX)/esp/normalize/esp.json
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/nvd3/client/lib/nvd3"
	cp src/esp/proto/nvd3/client/lib/nvd3/nv.d3.css $(BIT_VAPP_PREFIX)/esp/nvd3/client/lib/nvd3/nv.d3.css
	cp src/esp/proto/nvd3/client/lib/nvd3/nv.d3.js $(BIT_VAPP_PREFIX)/esp/nvd3/client/lib/nvd3/nv.d3.js
	cp src/esp/proto/nvd3/client/lib/nvd3/nv.d3.min.css $(BIT_VAPP_PREFIX)/esp/nvd3/client/lib/nvd3/nv.d3.min.css
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/nvd3"
	cp src/esp/proto/nvd3/esp.json $(BIT_VAPP_PREFIX)/esp/nvd3/esp.json
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/respond/client/lib/respond"
	cp src/esp/proto/respond/client/lib/respond/respond.js $(BIT_VAPP_PREFIX)/esp/respond/client/lib/respond/respond.js
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/respond"
	cp src/esp/proto/respond/esp.json $(BIT_VAPP_PREFIX)/esp/respond/esp.json
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/server"
	cp src/esp/proto/server/appweb.conf $(BIT_VAPP_PREFIX)/esp/server/appweb.conf
	cp src/esp/proto/server/esp.json $(BIT_VAPP_PREFIX)/esp/server/esp.json
	cp src/esp/proto/server/hosted.conf $(BIT_VAPP_PREFIX)/esp/server/hosted.conf
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/server/templates"
	cp src/esp/proto/server/templates/app.c $(BIT_VAPP_PREFIX)/esp/server/templates/app.c
	cp src/esp/proto/server/templates/controller.c $(BIT_VAPP_PREFIX)/esp/server/templates/controller.c
	cp src/esp/proto/server/templates/migration.c $(BIT_VAPP_PREFIX)/esp/server/templates/migration.c
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/xcharts/client/lib/xcharts"
	cp src/esp/proto/xcharts/client/lib/xcharts/xcharts.css $(BIT_VAPP_PREFIX)/esp/xcharts/client/lib/xcharts/xcharts.css
	cp src/esp/proto/xcharts/client/lib/xcharts/xcharts.js $(BIT_VAPP_PREFIX)/esp/xcharts/client/lib/xcharts/xcharts.js
	cp src/esp/proto/xcharts/client/lib/xcharts/xcharts.min.css $(BIT_VAPP_PREFIX)/esp/xcharts/client/lib/xcharts/xcharts.min.css
	mkdir -p "$(BIT_VAPP_PREFIX)/esp/xcharts"
	cp src/esp/proto/xcharts/esp.json $(BIT_VAPP_PREFIX)/esp/xcharts/esp.json
endif
ifeq ($(BIT_PACK_ESP),1)
