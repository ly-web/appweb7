...
build/$(CONFIG)/obj/dirHandler.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/dirHandler.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/dirHandler.c
...
build/$(CONFIG)/obj/fileHandler.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/fileHandler.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/fileHandler.c
...
build/$(CONFIG)/obj/log.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/log.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/log.c
...
build/$(CONFIG)/obj/server.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/server.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/server.c
...
build/$(CONFIG)/obj/slink.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/slink.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/slink.c
...
build/$(CONFIG)/obj/testAppweb.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/testAppweb.o $(CFLAGS) $(DFLAGS) $(IFLAGS) test/src/testAppweb.c
...
build/$(CONFIG)/obj/testHttp.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/testHttp.o $(CFLAGS) $(DFLAGS) $(IFLAGS) test/src/testHttp.c
