...
static void view_1abbd86a30698f2e94262b5f353f0d7a(HttpConn *conn) {
EdiRec      *rec = getRec();
            EdiField    *fp;
...
ESP_EXPORT int esp_view_1abbd86a30698f2e94262b5f353f0d7a(HttpRoute *route, MprModule *module) {
   espDefineView(route, "post/edit.esp", view_1abbd86a30698f2e94262b5f353f0d7a);
   return 0;
}
