...
ttrue(r.contains('ALIVE'))
ttrue(r.contains('END'))
ttrue(r.match(/^HTTP\/1.1 200 OK/mg).length == 2)
s.close()
...
ttrue(r.contains('ALIVE'))
ttrue(r.contains('END'))
ttrue(r.match(/^HTTP\/1.1 200 OK/mg).length == 1)
ttrue(r.match(/^HTTP\/1.0 200 OK/mg).length == 1)
s.close()
